...
], function (oConfigInfo) {
    "use strict";

    QUnit.test("config loaded",
        function (assert) {
            var oResult = {
                Line: {
                    default: {
                        ...
                        feeds: [
                            {
                                ...
                                type: "measure",
                                vizProperties: [
                                    { path: "valueAxis.layout.maxWidth", value: 0.4 },
                                    { path: "valueAxis.label.allowDecimals", value: true },
                                ],
                            },
                            {
                                uid: "categoryAxis",
                    ...
                    time: {
                        ...
                        vizProperties: [
                            { path: "plotArea.isSmoothed", value: false },
                            { path: "timeAxis.levels", value: ['year', 'month', 'day', 'hour', 'minute'] }
                        ],
                        dimensions: {
                            min: 1,
                            defaultRole: "Category",
            ...
            assert.ok(JSON.stringify(oConfigInfo.getChartsConfiguration()) === JSON.stringify(oResult), "Config file loaded successfully");
        }.bind(oConfigInfo)
    );
});
