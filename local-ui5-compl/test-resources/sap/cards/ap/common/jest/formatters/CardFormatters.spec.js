...
sap.ui.define(["sap/cards/ap/common/formatters/CardFormatters", "sap/ui/core/date/Gregorian"], function (sap_cards_ap_common_formatters_CardFormatters, sap_ui_core_date_Gregorian) {
  "use strict";

  const getFormatters = sap_cards_ap_common_formatters_CardFormatters["getFormatters"]; // load required calendar in advance
  describe("Card formatters", () => {
    ...
    let CriticalityType_1 = /*#__PURE__*/function (CriticalityType_1) {
      CriticalityType_1["Negative"] = "UI.CriticalityType/Negative";
      CriticalityType_1["Critical"] = "UI.CriticalityType/Critical";
      CriticalityType_1["Positive"] = "UI.CriticalityType/Positive";
      return CriticalityType_1;
    }({});
    ...
    test("formatCurrency: returns formatted currency value", () => {
      expect(cardFormatters.formatCurrency(1000.123, {
        numberOfFractionalDigits: 2,
        scaleFactor: 1000
      }, true, "$", "USD").replace(/\s+/g, "")).toEqual("$1.00K(USD)");
      expect(cardFormatters.formatCurrency(5631.08, {
        numberOfFractionalDigits: 1,
        scaleFactor: 1000
      }, false, "$", "USD").replace(/\s+/g, "")).toEqual("$5.6K");
    });
    test("returnPercentageChange: returns calculated percentage change", () => {
      expect(cardFormatters.returnPercentageChange("100", "95", {
        NumberOfFractionalDigits: 1,
        manifestTarget: 95
      })).toEqual("5.3%");
    });
    ...
    let CriticalityType_2 = /*#__PURE__*/function (CriticalityType_2) {
      CriticalityType_2["Negative"] = "UI.CriticalityType/Negative";
      CriticalityType_2["Positive"] = "UI.CriticalityType/Positive";
      return CriticalityType_2;
    }({});
    ...
    let CriticalityType_3 = /*#__PURE__*/function (CriticalityType_3) {
      CriticalityType_3["Negative"] = "UI.CriticalityType/Negative";
      CriticalityType_3["Critical"] = "UI.CriticalityType/Critical";
      CriticalityType_3["Positive"] = "UI.CriticalityType/Positive";
      CriticalityType_3["Information"] = "UI.CriticalityType/Information";
      return CriticalityType_3;
    }({});
    ...
    test("formatTrendIcon: returns trend icon for the value provided", () => {
      expect(cardFormatters.formatTrendIcon(100, {
    ...
    test("targetValueFormatter: returns formatted target value based on provided kpi value and target value", () => {
      expect(cardFormatters.targetValueFormatter(0, 1000, {
        NumberOfFractionalDigits: 1,
        manifestTarget: 10000
      })).toEqual("1.0K");
      expect(cardFormatters.targetValueFormatter(1000, 20000, {
        NumberOfFractionalDigits: 2,
        manifestTarget: 10000
      })).toEqual("20.00K");
    ...
    test("formatKPIValue: returns formatted kpi value", () => {
      expect(cardFormatters.formatKPIValue("12", {
        NumberOfFractionalDigits: 2,
    ...
    test("formatDate: returns formatted date value based on oLocale & UTC value provided", () => {
      expect(cardFormatters.formatDate("03/10/1997", {
        UTC: false
      })).toEqual("Mar 10, 1997");
      expect(cardFormatters.formatDate("03/10/1997", {
        UTC: true
...
//# sourceMappingURL=CardFormatters.spec.js.map