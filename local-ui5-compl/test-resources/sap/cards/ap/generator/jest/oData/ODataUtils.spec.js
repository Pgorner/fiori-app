...
sap.ui.define(["sap/cards/ap/generator/odata/ODataUtils"], function (sap_cards_ap_generator_odata_ODataUtils) {
  "use strict";
  ...
  describe("createPathWithEntityContext", () => {
    ...
    test("validate method createPathWithEntityContext for V4 data - with semantic key annotation", function () {
      try {
        const mockMetamodel = {
          getObject: sParam => {
            const entityContainer = {
