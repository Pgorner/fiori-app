...
import { CardGeneratorDialogController, getCriticality } from "sap/cards/ap/generator/app/CardGeneratorDialogController";
import { ApplicationInfo } from "sap/cards/ap/generator/helpers/ApplicationInfo";
import { NavigationalData } from "sap/cards/ap/generator/helpers/CardGeneratorModel";
...
import { getCurrentCardManifest, renderCardPreview } from "sap/cards/ap/generator/helpers/IntegrationCardHelper";
...
describe("Card Action Handlers", () => {
	...
	test("okPressed : should show success message on successful save", async () => {
		const oCard = {
			getManifest: jest.fn().mockReturnValue({ "sap.card": { configuration: {} } })
		};
		(CoreElement.getElementById as jest.Mock).mockReturnValue(oCard);
...
describe("Toggle Advanced Settings", () => {
    ...
    test("transpileIntegrationCardToAdaptive should be called", async () => {
        coreElementGetElementByIdSpy.mockImplementation((id) => {
        ...
        (CoreElement.getElementById as jest.Mock).mockReturnValue(
            new Splitter("", {
