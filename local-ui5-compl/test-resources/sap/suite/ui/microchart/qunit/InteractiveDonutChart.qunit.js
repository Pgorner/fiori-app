...
sap.ui.define([
	...
	"sap/ui/core/Core",
	"sap/ui/core/Theming"
], function(nextUIUpdate, jQuery, InteractiveDonutChart, InteractiveDonutChartSegment, FlexBox, mobileLibrary, Device, Label, microchartLibrary, Log, IntervalTrigger, Mobile, Core, Theming) {
	"use strict";
	...
	*/
	...
	QUnit.test("Calculation of gap size (belize)", async function(assert) {
		//Assert
		//Act
		var oStubGetTheme = sinon.stub(Theming, "getTheme").returns("sap_belize");
	...
	QUnit.test("Calculation of gap size (hcb)", async function(assert) {
		//Assert
		//Act
		var oStubGetTheme = sinon.stub(Theming, "getTheme").returns("sap_hcb");
		this.oChart.invalidate();
		await nextUIUpdate();
		//Assert
	...
	QUnit.test("Check legend value rendering w/o displayedValue", async function(assert) {
		assert.expect(1);
	...
	QUnit.test("Check legend N/A handling on null value", async function(assert) {
		assert.expect(1);

		//Arrange
		var sNAText = Core.getLibraryResourceBundle("sap.suite.ui.microchart").getText("INTERACTIVECHART_NA");
	...
	QUnit.test("Check legend N/A handling on undefined value", async function(assert) {
		assert.expect(1);
	...
	QUnit.test("Legend entries are resized", async function(assert) {
		//Arrange
	...
	QUnit.test("Semantic marker has correct class for Error color", async function(assert) {
		//Arrange
	...
	if (Device.system.desktop && !Device.system.combi) {
		...
		QUnit.test("Hover handlers are attached", async function(assert) {
			//Arrange
		...
		QUnit.test("Hover handlers are called - mousein on legend", async function(assert) {
			//Arrange
		...
		QUnit.test("Hover handlers are called - mousein on selected ghost segments", async function(assert) {
			//Arrange
		...
		QUnit.test("Hover handlers are called - mouseout from selected ghost segments", async function(assert) {
			//Arrange
			var aSegments = this.oChart.getSegments();
			sinon.spy(this.oChart, "_handleHoverSync");
		...
		QUnit.test("Hover handlers are called - mousein on selected segments", async function(assert) {
			//Arrange
			var aSegments = this.oChart.getSegments();
			sinon.spy(this.oChart, "_handleHoverSync");
		...
		QUnit.test("Hover handlers are called - mouseout from selected segments", async function(assert) {
			//Arrange
			var aSegments = this.oChart.getSegments();
			sinon.spy(this.oChart, "_handleHoverSync");
		...
		QUnit.test("Hover handlers are called - mousein on normal segments", async function(assert) {
			//Arrange
			sinon.spy(this.oChart, "_handleHoverSync");
	...
	QUnit.test("Click event on selection disabled segment chart test", async function(assert) {
		//Arrange
		this.oChart.setSelectionEnabled(false);
	...
	QUnit.test("Vertical responsiveness: show chart", async function(assert) {
		//Arrange
	...
	QUnit.test("Vertical responsiveness: hide chart", async function(assert) {
		//Arrange
	...
	QUnit.test("Vertical responsiveness: non-interactive mode", async function(assert) {
		//Arrange
	...
	QUnit.test("Vertical responsiveness: small font", async function(assert) {
		//Arrange
	...
	QUnit.test("Horizontal responsiveness: hide donut", async function(assert) {
		//Arrange
	...
	QUnit.test("Horizontal responsiveness: hide chart", async function(assert) {
		//Arrange
	...
	QUnit.test("Horizontal responsiveness: small font in normal mode", async function(assert) {
		//Arrange
	...
	QUnit.test("Horizontal responsiveness: small font in full width mode", async function(assert) {
		//Arrange
	...
	QUnit.test("Semantic colors", async function(assert) {
		//Arrange
	...
	QUnit.test("Chart describedby not set", function(assert) {
		//Assert
		var $Chart = this.oChart.$();
		assert.equal($Chart.attr("aria-describedby"), undefined, "Chart has attribute aria-describedby not set");
	});
	...
	QUnit.test("Interactive", async function(assert) {
		//Arrange
		...
		oLegendSegment.eq(0).trigger("mousemove");
		...
		oLegendSegment.eq(0).trigger("mouseleave");

		oLegendSegment.eq(1).trigger("mousemove");
		...
		oLegendSegment.eq(1).trigger("mouseleave");

		oLegendSegment.eq(2).trigger("mousemove");
		...
		oLegendSegment.eq(2).trigger("mouseleave");
	...
	QUnit.test("Non-Interactive", async function(assert) {
		//Arrange
		this.oFlexBox.setHeight("120px");
	...
	QUnit.test("Interactive, but selection disabled", async function(assert) {
		//Arrange
		this.oChart.setSelectionEnabled(false);
		await nextUIUpdate();
		//Act
	...
	QUnit.test("Non-Interactive custom chart title", async function(assert) {
		//Arrange
		this.oFlexBox.setHeight("120px");
		this.oFlexBox.setWidth("320px");
		await nextUIUpdate();
	...
	QUnit.test("Interactive custom segment tooltips", async function(assert) {
		//Arrange
	...
	QUnit.test("Interactive custom segment tooltips with line break", async function(assert) {
		//Arrange
		...
		$LegendSegment.trigger("mousemove");
		...
		$LegendSegment.trigger("mouseleave");
	...
	QUnit.test("Interactive chart, semantic colors", async function(assert) {
		//Arrange
		...
		//Act
		//Assert
		var oIntractionArea0 = this.oChart.$("interactionArea-0");
		var oIntractionArea1 = this.oChart.$("interactionArea-1");
		var oIntractionArea2 = this.oChart.$("interactionArea-2");
		oIntractionArea0.trigger("mousemove");
		assert.equal(oIntractionArea0.attr("title"), "Label1:\nText 1 Critical", "The tooltip of the first legend entry has been set correctly.");
		oIntractionArea0.trigger("mouseleave");

		oIntractionArea1.trigger("mousemove");
		assert.equal(oIntractionArea1.attr("title"), "Label2:\n31.7 Neutral", "The tooltip of the second legend entry has been set correctly.");
		oIntractionArea1.trigger("mouseleave");

		oIntractionArea2.trigger("mousemove");
		assert.equal(oIntractionArea2.attr("title"), "Label3:\nN/A Neutral", "The tooltip of the third legend entry has been set correctly.");
		oIntractionArea2.trigger("mouseleave");

	});

	QUnit.test("Suppress segment tooltip (interactive)", async function(assert) {
		//Arrange
