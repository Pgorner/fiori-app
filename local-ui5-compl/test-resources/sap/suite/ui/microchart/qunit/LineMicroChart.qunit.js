...
sap.ui.define([
	...
	"sap/ui/core/Lib",
	"sap/ui/core/Theming"
], function(nextUIUpdate, jQuery, LineMicroChart, HarveyBallMicroChart, LineMicroChartPoint, LineMicroChartEmphasizedPoint, ResizeHandler, FlexBox, TooltipBase, JSONModel, Button, GenericTile, TileContent, LineMicroChartRenderer, mobileLibrary, Text, microchartLibrary, Parameters, LineMicroChartLine, TestUtils, KeyCodes, Mobile, Core, CoreLib, Theming) {
	"use strict";
	...
	*/
	QUnit.test("Core initialization check - no core, but theme", function (assert) {
		...
		assert.ok(this.fnSpyReady.calledOnce, "Method Core.ready has been called once.");
		assert.ok(this.fnSpyHandleCoreInitialized.calledOnce, "Method _handleCoreInitialized has been called once.");
		assert.ok(this.fnStubAttachThemeApplied.calledOnce, "Method Core.attachThemeChanged has not been called.");
		assert.ok(this.fnSpyHandleThemeApplied.calledOnce, "Method _handleThemeApplied has not been called.");
	});
	...
	*/
	...
	QUnit.test("Adjustment of the canvas when the resize event is triggered", async function (assert) {
		//Arrange
		//Act
	...
	QUnit.test("Top labels are hidden when truncated", async function(assert) {
		//Arrange
	...
	QUnit.test("Bottom labels not hidden when truncated", async function(assert) {
		//Arrange
	...
	QUnit.test("Top labels are shown after there is space again", async function(assert) {
		//Arrange
	...
	QUnit.test("All labels hidden if the width is too small", async function(assert) {
		//Arrange
	...
	QUnit.test("Labels are not truncated when enough space", async function(assert) {
		//Arrange
	...
	QUnit.test("Function _getQualitativeColor", function (assert) {
		...
		for (i = 0; i < 12; i++) {
			//Assert
			assert.equal(oSpy.args[i][0], "sapChart_Sequence_" + (i + 1) % 22, "Correct class used");
		}
	});
	...
	*/
	QUnit.test("Chart is rendered with a LESS parameter color", async function (assert) {
		//Arrange
		//Act
		this.oChart.setColor("sapUiWarningBorder");
		await nextUIUpdate();

		return TestUtils.getThemeColor("sapUiWarningBorder").then(function(sExpectedColor) {
			//Assert
			var oSvgLines = this.oChart.$().find(".sapSuiteLMCSvgElement line").not(".sapSuiteLMCLineThreshold");
			assert.strictEqual(oSvgLines.eq(0).css("stroke"), sExpectedColor, "Chart color is applied correctly to the first line");
			assert.strictEqual(oSvgLines.eq(1).css("stroke"), sExpectedColor, "Chart color is applied correctly to the second line");
		}.bind(this));
	});

	QUnit.test("Chart is rendered with a valid LESS parameter color", async function (assert) {
		//Arrange
		//Act
		this.oChart.setColor("Good");
		await nextUIUpdate();

		return TestUtils.getThemeColor("Good").then(function(sExpectedColor) {
			//Assert
			var oSvgLines = this.oChart.$().find(".sapSuiteLMCSvgElement line").not(".sapSuiteLMCLineThreshold");
			assert.ok(oSvgLines.eq(0).attr("class").includes("sapSuiteLMCLineGood"), "Chart color is applied correctly to the first line");
			assert.ok(oSvgLines.eq(1).attr("class").includes("sapSuiteLMCLineGood"), "Chart color is applied correctly to the second line");
		}.bind(this));
	});

	QUnit.test("Chart is rendered with the second line outside the viewport (X axis)", async function (assert) {
		//Arrange
		var sLimit = 10;
	...
	QUnit.test("Chart is rendered with the second line outside the viewport (Y axis)", async function (assert) {
		//Arrange
		var sLimit = 10;
		var sLinesCount = this.oChart.$().find(".sapSuiteLMCSvgElement line").not(".sapSuiteLMCLineThreshold").length;
		//Act
	...
	QUnit.test("Labels are not present if the properties are not set", async function (assert) {
		//Arrange
		//Act
	...
	QUnit.test("Labels are visible and small if chart height lower than 72px", async function (assert) {
		//Arrange
	...
	QUnit.test("Top labels are hidden if the chart's height is lower than 2rem", async function (assert) {
		//Arrange
	...
	QUnit.test("Top labels are hidden if the bottom labels are not set and the chart's height is lower than 2rem", async function (assert) {
		//Arrange
	...
	QUnit.test("Truncated bottom labels are hidden", async function (assert) {
		//Arrange
	...
	QUnit.test("Chart is rendered with the bottom labels visible", async function (assert) {
		//Arrange
	...
	QUnit.test("No top labels present", async function(assert) {
		//Arrange
		//Act
	...
	QUnit.test("No bottom labels present", async function(assert) {
		//Arrange
		//Act
	...
	QUnit.test("No labels present", async function(assert) {
		//Arrange
		//Act
		this.oMicroChart.setLeftTopLabel(null);
		this.oMicroChart.setRightTopLabel(null);
	...
	QUnit.test("One top and one bottom label present", async function(assert) {
		//Arrange
		//Act
		this.oMicroChart.setLeftTopLabel(null);
		this.oMicroChart.setRightBottomLabel(null);
	...
	QUnit.test("showTopLabels false", async function(assert) {
		//Arrange
		//Act
	...
	QUnit.test("showBottomLabels false", async function(assert) {
		//Arrange
		//Act
	...
	QUnit.test("showTopLabels & showBottomLabels false", async function(assert) {
		//Arrange
		//Act
		this.oMicroChart.setShowTopLabels(false);
		this.oMicroChart.setShowBottomLabels(false);
	...
	QUnit.test("Threshold Line is rendered when inside defined scale", async function (assert) {
		//Arrange
		//Act
	...
	QUnit.test("Threshold Line is not rendered when the threshold is null", async function (assert) {
		//Arrange
		//Act
		this.oChart.setThreshold(null);
	...
	QUnit.test("Threshold Line is rendered when inside observed scale even if no manual scale is set", async function (assert) {
		//Arrange
		//Act
	...
	QUnit.test("Threshold Line is not rendered, when out of scale", async function (assert) {
		//Arrange
		//Act
	...
	QUnit.test("Threshold Line is rendered when below observed lower scale and manual lower scale is not set", async function (assert) {
		//Arrange
		//Act
		this.oChart.setMinYValue(null);
		this.oChart.setThreshold(-50);
	...
	QUnit.test("Threshold Line is rendered when above observed upper scale and manual upper scale is not set", async function (assert) {
		//Arrange
		//Act
		this.oChart.setMaxYValue(null);
		this.oChart.setThreshold(150);
	...
	QUnit.test("Threshold Line is rendered when above observed upper scale and no scale is set", async function (assert) {
		//Arrange
		//Act
		this.oChart.setMaxYValue(null);
		this.oChart.setMinYValue(null);
	...
	QUnit.test("Threshold Line is rendered when below observed lower scale and no scale is set", async function (assert) {
		//Arrange
		//Act
		this.oChart.setMaxYValue(null);
		this.oChart.setMinYValue(null);
	...
	QUnit.test("showThresholdLine", async function (assert) {
		this.oChart.setThreshold(50);
		await nextUIUpdate();
		var oThreshold = this.oChart.$().find(".sapSuiteLMCLineThreshold");
		assert.equal(oThreshold.length, 1, "The threshold is rendered exactly once");
	...
	QUnit.test("showThresholdValue", async function (assert) {
	...
	QUnit.test("showThresholdValue with showThresholdLine false", async function (assert) {
		this.oChart.setShowThresholdValue(true);
		this.oChart.setShowThresholdLine(false);
		await nextUIUpdate();
	...
	QUnit.test("thresholdDisplayValue", async function (assert) {
		this.oChart.setShowThresholdValue(true);
	...
	QUnit.test("thresholdDisplayValue hidden when not enough space", async function (assert) {
		this.oChart.setShowThresholdValue(true);
	...
	QUnit.test("Unsemantic - Neither top Label is different from Neutral color if first and last Point has Neutral color", async function (assert) {
		//Arrange
		//Act
	...
	QUnit.test("Semantic - Neither top Label is different from Neutral color if first and last Point has Neutral color", async function (assert) {
		//Arrange
		//Act
		this.oChart.getPoints()[0].setColor("Neutral");
	...
	QUnit.test("Unsemantic - Neither top Label is different from Neutral color if first and last Point has semantic color but is not shown", async function (assert) {
		//Arrange
		//Act
	...
	QUnit.test("Semantic - Neither top Label is different from Neutral color if first and last Point has semantic color but is not shown", async function (assert) {
		//Arrange
		//Act
		this.oChart.getPoints()[0].setColor("Error");
		this.oChart.getPoints()[0].setShow(false);
	...
	QUnit.test("Semantic - Top labels gain their respective semantic colors if their corresponding points are shown", async function (assert) {
		//Arrange
		//Act
		this.oChart.getPoints()[0].setColor("Error");
	...
	QUnit.test("Lines/Points are colored when EmphasizedPoints are used - single semantic chart color and all Points Neutral color", async function (assert) {
		//Arrange
		//Act
	...
	QUnit.test("Lines/Points are not colored when EmphasizedPoints are used - single semantic chart color and one Point non Neutral", async function (assert) {
		//Arrange
		//Act
		this.oChart.setColor("Error");
	...
	QUnit.test("Lines/Points are not colored when EmphasizedPoints are used - composite semantic chart colors", async function (assert) {
		//Arrange
		//Act
	...
	QUnit.test("Lines/Points are colored when EmphasizedPoints are used - single hex chart color and all Points Neutral color", async function (assert) {
		//Arrange
		//Act
	...
	QUnit.test("Lines/Points are not colored when EmphasizedPoints are used - single hex chart color and one Point non Neutral", async function (assert) {
		//Arrange
		//Act
		this.oChart.setColor("#222222");
		this.oChart.getPoints()[1].setColor("Critical");
	...
	QUnit.test("Lines/Points are not colored when EmphasizedPoints are used - composite hex chart colors", async function (assert) {
		//Arrange
		//Act
	...
	QUnit.test("Lines are not colored when EmphasizedPoints are using semantical colors", async function (assert) {
		//Arrange
		//Act
		this.oChart.getPoints()[0].setColor("Error");
		this.oChart.getPoints()[1].setColor("Critical");
	...
	QUnit.test("ShowPoints mode has no influence on display of Points showPoints false", async function (assert) {
		//Arrange
		//Act
	...
	QUnit.test("ShowPoints mode has no influence on display of Points showPoints true", async function (assert) {
		//Arrange
		//Act
	...
	QUnit.test("SemanticMode is not active if no EmphasizedPoints are using colors different from Neutral", async function (assert) {
		//Arrange
		//Act
		this.oChart.getPoints()[0].setColor("Neutral");
		this.oChart.getPoints()[1].setColor("Neutral");
	...
	QUnit.test("SemanticMode is active if atleast one EmphasizedPoint is using colors different from Neutral which is shown", async function (assert) {
		//Arrange
		//Act
		this.oChart.getPoints()[0].setColor("Neutral");
		this.oChart.getPoints()[1].setColor("Error");
	...
	QUnit.test("SemanticMode is not active if at least one EmphasizedPoint is using colors different from Neutral but is not shown", async function (assert) {
		//Arrange
		//Act
		this.oChart.getPoints()[0].setColor("Neutral");
		this.oChart.getPoints()[1].setColor("Error");
	...
	QUnit.test("EmphasizedPoint will be semantically colored if property color is set", async function (assert) {
		//Arrange
		//Act
		this.oChart.getPoints()[0].setColor("Error");
		this.oChart.getPoints()[1].setColor("Critical");
	...
	*/
	QUnit.test("EmphasizedPoint fall back to Neutral if property color is incorrect", function (assert) {
		//Arrange
		return TestUtils.getThemeColor("sapUiChartPaletteQualitativeHue1").then(async function(sFallbackColor) {
			//Act
			this.oChart.getPoints()[0].setColor(null);
			this.oChart.getPoints()[1].setColor(null);
			this.oChart.getPoints()[2].setColor(null);
			await nextUIUpdate();
			var aPoints = this.oChart.$().find(".sapSuiteLMCPoint").filter(function() {
				return this.style.backgroundColor == sFallbackColor;
			});
			//Assert
			...
			//Assert
			assert.equal(aPoints.length, 0, "No Point has default semantic color applied");
		}.bind(this));
	});

	QUnit.test("EmphasizedPoints are not rendered if their show property is false", async function (assert) {
		//Arrange
		//Act
		this.oChart.getPoints()[0].setShow(false);
		this.oChart.getPoints()[1].setShow(false);
	...
	QUnit.test("In no showPoints mode no points are rendered", async function (assert) {
		//Arrange
		//Act
		this.oChart.setShowPoints(false);
		await nextUIUpdate();
	...
	QUnit.test("ShowPoints mode enabled means all Points are rendered", async function (assert) {
		//Arrange
		//Act
		this.oChart.setShowPoints(true);
		await nextUIUpdate();
	...
	QUnit.test("Lines/Points are colored regardless of the threshold used - single semantic chart color", async function (assert) {
		//Arrange
		//Act
		this.oChart.setColor("Error");
		await nextUIUpdate();
	...
	QUnit.test("Lines/Points are colored according to the threshold used - composite semantic chart colors", async function (assert) {
		//Arrange
		//Act
		this.oChart.setColor({above: "Error", below: "Good"});
		await nextUIUpdate();
	...
	/**
		* @deprecated As of version 1.120
	*/
	QUnit.test("Lines/Points are colored regardless of the threshold used - single hex chart color", async function (assert) {
		//Arrange
		//Act
		this.oChart.setColor("#222222");
		await nextUIUpdate();
	...
	/**
		* @deprecated As of version 1.120
	*/
	QUnit.test("Lines/Points are colored when according to the threshold used - composite hex chart colors", async function (assert) {
		//Arrange
		//Act
		this.oChart.setColor({above: "#222222", below: "#333333"});
		await nextUIUpdate();
	...
	QUnit.test("Lines/Points fall back to Neutral if property color is incorrect - single incorrect chart color", function (assert) {
		...
		return TestUtils.getThemeColor("sapUiChartPaletteQualitativeHue1").then(async function(sFallbackColor) {
			...
			var oSvgLines = this.oChart.$().find(".sapSuiteLMCSvgElement line").not(".sapSuiteLMCLineThreshold").filter(function() {
				return this.style.stroke == sFallbackColor;
			});
			//Assert
	...
	QUnit.test("Neither FocusMode nor SemanticMode is active if single semantic chart color is used", async function (assert) {
		//Arrange
		//Act
	...
	QUnit.test("Neither FocusMode nor SemanticMode is active if single hex chart color is used", async function (assert) {
		//Arrange
		//Act
		this.oChart.setColor("#222222");
		await nextUIUpdate();
	...
	/**
		* @deprecated As of version 1.120
	*/
	QUnit.test("Only SemanticMode is active if composite hex chart colors are used", async function (assert) {
		//Arrange
		//Act
		this.oChart.setColor({above: "#222222", below: "#333333"});
		await nextUIUpdate();
	...
	QUnit.test("Only SemanticMode is active if composite semantic chart colors are used", async function (assert) {
		//Arrange
		//Act
	...
	QUnit.test("Only SemanticMode is active even if composite semantic chart colors are used and both are Neutral", async function (assert) {
		//Arrange
		//Act
	...
	QUnit.test("Neither FocusMode nor SemanticMode is active if composite chart color is incomplete", async function (assert) {
		//Arrange
		//Act
	...
	QUnit.test("Neither FocusMode nor SemanticMode is active if threshold is null even if composite chart color is correct", async function (assert) {
		//Arrange
		//Act
		this.oChart.setColor({above: "Error", below: "Good"});
		this.oChart.setThreshold(null);
	...
	QUnit.test("Labels are Neutral - single semantic color", async function (assert) {
		//Arrange
		//Act
		this.oChart.setColor("Error");
		await nextUIUpdate();
	...
	QUnit.test("Labels are colored - composite semantic colors and showPoints", async function (assert) {
		//Arrange
		//Act
		this.oChart.setColor({above: "Error", below: "Good"});
		this.oChart.setShowPoints(true);
	...
	QUnit.test("Labels are not colored - composite semantic colors and non-showPoints", async function (assert) {
		//Arrange
		//Act
		this.oChart.setColor({above: "Error", below: "Good"});
		this.oChart.setShowPoints(false);
	...
	QUnit.test("Labels are Neutral - single hex color", async function (assert) {
		//Arrange
		//Act
		this.oChart.setColor("#222222");
		await nextUIUpdate();
	...
	QUnit.test("Labels are neutral - composite hex colors", async function (assert) {
		//Arrange
		//Act
		this.oChart.setColor({above: "#222222", below: "#333333"});
		await nextUIUpdate();
	...
	QUnit.test("Labels are colored - composite semantic colors and showPoints - threshold at maxY", async function (assert) {
		//Arrange
		//Act
		this.oChart.setColor({above: "Error", below: "Good"});
		this.oChart.setShowPoints(true);
	...
	QUnit.test("Labels are colored - composite semantic colors and showPoints - threshold at minY", async function (assert) {
		//Arrange
		//Act
		this.oChart.setColor({above: "Error", below: "Good"});
		this.oChart.setShowPoints(true);
	...
	QUnit.test("Labels are colored - composite semantic colors and showPoints - threshold above maxY", async function (assert) {
		//Arrange
		//Act
		this.oChart.setColor({above: "Error", below: "Good"});
		this.oChart.setShowPoints(true);
	...
	QUnit.test("Labels are colored - composite semantic colors and showPoints - threshold below minY", async function (assert) {
		//Arrange
		//Act
		this.oChart.setColor({above: "Error", below: "Good"});
		this.oChart.setShowPoints(true);
	...
	QUnit.test("Equal Y points are drawn in the middle of the canvas if no threshold present", async function(assert) {
		//Arrange
	...
	QUnit.test("Points are correctly rendered after setting the scale", async function(assert) {
		//Arrange
	...
	QUnit.test("Points are correctly rendered by setting the scale inside the original canvas", async function(assert) {
		//Arrange
	...
	QUnit.test("Internal scaling equals set scale", async function (assert) {
		//Arrange
		//Act
	...
	QUnit.test("Internal scaling equals observed scale if min/max values are invalid", async function (assert) {
		//Arrange
		//Act
	...
	QUnit.test("MinX greater than MaxX - Chart is empty", async function (assert) {
		//Arrange
		//Act
	...
	QUnit.test("MaxX smaller than MinX - Chart is empty", async function (assert) {
		//Arrange
		//Act
		this.oChart.setMinXValue(50);
	...
	QUnit.test("MinY greater than MaxY - Chart is empty", async function (assert) {
		//Arrange
		//Act
	...
	QUnit.test("MaxY smaller than MinY - Chart is empty", async function (assert) {
		//Arrange
		//Act
		this.oChart.setMinYValue(50);
	...
	QUnit.test("MinX greater than observed MaxX - Chart is empty", async function (assert) {
		//Arrange
		//Act
	...
	QUnit.test("MaxX smaller than observed MinX - Chart is empty", async function (assert) {
		//Arrange
		//Act
	...
	QUnit.test("MinY greater than observed MaxY - Chart is empty", async function (assert) {
		//Arrange
		//Act
	...
	QUnit.test("MaxY smaller than observed MinY - Chart is empty", async function (assert) {
		//Arrange
		//Act
	...
	QUnit.test("Threshold smaller than observed min Y value without custom scale - internal MinY adjusted to Threshold", async function (assert) {
		//Arrange
		//Act
	...
	QUnit.test("Threshold greater than observed max Y value without custom scale - internal MinY adjusted to Threshold", async function (assert) {
		//Arrange
		//Act
	...
	QUnit.test("Threshold smaller than observed min Y value but smaller than minY - internal minY honors set minY", async function (assert) {
		//Arrange
		//Act
		this.oChart.setThreshold(40);
	...
	QUnit.test("Threshold greater than observed max Y value but greater than minY - internal maxY honors set maxY", async function (assert) {
		//Arrange
		//Act
		this.oChart.setThreshold(70);
	...
	QUnit.test("Threshold smaller than manually set scale defined by minY and maxY - internal minY honors set minY", async function (assert) {
		//Arrange
		//Act
		this.oChart.setThreshold(40);
		this.oChart.setMinYValue(45);
	...
	QUnit.test("Threshold greater than manually set scale defined by minY and maxY - internal maxY honors set maxY", async function (assert) {
		//Arrange
		//Act
		this.oChart.setThreshold(70);
		this.oChart.setMaxYValue(65);
	...
	QUnit.test("Intersection Left", async function (assert) {
		//Arrange
		//Act
	...
	QUnit.test("Intersection Top", async function (assert) {
		//Arrange
		//Act
	...
	QUnit.test("Intersection Right", async function (assert) {
		//Arrange
		//Act
		this.oChart.getPoints()[0].setX(50);
		this.oChart.getPoints()[0].setY(30);
	...
	QUnit.test("Intersection Bottom", async function (assert) {
		//Arrange
		//Act
		this.oChart.getPoints()[0].setX(50);
		this.oChart.getPoints()[0].setY(50);
	...
	QUnit.test("No data rendered when no points given", function (assert) {
		...
		//Act
		//Assert
		assert.ok(document.getElementById("lineBallMicroChart"), "Control was rendered");
	...
	QUnit.test("Points are rendered", async function(assert) {
		this.oMicroChart.bindLines({
			path: "/lines",
			template: new LineMicroChartLine({
				points: {
	...
	QUnit.test("emphasized points", async function(assert) {
		this.oMicroChart.bindLines({
			path: "/lines",
			template: new LineMicroChartLine({
				points: {
	...
	*/
	...
	QUnit.test("getColor", function(assert) {
		...
		oLine.setColor("Sequence2");
		assert.equal(oLine.getColor(), "Sequence2", "line returns its own color if directly set");
	});
