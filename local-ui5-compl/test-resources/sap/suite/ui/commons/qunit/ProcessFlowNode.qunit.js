sap.ui.define([
...
], function(jQuery, suiteLibrary, ProcessFlowNode, nextUIUpdate) {
	"use strict";

	var ProcessFlowNodeState = suiteLibrary.ProcessFlowNodeState,
		ProcessFlowNodeType = suiteLibrary.ProcessFlowNodeType,
	...
	QUnit.test("Get ARIA details of Process Flow Node", function(assert) {
		...
		var sDefaultActivateNode = this.processFlowNode._oResBundle.getText("PF_DEFAULT_NODE_ACTIVATE");
