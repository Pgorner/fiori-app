sap.ui.define([
...
], function(jQuery, suiteLibrary, ProcessFlowLaneHeader, JSONModel, ProcessFlow, ProcessFlowNode, nextUIUpdate) {
	"use strict";
	...
	QUnit.test("ProcessFlow lane map check, strange order of lanes", async function (assert) {
		assert.expect(0);
