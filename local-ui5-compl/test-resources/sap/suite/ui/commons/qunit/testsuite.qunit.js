sap.ui.define(function () {
	...
	return {
		...
		tests: {
			 ...
			 */
			CloudFilePicker: {
				group: "CloudFilePicker",
				coverage: {
					only: "//sap\/suite\/ui\/commons\/CloudFilePicker.*/"
				},
				module: [
					"./CloudFilePicker.qunit"
				]
			},
			/*
			 * Collaboration
			...
			Collaboration: {
				group: "Collaboration",
				coverage: {
					only: "//sap\/suite\/ui\/commons\/collaboration\/.*/"
				},
				module: [
					"./collaboration/TeamsHelperService.qunit",
					"./collaboration/ServiceContainer.qunit",
					"./collaboration/CollaborationHelper.qunit",
					"./collaboration/ContactHelper.qunit",
					"./collaboration/CollaborationCardHelper.qunit"
				]
			}
		}
	};
