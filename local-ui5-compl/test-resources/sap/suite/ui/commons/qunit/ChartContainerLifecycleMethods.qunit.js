sap.ui.define([
...
], function(ChartContainerContent, ChartContainer, VizFrame, ToggleButton, OverflowToolbarButton, mobileLibrary, SegmentedButton,
			ResizeHandler, ScrollEnablement, nextUIUpdate) {
	"use strict";
	...
	QUnit.test("_oShowLegendButton for different values of showLegend & showLegendButton", async function(assert) {
