sap.ui.define([
	...
	"require"
], function(MockServer, require) {
	"use strict";

	var MockServerInitializer = function(){
		var sMockServerDataFolderPath = require.toUrl("./");
	...
	MockServerInitializer.prototype.initializeMockData = function(oGroupFeedComponent) {
		...
		oSocialProfile._createView().then((oPopoverView) => {
			var oSocialProfileController = oPopoverView.getController();
