sap.ui.define([
	...
	"sap/gantt/misc/Utility"
            ...
            DateFormat, FullScreenStrategy, UriParameters, StepwiseTimeLineOptions, GanttChartConfigurationUtils, Utility) {
	"use strict";
	...
	var oCustomZoomSettings = {
		...
		timeLineOption: StepwiseTimeLineOptions.Month
	};
	...
	return Controller.extend("sap.gantt.simple.test.GanttChartArtifacts", {
		...
		createTimeLineOptions: function () {
			...
			var timeLineOptions = StepwiseTimeLineOptions;
