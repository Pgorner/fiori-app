sap.ui.define([
	...
	var oSandbox = sinon.sandbox.create(),
		...
		sNamespace = sap.ui.require.toUrl("sap/gantt/sample/GanttChartODataV4/localService"),
	...
	function readData() {
		var oMetadataPromise = new Promise(function (fnResolve, fnReject) {
				var sResourcePath = sap.ui.require.toUrl(sNamespace + "/metadata.xml"),
					oRequest = new XMLHttpRequest();

				sResourcePath = sResourcePath.replace("/resources","");
			...
			oMockDataPromise = new Promise(function (fnResolve, fnReject) {
				var sResourcePath
						= sap.ui.require.toUrl(sNamespace + "/mockdata/people.json");
						sResourcePath = sResourcePath.replace("/resources","");
