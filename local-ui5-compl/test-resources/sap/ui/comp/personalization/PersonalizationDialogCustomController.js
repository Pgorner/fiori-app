...
], function(compLibrary, PersonalizationDialog, Util, Controller, BaseController, P13nPanel,
		MultiComboBox, App, Page, Toolbar, CheckBox, Carousel, Panel, Shell, Item, jQuery) {
	'use strict';
