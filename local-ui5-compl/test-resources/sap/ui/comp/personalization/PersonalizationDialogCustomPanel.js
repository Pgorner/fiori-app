sap.ui.define([
...
], function (PersonalizationDialog, Util, Controller, MessageToast, Item, MultiComboBox,
		RadioButtonGroup, RadioButton, P13nDialog, JSONModel, App, Page, Toolbar, CheckBox, Carousel, Panel, Shell, P13nPanel, jQuery) {
	"use strict";

	// P13nPanel extention
	const CustomPanelColumns = P13nPanel.extend("sap.m.CustomPanelColumns", {
	...
	// P13nPanel extention
	const CustomPanelSetting = P13nPanel.extend("sap.m.CustomPanelSetting", {
		constructor: function (sId, mSettings) {
			P13nPanel.apply(this, arguments);
		},
		metadata: {
