sap.ui.define([
	...
	"sap/ui/comp/sample/smartlink/example_05/formatter",
	"sap/ui/comp/navpopover/LinkData",
	"sap/ui/comp/navpopover/SemanticObjectController",
	"sap/ui/core/Title",
	"sap/ui/layout/form/SimpleForm",
	"sap/m/Text"
], function(Controller, JSONModel, formatter, LinkData, SemanticObjectController, Title, SimpleForm, Text) {
	"use strict";
	...
	return Controller.extend("sap.ui.comp.sample.smartlink.example_05.Example", {
		...
		onNavigationTargetsObtainedOnlyContent: function(oEvent) {
			var oParameters = oEvent.getParameters();
			oParameters.show("", null, [], new SimpleForm({
				maxContainerCols: 1,
				content: [
					new Title({
						text: "Detailed information"
