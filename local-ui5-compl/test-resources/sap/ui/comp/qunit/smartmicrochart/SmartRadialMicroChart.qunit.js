...
], function (SmartRadialMicroChart, SmartMicroChartBase, CustomData, Model, ChartProvider, JSONModel,
			 Label, RadialMicroChart, microchartLibrary, Log, Button, MLibrary, nextUIUpdate) {
	"use strict";
