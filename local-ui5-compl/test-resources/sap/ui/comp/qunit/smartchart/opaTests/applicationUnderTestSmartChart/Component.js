sap.ui.define([
	"sap/ui/core/UIComponent", 'sap/ui/comp/navpopover/FakeFlpConnector', 'sap/ui/comp/navpopover/SemanticObjectController'
], function(UIComponent, FakeFlpConnector, SemanticObjectController) {
	"use strict";

	return UIComponent.extend("applicationUnderTestSmartChart", {
		metadata: {
			manifest: "json"
		},
