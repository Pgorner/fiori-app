	...
	return UIComponent.extend("sap.ui.comp.sample.smartfilterbar_types.Component", {
		...
		init: function () {
			...
			oMockServer.simulate(sMetadataUrl, {
				...
				aEntitySetsNames: [
					"ZEPM_C_SALESORDERITEMQUERYResults", "ZEPM_C_SALESORDERITEMQUERY", "StringVH", "StringNoTextVH", "StringNoItemsVHVL", "StringVHVLTX", "StringInOutVH", "StringVHStringAuto", "StringInOutVHDeprecationCode", "WhiteSpace", "C_RFDYRqmtRefreshStrategyVH"
				]
			});
