...
sap.ui.define([
	...
	QUnit.module("Custom operation enter text in field");
	...
	opaTest("TestPage5", function(Given, When, Then) {
		...
		// Act
		When.iEnterValue("smartFilterBar-filterItemControlA_-Test5-input", "Due Up Until Tomorrow", false);
		When.iPressTheFilterGoButton();
	...
	opaTest("TestPage6", function(Given, When, Then) {
		...
		// Act
		When.iEnterValue("smartFilterBar-filterItemControlA_-Test6-input", "Yesterday and Today", false);
		When.iPressTheFilterGoButton();
	...
	opaTest("TestPage8", function(Given, When, Then) {
		...
		// Act
		When.iEnterValue("smartFilterBar-filterItemControlA_-Test8-input", "Within Last 14 Days", false);
		When.iPressTheFilterGoButton();
		...
		// Act
		When.iEnterValue("smartFilterBar-filterItemControlA_-Test8-input","Last 31 To 90 Days", false);
		When.iPressTheFilterGoButton();
	...
	opaTest("TestPage9", function(Given, When, Then) {
		...
		Given.iEnsureMyAppIsRunning();
		// Act
		When.iEnterValue("smartFilterBar-filterItemControlA_-Test9-input", "Next 30 Minutes", false);
		When.iPressTheFilterGoButton();
	...
	opaTest("TestPage10", function(Given, When, Then) {
		...
		// Act
		When.iEnterValue("smartFilterBar-filterItemControlA_-Test10-input", "Next 3 years from date", false);
		When.iPressTheFilterGoButton();
	...
	opaTest("TestPage12", function(Given, When, Then) {
		...
		// Act
		When.iEnterValue("smartFilterBar-filterItemControlA_-Test12-input", "Next 4 Weeks", false);
		When.iPressTheFilterGoButton();
