sap.ui.define([
	...
	'sap/m/library'
], function(Opa5, opaTest, Util, Arrangement, Action, Assertion, mlibrary) {
	'use strict';
	...
	opaTest("When I load 'PriceAtFirstAndDateAtLast' variant and open the dialog, the variant columns should appear and the 'Restore' button should be disabled", function(Given, When, Then) {
		//Actions
		When.iSelectVariant("PriceAtFirstAndDateAtLast").and.iPressOnPersonalizationButton(true).and.iNavigateToPanel(Util.getTextFromResourceBundle("sap.ui.mdc", "p13nDialog.TAB_Column"));
