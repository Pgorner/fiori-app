sap.ui.define([
	...
	opaTest("When I navigate to filter panel, the filter should be empty", function(Given, When, Then) {
		Device.system.phone ? When.iPressBackButton().and.iNavigateToPanel(Util.getTextFromResourceBundle("sap.m", "FILTERPANEL_TITLE")) : When.iNavigateToPanel(Util.getTextFromResourceBundle("sap.m", "FILTERPANEL_TITLE"));
	...
	opaTest("When I navigate to group panel, the group should be empty", function(Given, When, Then) {
		Device.system.phone ? When.iPressBackButton().and.iNavigateToPanel(Util.getTextFromResourceBundle("sap.m", "GROUPPANEL_TITLE")) : When.iNavigateToPanel(Util.getTextFromResourceBundle("sap.m", "GROUPPANEL_TITLE"));
	...
	opaTest("When I load 'Compatibility03' variant and open columns panel of the dialog, some columns should be changed", function(Given, When, Then) {
		//Actions
		When.iSelectVariant("Compatibility03").and.iPressOnPersonalizationButton(true).and.iNavigateToPanel(Util.getTextFromResourceBundle("sap.ui.mdc", "p13nDialog.TAB_Column"));
	...
	opaTest("When I load 'Compatibility05' variant and open columns panel of the dialog, some columns should be changed", function(Given, When, Then) {
		//Actions
		When.iSelectVariant("Compatibility05").and.iPressOnPersonalizationButton(true).and.iNavigateToPanel(Util.getTextFromResourceBundle("sap.ui.mdc", "p13nDialog.TAB_Column"));
	...
	opaTest("When I load 'Compatibility06' variant and open columns panel of the dialog, some columns should be changed", function(Given, When, Then) {
		//Actions
		When.iSelectVariant("Compatibility06").and.iPressOnPersonalizationButton(true).and.iNavigateToPanel(Util.getTextFromResourceBundle("sap.ui.mdc", "p13nDialog.TAB_Column"));
	...
	opaTest("When I load 'Compatibility07' variant and open columns panel of the dialog, some columns should be changed", function(Given, When, Then) {
		//Actions
		When.iSelectVariant("Compatibility07").and.iPressOnPersonalizationButton(true).and.iNavigateToPanel(Util.getTextFromResourceBundle("sap.ui.mdc", "p13nDialog.TAB_Column"));
	...
	opaTest("When I load 'Compatibility08' variant and open columns panel of the dialog, some columns should be changed", function(Given, When, Then) {
		//Actions
		When.iSelectVariant("Compatibility08").and.iPressOnPersonalizationButton(true).and.iNavigateToPanel(Util.getTextFromResourceBundle("sap.ui.mdc", "p13nDialog.TAB_Column"));
	...
	opaTest("When I load 'Compatibility09' variant and open columns panel of the dialog, some columns should be changed", function(Given, When, Then) {
		//Actions
		When.iSelectVariant("Compatibility09").and.iPressOnPersonalizationButton(true).and.iNavigateToPanel(Util.getTextFromResourceBundle("sap.ui.mdc", "p13nDialog.TAB_Column"));
	...
	opaTest("When I load 'Compatibility10' variant and open columns panel of the dialog, some columns should be changed", function(Given, When, Then) {
		//Actions
		When.iSelectVariant("Compatibility10").and.iPressOnPersonalizationButton(true).and.iNavigateToPanel(Util.getTextFromResourceBundle("sap.ui.mdc", "p13nDialog.TAB_Column"));
	...
	opaTest("When I navigate to filter panel, filter should be changed", function(Given, When, Then) {
		...
		Then.iShouldSeeFilterWithNameAndToken("Price", "<100.0000", "LT");
	});
	opaTest("When I navigate to group panel, the group should be changed", function(Given, When, Then) {
		...
		Then.iShouldSeeGroupSelectionWithCheckedShowFieldAsColumn("Product Category", true);
		Then.iShouldSeeGroupSelectionWithEnabledShowFieldAsColumn("Product Category", true);
	});
