...
sap.ui.define([
	...
	"sap/base/Log"
], function(Localization, Element, nextUIUpdate, RichTextEditor, Button, Core, InvisibleText, XMLView, jQuery, rteLibrary, Log) {
	"use strict";
	...
	return function runRTECommonTests(sEditorType) {
		...
		var fnTestControlLifecycle = function (assert) {
			...
			oRichTextEditor1.attachReady(function () {
				...
				assert.ok(!!tinymce.editors["RTETestControlLifecycle-textarea"], "tinymce editor 'RTETestControlLifecycle-textarea' must be definied");
				done();
				assert.equal(tinymce.editors["RTETestControlLifecycle-textarea"].id, "RTETestControlLifecycle-textarea", "tinymce id must be 'RTETestControlLifecycle-textarea'");
				...
				assert.ok(!tinymce.editors["RTETestControlLifecycle-textarea"], "tinymce editor 'RTETestControlLifecycle-textarea' must not be definied after destruction");
				done();
			});
		...
		var fnTestControlSize = function (assert) {
			...
			Core.getUIArea("content") && Core.getUIArea("content").removeAllContent();
			...
			oRichTextEditor1.attachReady(function () {
				...
				assert.ok(!tinymce.editors["RTETestControlSize-textarea"], "tinymce editor 'RTETestControlSize-textarea' must not be definied after destruction");
				done();
			});
		...
		var fnTestNativeApi = function (assert) {
			...
			oRichTextEditor1.attachReady(function () {
				...
				assert.ok(!tinymce.editors["RTETestNativeApi-textarea"], "tinymce editor 'RTETestNativeApi-textarea' must not be definied after destruction");
				done();
			});
		...
		var fnTestInitialValue = function (assert) {
			...
			oRichTextEditor1.attachReady(function () {
				...
				assert.ok(!tinymce.editors["RTETestInitialValue-textarea"], "tinymce editor 'RTETestInitialValue-textarea' must not be definied after destruction");
				done();
			});
		...
		var fnTestSetValue = function (assert) {
			...
			oRichTextEditor1.attachReady(function () {
				...
				setTimeout(function () {
					...
					assert.ok(!tinymce.editors["RTETestSetValue-textarea"], "tinymce editor 'RTETestSetValue-textarea' must not be definied after destruction");
					done();
				}, 0);
			});
		...
		var fnTestSanitization = function (assert) {
			...
			oRichTextEditor1.attachReady(function () {
				...
				setTimeout(function () {
					...
					assert.ok(!tinymce.editors["RTETestSanitization-textarea"], "tinymce editor 'RTETestSanitization-textarea' must not be definied after destruction");
					done();
				}, 0);
			});
		...
		var fnTestIframeSanitization = function (assert) {
			var done = assert.async(2);

			var myValue = '<iframe><textarea></iframe><img src="a" onerror="alert(document.domain)" />';
			var mySanitizedValue = '<p><iframe><textarea></iframe><img src=\"a\" /></p>';
			var mySFSanitizedValue = '<p><iframe>&lt;textarea&gt;</iframe><img src=\"a\" /></p>';

			var oRichTextEditor = new RichTextEditor("RTETestIframeSanitization", {
				editorType: sEditorType,
				width: "400px",
				height: "300px"
			});
			...
			oRichTextEditor.attachReady(function () {
				...
				// Safari and IE uses "&lt" and "&gt" for "<" and ">", therefore we are required to have a condition
				assert.ok(oRichTextEditor.getNativeApi().getContent() === mySanitizedValue ||  oRichTextEditor.getNativeApi().getContent() === mySFSanitizedValue, "Editor should have the correct content value");
				done();
		...
		var fnTestLinkTargets = function (assert) {
			...
			oRichTextEditor1.attachReady(function () {
				...
				setTimeout(function () {
					...
					assert.ok(!tinymce.editors["RTETestLinkTargets-textarea"], "tinymce editor 'RTETestLinkTargets-textarea' must not be definied after destruction");
					done();
				}, 0);
			});
		...
		QUnit.test("setValue with comments", async function(assert) {
			...
			oRichTextEditor.attachReady(function () {
				...
				setTimeout(function () {
					...
					assert.ok(!tinymce.editors["RTEsetValue-textarea"], "tinymce editor 'RTEsetValue-textarea' must not be definied after destruction");
					done();
				}, 0);
			});
		...
		QUnit.test("setValue with HTML", async function(assert) {
			...
			oRichTextEditor.attachReady(function () {
				...
				setTimeout(function () {
					...
					assert.ok(!tinymce.editors["RTEsetValueHTML-textarea"], "tinymce editor 'RTEsetValueHTML-textarea' must not be definied after destruction");
					done();
				}, 0);
			});
		...
		QUnit.test("setValue sanitization escaping", async function(assert) {
			...
			oRichTextEditor.attachReady(function () {
				...
				setTimeout(function () {
					...
					assert.ok(!tinymce.editors["RTEsetValueEscaping-textarea"], "tinymce editor 'RTEsetValueEscaping-textarea' must not be definied after destruction");
					done();
				}, 0);
			});
		...
		QUnit.test("setValue sanitization", fnTestIframeSanitization);
		...
		QUnit.test("Lifecycle", async function(assert) {
			...
			oRichTextEditor1.attachReady(function () {
				...
				assert.ok(!!tinymce.editors["RTELifecycle-textarea"], "tinymce editor 'RTELifecycle-textarea' must be definied");
				done();
				assert.equal(tinymce.editors["RTELifecycle-textarea"].id, "RTELifecycle-textarea", "tinymce id must be 'RTELifecycle-textarea'");
				...
				assert.ok(!tinymce.editors["RTELifecycle-textarea"], "tinymce editor 'RTELifecycle-textarea' must not be definied after destruction");
				done();
			});
