...
sap.ui.define([
	...
	QUnit.test("Highlight", function(assert) {
		...
		assert.equal(highlight2.getName(), "", "getName default value of highlight");
		assert.deepEqual(highlight2.getOpacities(), [], "getOpacities default value of highlight");
		assert.deepEqual(highlight2.getColours(), [], "getColours default value of highlight");
		...
		assert.equal(result.opacity, 0.5, "getOpacity of finite highlight at the start of 1st cycle");
		assert.equal(result.isCompleted, false, "getOpacity of finite highlight at the start of 1st cycle");
		assert.equal(highlight2.getOpacity(0.5).opacity, 1.0, "getOpacity of finite highlight at the 1st time of 1st cycle");
		assert.equal(highlight2.getOpacity(1).opacity, 0.5, "getOpacity of finite highlight at the 2nd time of 1st cycle");
		assert.equal(highlight2.getOpacity(2).opacity, 0.5, "getOpacity of finite highlight at the start of 2nd cycle");
		assert.equal(highlight2.getOpacity(3).opacity, 0.5, "getOpacity of finite highlight at the 1st time of 2nd cycle");
		assert.equal(highlight2.getOpacity(3.5).opacity, undefined, "getOpacity of finite highlight at the end of 2nd cycle");
		assert.equal(highlight2.getOpacity(4.5).opacity, undefined, "getOpacity of finite highlight outside playing cycle");
		assert.equal(highlight2.getOpacity(7).opacity, undefined, "getOpacity of finite highlight outside playing cycle");
		...
		assert.deepEqual(highlight2.getColour(2).colour, [1.0, 1.0, 1.0, 1.0], "getColour of finite highlight at the start of 2nd cycle");
		...
		assert.equal(highlight2.getOpacity(0).opacity, 0.5, "getOpacity of infinite highlight at the start of 1st cycle");
		assert.equal(highlight2.getOpacity(0.25).opacity, 0.75, "getOpacity of infinite highlight at the 1st time of 1st cycle");
		assert.equal(highlight2.getOpacity(1).opacity, 0.5, "getOpacity of infinite highlight at the 2nd time of 1st cycle");
		assert.equal(highlight2.getOpacity(1.5).opacity, 1.0, "getOpacity of infinite highlight at the end of 1st cycle");
		result = highlight2.getOpacity(2.0);
		assert.equal(result.opacity, 0.5, "getOpacity of infinite highlight at the start of 2nd cycle");
		assert.equal(result.isCompleted, false, "getOpacity of infinite highlight at the start of 2nd cycle");
		assert.equal(highlight2.getOpacity(2.5).opacity, 1.0, "getOpacity of infinite highlight at the 1st time of 2nd cycle");
		assert.equal(highlight2.getOpacity(2.75).opacity, 0.75, "getOpacity of infinite highlight at the 2nd time of 2nd cycle");
		result = highlight2.getOpacity(3.5);
		assert.equal(result.opacity, 1.0, "getOpacity of infinite highlight at the end of 2nd cycle");
		assert.equal(result.isCompleted, false, "getOpacity of infinite highlight at the end of 2nd cycle");
		assert.equal(highlight2.getOpacity(60).opacity, 0.5, "getOpacity of infinite highlight at start of 30th cycle");
		assert.equal(highlight2.getOpacity(60.5).opacity, 1.0, "getOpacity of infinite highlight within 30th cycle");
		assert.equal(highlight2.getOpacity(62).opacity, 0.5, "getOpacity of infinite highlight at the end of 30th cycle");
