...
sap.ui.define([
	...
	QUnit.test("Three JS Material Interface", function(assert) {
		...
		var testMaterial = function() {
			...
			material.setGlossiness(sourceData.glossiness);
			...
			var glossiness = material.getGlossiness();
			assert.ok(sourceData.opacity === opacity &&
				sourceData.glossiness === glossiness, "Setting and getting opacity and glossiness works ok");
		...
		var testLineMaterial = function() {
			var material = new Material(MaterialType.LineBasicMaterial);
			var c = {
				red: sourceData.lineColourR,
