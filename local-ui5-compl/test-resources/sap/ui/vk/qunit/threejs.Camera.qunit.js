...
sap.ui.define([
	...
	QUnit.skip("MAIN TEST", function(assert) {
		...
		viewport.attachNodeZoomed(function(event) {
			...
			var cameraTarget = bbox.getCenter(new THREE.Vector3());
			...
			var cameraDir = camera.getWorldDirection(new THREE.Vector3()).normalize();
