...
sap.ui.define([
	...
	QUnit.test("Test AnchorPointTool", function(assert) {
		...
		tool.moveTo(box.matrix);
		testGizmoPosition(0, 10, 0, "moveTo(box.matrix) test");

		tool.moveTo(cone.matrix);
		testGizmoPosition(25, 10, 0, "moveTo(cone.matrix) test");

		tool.moveTo(cylinder.matrix);
		testGizmoPosition(-25, -10, 0, "moveTo(cylinder.matrix) test");

		tool.moveTo(sphere.matrix);
		testGizmoPosition(0, -10, 0, "moveTo(cylinder.matrix) test");
		...
		tool.alignTo(cylinder.matrix);
		testGizmoQauternion(cylinder.quaternion, "alignTo(cylinder.matrix) test1 ");

		viewport.fireCameraChanged();
		testGizmoQauternion(cylinder.quaternion, "alignTo(cylinder.matrix) test 2");
