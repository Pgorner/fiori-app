...
sap.ui.define([
	...
	QUnit.test("Testing RedlineElementEllipse", function(assert) {
		...
		assert.strictEqual(ellipse.getRadiusX(), 0.25, "After editing by (250, 400), 'radiusX' becomes 0.25");
		assert.strictEqual(ellipse.getRadiusY(), 0.4, "After editing by (250, 400), 'radiusY' becomes 0.4");
