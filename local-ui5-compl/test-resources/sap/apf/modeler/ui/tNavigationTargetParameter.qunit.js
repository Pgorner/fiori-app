...
sap.ui.define([
	...
	function commonSetup(id, assert) {
		...
		modelerUIHelper.getModelerInstance(async function(modelerInstance) {
			...
			testEnv.oNavigationTargetController = await Controller.create({
				name : "sap.apf.modeler.ui.controller.navigationTarget"
			});
			testEnv.oNavigationTargetView = await View.create({
	...
	QUnit.test("Enter parameter with an already existing key", function(assert) {
		...
		assert.strictEqual(this.addNavigationParameterSpy.callCount, 1, "addNavigationParameter called once");
		assert.strictEqual(this.addNavigationParameterSpy.getCall(0).args[0], "key", "addNavigationParameter called with key");
		assert.strictEqual(secondNavigationParameter.byId("idNavigationParametersKey").getValueState(), ValueState.Error, "Error state set");
		// Update second key
		secondNavigationParameter.byId("idNavigationParametersKey").setValue("key2");
		secondNavigationParameter.byId("idNavigationParametersValue").fireChange();
		...
		assert.strictEqual(secondNavigationParameter.byId("idNavigationParametersKey").getValueState(), ValueState.None, "Error state removed");
	});
	...
	QUnit.test("Remove key and validate", function(assert){
		...
		assert.strictEqual(firstNavigationParameter.byId("idNavigationParametersKey").getValueState(), ValueState.Error, "Value state of key entry set to Error");
		...
		assert.strictEqual(firstNavigationParameter.byId("idNavigationParametersValue").getValueState(), ValueState.None, "No Error for Value field");
		firstNavigationParameter.byId("idNavigationParametersKey").setValue("Key");
		firstNavigationParameter.byId("idNavigationParametersKey").fireChange();
		assert.strictEqual(firstNavigationParameter.byId("idNavigationParametersKey").getValueState(), ValueState.None, "Error state removed after entering key");
	});
	QUnit.test("Remove value and validate", function(assert){
		...
		firstNavigationParameter.byId("idNavigationParametersValue").fireChange();
		assert.notOk(this.oNavigationTargetController.getValidationState(), "Navigation Target is not valid");
		assert.strictEqual(firstNavigationParameter.byId("idNavigationParametersValue").getValueState(), ValueState.Error, "Value state of Value entry set to Error");
		...
		assert.strictEqual(firstNavigationParameter.byId("idNavigationParametersKey").getValueState(), ValueState.None, "No Error for Key field");
		firstNavigationParameter.byId("idNavigationParametersValue").setValue("Key");
		firstNavigationParameter.byId("idNavigationParametersValue").fireChange();
		assert.strictEqual(firstNavigationParameter.byId("idNavigationParametersKey").getValueState(), ValueState.None, "Error state removed after entering Value");
	});
