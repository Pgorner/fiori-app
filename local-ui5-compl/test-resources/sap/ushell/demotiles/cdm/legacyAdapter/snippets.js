...
(function () {
    ...
    function fakeUI2Contracts (oTile) { // eslint-disable-line no-unused-vars
        var sSemanticObject = oTile.target.semanticObject || "";
        var sAction = oTile.target.action || "";
        var sParameters = JSON.stringify(oTile.target.parameters) || ""; // TODO stringify is not correct
        var sUrl = "#" + sSemanticObject + "-" + sAction;
        var oBagTileProperties = new CdmBag("tileProperties", [], [
        ...
        var oBagTileNavigationActions = new CdmBag("tileNavigationActions", [
