...
sap.ui.define([
    ...
    // Controller needs to be preloaded
    "sap/ushell/demotiles/abap/customTileDynamic/DynamicTile.controller"
], function (GenericTile, mobileLibrary, NumericContent, TileContent, View) {
    "use strict";

    // shortcut for sap.m.ValueColor
    var ValueColor = mobileLibrary.ValueColor;

    return View.extend("sap.ushell.demotiles.abap.customTileDynamic.DynamicTile", {
