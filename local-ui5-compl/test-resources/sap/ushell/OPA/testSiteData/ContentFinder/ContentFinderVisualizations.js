...
sap.ui.define([], function () {
    ...
    return {
        visualizations: {
            ...
            nodes: [
                {
                    id: "8adf91e9-b17a-425e-8053-f39b62f0c31e1",
                    type: "sap.ushell.StaticAppLauncher",
                    targetAppIntent: "#Action-app1",
                    descriptor: {
                        value: {
                            "sap.app": {
                                id: "F075632",
                                title: "Success Map",
                                subTitle: "Access Success Map"
                            },
                            "sap.flp": {
                                target: {
                                    type: "URL",
                ...
                {
                    id: "8adf91e9-b17a-425e-8053-f39b62f0c31e3",
                    type: "sap.ushell.StaticAppLauncher",
                    descriptor: {
                        value: {
                            "sap.app": {
                                id: "F075634",
                                title: "Application Title Example Double line.",
                                subTitle: "Subheader"
                            },
                            "sap.flp": {
                                target: {
                ...
                {
                    id: "8adf91e9-b17a-425e-8053-f39b62f0c31e4",
                    type: "sap.ushell.StaticAppLauncher",
                    descriptor: {
                        value: {
                            "sap.app": {
                ...
                {
                    id: "8adf91e9-b17a-425e-8053-f39b62f0c31e6",
                    type: "sap.ushell.StaticAppLauncher",
                    descriptor: {
                        value: {
                            "sap.app": {
                                id: "F075637",
                                title: "Quotation Conversion Rater"
                            },
                            "sap.flp": {
                                target: {
                                    type: "URL",
                ...
                {
                    id: "8adf91e9-b17a-425e-8053-f39b62f0c31e7",
                    type: "sap.ushell.StaticAppLauncher",
                    descriptor: {
                        value: {
                            "sap.app": {
                ...
                {
                    id: "8adf91e9-b17a-425e-8053-f39b62f0c31e9",
                    type: "sap.ushell.StaticAppLauncher",
                    descriptor: {
                        value: {
                            "sap.app": {
                ...
                {
                    id: "8adf91e9-b17a-425e-8053-f39b62f0c31e10",
                    type: "sap.ushell.StaticAppLauncher",
                    descriptor: {
                        value: {
                            "sap.app": {
                                id: "F456789",
                                title: "Drown Employees",
                                subTitle: "Get rid of annoying questions"
                            },
                            "sap.flp": {
                                target: {
                                    type: "URL",
                ...
                {
                    id: "8adf91e9-b17a-425e-8053-f39b62f0c31e11",
                    type: "sap.ushell.StaticAppLauncher",
                    descriptor: {
                        value: {
                            "sap.app": {
