...
/**
 * @file Sample Fiori sandbox application configuration.
 */
sap.ui.define("sap.ushell.shells.demo.fioriDemoConfig", [
    ...
    var oTestContent = {
        ...
        catalogs: [{
            ...
            },
            {
                ...
                properties: {
                    ...
                    subtitle: "A tile wrapped in a component",
                    infoState: "Neutral",
                    info: "Has no target so that it is displayed as tile in the App Finder",
                    targetURL: ""
                }
            }]
        }, {
        ...
        applications: {
            ...
            "Action-toappnavsample2": {
                ...
                description: "AppNavSample2 Inner App Navigation: Do it your self (Early(component) navigator instantiation, " +
                    "simple route registration example, no model binding, explicit view changes within the app)"
            },
            ...
            "UI2Fiori2SampleApps-approvepurchaseorders": {
                ...
                description: "ApprovePurchaseOrders:SAP UI5 Best practice App (Inner App Navigation): " +
                    "explicit mapping of routes to model bindings and views, automatic view changes by the Nav framework"
            },
            "UI2Fiori2SampleApps-navigationwithroutes": {
                ...
                description: "NavigationWithRoutes:Shows how to navigate using routes without the context property"
            },
    ...
    function writeToUshellConfig (oConfig) {
        var oLaunchPageAdapterConfig = ObjectPath.create("sap-ushell-config.services.LaunchPage.adapter.config");
        oLaunchPageAdapterConfig.groups = oConfig.groups;
        oLaunchPageAdapterConfig.catalogs = oConfig.catalogs;
        var oVisualizationDataProviderAdapterConfig = ObjectPath.create("sap-ushell-config.services.VisualizationDataProvider.adapter.config");
        oVisualizationDataProviderAdapterConfig.groups = oConfig.groups;
        oVisualizationDataProviderAdapterConfig.catalogs = oConfig.catalogs;
        ObjectPath.create("sap-ushell-config.services.NavTargetResolution.adapter.config").applications = oConfig.applications;
        ObjectPath.create("sap-ushell-config.services.NavTargetResolutionInternal.adapter.config").applications = oConfig.applications;

        var oPersonalizationAdapterConfig = ObjectPath.create("sap-ushell-config.services.Personalization.adapter.config");
        ...
        var oPersonalizationV2AdapterConfig = ObjectPath.create("sap-ushell-config.services.PersonalizationV2.adapter.config");
        oPersonalizationV2AdapterConfig.personalizationData = oConfig.personalizationData;
        oPersonalizationV2AdapterConfig.storageType = oConfig.personalizationStorageType;
    ...
    if (oUriParameters.get("use-demo-content") === "true") {
        writeToUshellConfig(oDemoContent);
    } else {
        ...
        delete ObjectPath.get("sap-ushell-config.services.NavTargetResolutionInternal.adapter.config").applications[""];
    }
    var sEasyAccessRealDataParameter = oUriParameters.get("easy-access-real-data");
    if (!sEasyAccessRealDataParameter || sEasyAccessRealDataParameter === "false") {
        // mock data for easyAccess
        var oConfig = ObjectPath.create("sap-ushell-config.renderers.fiori2.componentData.config.applications.Shell-home");

        if (oConfig) {
            oConfig.easyAccessNumbersOfLevels = 1;
        }

        var baseUrl = sap.ui.require.toUrl("sap/ushell/shells/demo");
        mockserver.loadMockServer(baseUrl + "/AppFinderData/EASY_ACCESS_MENU/", "/sap/opu/odata/UI2/EASY_ACCESS_MENU;o=LOCAL/");
        mockserver.loadMockServer(baseUrl + "/AppFinderData/EASY_ACCESS_MENU/", "/sap/opu/odata/UI2/EASY_ACCESS_MENU;o=U1YCLNT120/");
        mockserver.loadMockServer(baseUrl + "/AppFinderData/USER_MENU/LOCAL/", "/sap/opu/odata/UI2/USER_MENU;o=LOCAL/");
        mockserver.loadMockServer(baseUrl + "/AppFinderData/USER_MENU/U1YCLNT120/", "/sap/opu/odata/UI2/USER_MENU;o=U1YCLNT120/");
    }
});
