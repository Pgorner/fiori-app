    ...
    var oTestContent = {
        ...
        applications: {
            ...
            "Action-toappnavsample2": {
                ...
                description: "AppNavSample2 Inner App Navigation: Do it your self " +
                    "(Early(component) navigator instantiation, simple route registration example, no model binding, explicit view changes within the app)"
            },
