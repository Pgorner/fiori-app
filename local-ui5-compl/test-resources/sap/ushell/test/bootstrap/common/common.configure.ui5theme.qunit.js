...
sap.ui.define([
    ...
    [{
        ...
        QUnit.test("configureUI5theme: copies theme ranges to /services/UserInfo/adapter/config/themes as expected when " + oFixture.testDescription, function (assert) {
            ...
            // Arrange
            var oUshellConfig = deepExtend({}, oFixture.oUshellConfig);

            // Act
            fnConfigureUI5Theme(oUshellConfig);

            // Sanity
            oUserProfileMetadataFixture = ObjectPath.get("oUshellConfig.services.Container.adapter.config.userProfile.metadata", oFixture) || {};
            oUserInfoAdapterConfig = ObjectPath.get("services.UserInfo.adapter.config", oUshellConfig) || {};
