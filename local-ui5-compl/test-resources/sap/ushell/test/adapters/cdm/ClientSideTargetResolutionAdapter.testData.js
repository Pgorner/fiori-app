...
sap.ui.define(["sap/base/util/ObjectPath"], function (ObjectPath) {
    ...
    var oLpaData = ObjectPath.create("sap.ushell.test.data.cdm.FlpLaunchPageAdapter");
    var oCdmData = ObjectPath.create("sap.ushell.test.data.cdm.cdmSiteService");
    var oCstrData = ObjectPath.create("sap.ushell.test.data.cdm.ClientSideTargetResolution");
    ...
    oCdmData.site = {
        applications: {
                    ...
                    crossNavigation: {
                        inbounds: {
                            tosu01: {
                                ...
                                signature: {
                                    parameters: {
                                        "sap-system": { defaultValue: { value: "U1YCLNT111" } }
                                    }
                                },
                                deviceTypes: {
                                    desktop: true,
            ...
            "sap.ushell.demo.AppNavSample": {
                "sap.app": {
                    title: "Demo actual title AppNavSample : Demos startup parameter passing ( albeit late bound in model!) "
                        + "and late instantiation of navigator in view (low level manual routing only)",
                    shortTitle: "short Title",
            ...
            "sap.ushell.demo.startURL": {
                ...
                "sap.platform.runtime": { uri: "http://nytimes.com" }
            },
            shellPluginToBeIgnored: {
                    ...
                    crossNavigation: {
                        inbounds: {
                            "Shell-plugin": {
                                ...
                                signature: {
                                    parameters: {
                                        localMode: { defaultValue: { value: "true" } }
                                    },
                                    additionalParameters: "ignored"
                                }
                            }
                ...
                "sap.ui5": { componentName: "sap.ushell.demo.UserDefaultPluginSample" },
                "sap.flp": { type: "plugin" },
                "sap.platform.runtime": {
                    componentProperties: {
