...
sap.ui.define([], function () {
     ...
     */
    function getCommonDataModelData () {
        var oCdmData = {};
        oCdmData.site = {
            site: {
                payload: {
            ...
            applications: {
                ...
                AppDesc2: {
                        ...
                        crossNavigation: {
                            inbounds: {
                                ...
                                sneaky: {
                                    semanticObject: "App2",
                                    action: "withFilter",
                                    signature: { parameters: { abc: { filter: { value: "ABC" } } } }
                                }
                            }
                        }
                    },
                    "sap.ui": {
                        technology: "WDA",
                        icons: { icon: "sap-icon://Fiori2/F0023" },
                        deviceTypes: {
                            desktop: true,
                            tablet: false,
                            phone: false
                ...
                SomePlugin: {
                    ...
                    "sap.ui": {
                        _version: "1.1.0",
                        technology: "UI5",
                        icons: { icon: "sap-icon://Fiori2/F0100" },
                        deviceTypes: {
                            desktop: true,
                            tablet: true,
                            phone: true
                        ...
                        componentProperties: {
                            ...
                            asyncHints: {
                                libs: [
                                    { name: "sap.m" },
                                    { name: "sap.ui.core" },
                                    { name: "sap.ui.unified", lazy: true }
                                ],
                                requests: [
                                    { name: "sap.ui.fl.changes", reference: "sap.ushell.demo.UIPluginSampleAddHeaderItems.Component" }
                                ]
                            }
                        }
                    }
            ...
            groups: {
                ...
                BOOKMARK_COUNT: {
                    ...
                    payload: {
                        tiles: [{
                            ...
                            target: { url: "http://www.sap.com?a=1" },
                            isBookmark: true
                        }, {
                            id: "08",
                            ...
                            id: "10",
                            target: { url: "http://www.sap.com?a=10" },
                            isBookmark: true
                        }, {
                            id: "11",
                            target: { url: "http://www.sap.com?a=10" },
                            ...
                            id: "12",
                            target: { url: "http://www.sap.com?a=12" },
                            isBookmark: true
                        }, {
                            id: "13",
                            icon: "sap-icon://favorite",
                            title: "Bookmark title 13",
                            target: { semanticObject: "SO", action: "action", appSpecificRoute: "&/test/123" },
                            isBookmark: true
                        }, {
                            id: "14",
                            icon: "sap-icon://world",
                            ...
                            id: "15",
                            icon: "sap-icon://world",
                            title: "Bookmark title 15",
                            target: { semanticObject: "SO", action: "action" },
                            contentProvider: "S4SYSTEM",
                            isBookmark: true
                        }],
                        links: [],
                        groups: []
                ...
                KEYWORDS: {
                    ...
                    payload: {
                        tiles: [{
                            ...
                            target: { semanticObject: "App3", action: "viaStatic" },
                            isBookmark: false
                        }],
                        links: [],
                        groups: []
                ...
                URL_TILES: {
                    ...
                    payload: { tiles: [{ id: "urlTile", vizId: "urlTile" }] }
                }
            },
            visualizations: {
                AppDesc1: {
                    ...
                    vizConfig: {
                        "sap.flp": { target: { appId: "AppDesc1", inboundId: "start" } }
                    }
                },
                AppDesc2: {
                    vizType: "sap.ushell.StaticAppLauncher",
                    ...
                    vizConfig: {
                        "sap.flp": { target: { appId: "AppDesc2", inboundId: "start" } }
                    }
                },
                AppPhone: {
                    vizType: "sap.ushell.StaticAppLauncher",
                    ...
                    vizConfig: {
                        "sap.flp": { target: { appId: "AppPhone", inboundId: "start" } }
                    }
                },
                CustomTileApplication: {
                    ...
                    vizConfig: {
                        "sap.flp": { target: { appId: "CustomTileApplication1", inboundId: "start" } }
                    }
                },
                urlTile: {
                    vizType: "sap.ushell.StaticAppLauncher",
                    ...
                    vizConfig: {
                        "sap.app": { title: "SAP Website" },
                        "sap.flp": { target: { type: "URL", url: "http://www.sap.com" } }
                    }
                },
                SomePlugin: {
                    vizType: "sap.ushell.StaticAppLauncher",
                    ...
                    vizConfig: {
                        "sap.flp": { target: { appId: "SomePlugin", inboundId: "Shell-plugin" } }
                    }
                }
            },
            vizTypes: {
        ...
        oCdmData.contentProviderSiteWithOneCatalog = {
            ...
            visualizations: {
                "3rdPartyApp1": {
                    vizType: "sap.ushell.StaticAppLauncher",
                    vizConfig: {
                        "sap.flp": { target: { appId: "3rdPartyApp1", inboundId: "Shell-launchURL" } }
                    }
                },
                "3rdPartyApp2": {
                    ...
                    vizConfig: {
                        "sap.flp": {
                            target: { appId: "3rdPartyApp2", inboundId: "Shell-launchURL" },
                            indicatorDataSource: {
            ...
            applications: {
                "3rdPartyApp1": {
                    ...
                    "sap.platform.runtime": { uri: "https://www.example.com" }
                },
                "3rdPartyApp2": {
                    "sap.app": {
                        id: "3rdPartyApp2",
        ...
        oCdmData.contentProviderSiteWithMultipleCatalogs = {
            ...
            catalogs: {
                "3rdPartyCatalogA": {
                    ...
                    payload: { appDescriptors: [{ id: "3rdPartyAppA" }] }
                },
                "3rdPartyCatalogB": {
                    identification: {
                        id: "3rdPartyCatalogB",
                    ...
                    payload: { appDescriptors: [{ id: "3rdPartyAppB" }] }
                }
            },
            applications: {
                "3rdPartyAppA": {
                    ...
                    "sap.platform.runtime": { uri: "https://jam4.sapjam.com/groups/about_page/7MFgdXHJVVv2BWC8g0Ubep" }
                },
                "3rdPartyAppB": {
                    "sap.app": {
                        id: "3rdPartyAppB",
                    ...
                    "sap.platform.runtime": { uri: "https://jam4.sapjam.com/groups/about_page/XVL4EFif3DZFfW0PQNf0Tt" }
                }
            },
            groups: {},
            systemAliases: {}
     ...
     */
    function getLaunchPageAdapterData () {
        var oLpaData = {};
        oLpaData.catalogs = getCommonDataModelData().site.catalogs;
            ...
            CustomTileApplication: {
                ...
                tileResolutionResult: {
                    ...
                    targetOutbound: {
                        ...
                        parameters: { XXX: { value: { value: "YYY" } } },
        ...
        oLpaData.extensionCatalogTiles = {
            "3rdPartyApp1": {
                ...
                tileResolutionResult: {
                    ...
                    isCard: false,
                    navigationMode: "newWindow",
                    runtimeInformation: { uri: "https://www.example.com" },
                    size: "1x1",
                    subTitle: "SAP JAM",
                    technicalInformation: undefined,
                    tileComponentLoadInfo: { componentName: "sap.ushell.components.tiles.cdm.applauncher" },
     ...
     */
    function getClientSideTargetResolutionData () {
        var oCstrData = {};
        oCstrData.resolvedTileHashes = {
            ...
            "#Dynamic-dataSourceFromManifest": {
                ...
                dataSources: { fooService: { uri: "sap/opu/fooData/" } }
            },
            "#Dynamic-dataSourceAdjustToComponentUri": {
                ...
                dataSources: { odata: { uri: "test/test.odata.svc/" } },
                runtimeInformation: { componentProperties: { url: "/component.relative.uri/~12345678910~/" } }
            },
            ...
            "#Shell-customTile": {
                ...
                size: "1x2",
                tileComponentLoadInfo: {
                    componentProperties: { url: "/sap/bc/ui5_demokit/test-resources/sap/ushell/demotiles/cdm/newstile" },
                    "sap.platform.runtime": {
                        componentProperties: { url: "/sap/bc/ui5_demokit/test-resources/sap/ushell/demotiles/cdm/newstile" }
                    },
                    applicationType: "URL",
            ...
            "#Shell-customTileWithTargetOutbound": {
                ...
                targetOutbound: {
                    semanticObject: "Action",
                    action: "toappnavsample",
                    parameters: { param1: { value: { value: "value1" } } }
                },
                tileComponentLoadInfo: {
                    componentProperties: { url: "/sap/bc/ui5_demokit/test-resources/sap/ushell/demotiles/cdm/newstile" },
                    "sap.platform.runtime": {
    ...
    return {
        getCommonDataModelData: getCommonDataModelData,
        getLaunchPageAdapterData: getLaunchPageAdapterData,
        getClientSideTargetResolutionData: getClientSideTargetResolutionData
    };
});
