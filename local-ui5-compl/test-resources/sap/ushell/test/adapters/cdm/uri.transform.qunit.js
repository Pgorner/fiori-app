...
sap.ui.define([
    ...
    [{
        ...
        testDescription: "(19) When called with (relative, relative, abs, abs) as parameters",
        input: {
            uri: "uri/uri",
            uriParent: "parent/parent",
            uriBase: "/base/base/",
            uriNewBase: "https://newbase/newbase"
        },
        expected: {
            uri: "uri/uri",
            uriAbsolute: "https://newbase/base/base/parent/uri/uri",
            uriBase: "https://newbase/",
            uriParent: "base/base/parent/parent",
            uriRelative: "base/base/parent/parent/uri/uri"
        },
        successMessage: "uri.transform returns { uri, uriAbsolute, uriBase, uriParent, uriRelative } properly calculated"
