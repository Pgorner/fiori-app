...
/**
 * @fileoverview QUnit tests for sap.ushell.adapters.cep.NavTargetResolutionInternalAdapter
 */

sap.ui.define([
        "sap/ushell/adapters/cep/NavTargetResolutionInternalAdapter",
    ...
    function (
        NavTargetResolutionInternalAdapter,
        ObjectPath,
        HttpClient,
        Config,
        Container
        ...
        QUnit.module("_getIntentForService", {
            beforeEach: function () {
                ...
                this.oAdapter = new NavTargetResolutionInternalAdapter({}, {}, oConfig);
        ...
        QUnit.test("calls function correctly", function (assert) {
            this.oAdapter = new NavTargetResolutionInternalAdapter({}, {}, {});
