...
sap.ui.define([
    ...
    QUnit.test("value function - correct", function (assert) {
        try {
            let result = oFunctions.applyFunctionInPipeContext("value", ["param1"], {
                "param1": ["val1"]
            });
            assert.strictEqual(result, "val1");
            result = oFunctions.applyFunctionInPipeContext("value", ["param2"], {
                "param1": ["val1"]
            });
