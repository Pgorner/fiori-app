        ...
        oParsedParameters: {
            ...
            p3: {
                ...
                value: {
                    type: "function",
                    name: "not",
                    args: [{ type: "reference", value: "p2" }],
                    params: [{ type: "reference", value: "p1" }]
                }
            }
        },
        expectedResult: {
        ...
        oParsedParameters: {
            ...
            p3: {
                ...
                value: {
                    ...
                    name: "not",
                    args: [{ type: "reference", value: "p2" }],
                    params: [{ type: "reference", namespace: "env", value: "p1" }]
                }
            }
        },
        expectedResult: {
        ...
        var oParsedParameters = {
            p1: {
                ...
                value: {
                    ...
                    name: "if",
                    args: ["stringNotEmpty"],
                    params: [{ type: "something_strange", value: "A" },
                    { type: "literal", value: "B" }]
                }
            },
            p3: {}
