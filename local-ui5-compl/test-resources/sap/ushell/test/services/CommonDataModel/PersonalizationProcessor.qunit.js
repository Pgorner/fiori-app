...
sap.ui.define([
    ...
    [{
        ...
        QUnit.test("_applyGroupVisibility: " + oFixture.testDescription, function (assert) {
            ...
            oTestDataPromise = requestData("sap/ushell/cdmLiveSiteData/CommonDataModelAdapterDataTest.json");
    ...
    aTestDataMap.forEach(function (oFixture) {
        QUnit.test("extractPersonalization: " + oFixture.testDescription, function (assert) {
            ...
            // request test data
            oOriginalSiteDataPromise = requestData("sap/ushell/cdmLiveSiteData/"
                + (oFixture.sOriginalSiteData || "CommonDataModelAdapterDataTest.json"));
            oLiveSiteDataPromise = requestData("sap/ushell/cdmLiveSiteData/" + oFixture.sLiveSiteData);
            oPersonalizationDeltaDataPromise
        ...
        QUnit.test("mixinPersonalization: " + oFixture.testDescription, function (assert) {
            ...
            jQuery.when(oOriginalSiteDataPromise, oLiveSiteDataPromise, oPersonalizationDeltaDataPromise)
                .done(function (oOriginalSiteData, oLiveSiteData, oPersonalizationDeltaData) {
                    ...
                    var oOriginalPersonalizationDelta = deepClone(oPersonalizationDeltaData);
