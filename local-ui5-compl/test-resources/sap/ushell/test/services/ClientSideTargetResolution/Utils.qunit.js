...
sap.ui.define([
    ...
    [{
        ...
        function (oFixture) {
            QUnit.test("filter Object when " + oFixture.description, function (assert) {
                var actObject = _Utils.filterObjectKeys(
    ...
    [{
        ...
        QUnit.test("constructParameterDominatorMap when " + oFixture.description, function (assert) {
            var oMap = _Utils.constructParameterDominatorMap(oFixture.oParameters);
    ...
    [{
         ...
         */
        QUnit.test("constructParameterDominatorMap when " + oFixture.description, function (assert) {
            var oParameterDominatorMap = _Utils.constructParameterDominatorMap(oFixture.oParameters);
            var oDominatedDefaultParametersToRemove = _Utils.findDominatedDefaultParameters(
            ...
            var oIntentParamsPlusAllDefaultsWithoutDominatedParams =
                _Utils.filterObjectKeys(oFixture.oIntentParamsPlusAllDefaults, function (sDefaultedParam) {
    ...
    [{
        ...
        QUnit.test("inboundSignatureMeetsParameterOptions when " + oFixture.testDescription, function (assert) {
            var bResult = _Utils.inboundSignatureMeetsParameterOptions(
    ...
    [{
        ...
        QUnit.test("" + oFixture.sTestDescription, function (assert) {
            // Arrange
            // Act
            var oResult = _Utils.extractParameters(oFixture.aParams, oFixture.oWithParameters);
