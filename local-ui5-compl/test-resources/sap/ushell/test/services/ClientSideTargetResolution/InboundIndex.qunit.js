...
sap.ui.define([
    ...
    Q.test("InboundIndex: can construct from an empty array", function (assert) {
    ...
    Q.test("InboundIndex: constructing an index leaves the original object intact", function (assert) {
        ...
        var aInboundsClone = deepExtend([], aInbounds);
    ...
    Q.test("InboundIndex: can construct from a non empty array", function (assert) {
        var aInbounds = [
            mkInb("#So1-a1"),
            mkInb("#So2-a2"),
            mkInb("#So3-a3"),
    ...
    Q.test("InboundIndex: can construct with tags", function (assert) {
        var oIndex,
            oInbound1,
            oInbound2,
            oInbound3,
    ...
    Q.test("GetSegment: returns the expected segment", function (assert) {
        var oIndex,
            oInbound6,
            oInbound5,
            oInbound4,
    ...
    Q.test("GetSegment: appends the 'always' set to the response if any", function (assert) {
        var oIndex,
            oInbound6,
            oInbound5,
            oInbound4,
    ...
    Q.test("GetSegment: does not put '*' into a segment", function (assert) {
        var oIndex,
            oInbound6,
            oInbound5,
            oInbound4,
