...
sap.ui.define([
    ...
    QUnit.module("init", {
        beforeEach: function () {
            return Container.init("local")
                .then(function () {
                    return Container.getServiceAsync("MessageInternal").then(function (oMessageService) {
            ...
            return Container.init("local")
                .then(function () {
                    return Container.getServiceAsync("MessageInternal").then(function (oMessageService) {
                        ...
                        this.oRequireStub.callsFake(function (aFiles, fnCallBack) {
    ...
    QUnit.test("default error dialog with custom title", function (assert) {
        ...
        // Act
        var oDialog = this.oMessage.errorWithDetails(this.sMessage, this.oDetailControl, "custom title");
    ...
    QUnit.test("default error dialog with custom title in messageConfig object", function (assert) {
        ...
        // Act
        var oDialog = this.oMessage.errorWithDetails(this.sMessage, this.oDetailControl, { title: "custom title" });
    ...
    QUnit.test("default error dialog with onClose callback", function (assert) {
        ...
        // Act
        var oDialog = this.oMessage.errorWithDetails(this.sMessage, this.oDetailControl, { onClose: fnCallback });
        oDialog.close();
    });
