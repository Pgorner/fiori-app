...
/**
 * @fileOverview QUnit tests for NavTargetResolution
...
sap.ui.define([
    ...
    QUnit.module("sap.ushell_abap.adapters.abap.NavTargetResolution: ", {
        beforeEach: function () {
                    ...
                    CommonDataModel: {
                        ...
                        adapter: {
                            ...
                            config: {
                                ...
                                cdmSiteUrl: sap.ui.require.toUrl("sap/ushell/test/services/NavTargetResolutionCDMBlackboxV2.testData.json")
                            }
                        }
                    },
    ...
    aResolveHashFragmentFixture.forEach(function (oFixture) {
        QUnit.test("resolveHashFragment without sap.ushell.services.AppConfiguration side effects: " + oFixture.sHashFragmentToResolve, function (assert) {
            ...
            Container.getServiceAsync("NavTargetResolution").then(function (NavTargetResolutionService) {
                NavTargetResolutionService.resolveHashFragment(oFixture.sHashFragmentToResolve)
    ...
    QUnit.test("isIntentSupported works as expected when a mix of intents is given", function (assert) {
        ...
        var fnDone = assert.async();
        Container.getServiceAsync("NavTargetResolution").then(function (NavTargetResolutionService) {
            NavTargetResolutionService.isIntentSupported(oFixture.aIntents)
