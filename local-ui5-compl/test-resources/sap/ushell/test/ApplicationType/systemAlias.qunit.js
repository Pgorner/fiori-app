...
sap.ui.define([
...
], function (URI, oSystemAlias, jQuery, Container) {
    "use strict";
    ...
    [{
        ...
        QUnit.test("_selectSystemAliasDataName: selects " + oFixture.expectedSystemAliasDataName + " when " + oFixture.testDescription, function (assert) {
            ...
            // Act
            var sSelectedSystemAliasDataName = oSystemAlias._selectSystemAliasDataName(oSystemAliasCollection, oFixture.sWindowLocationProtocol);
    ...
    QUnit.test("Returns the correct URL if the frameworkId is WDA", function (assert) {
        // Arrange
        const oContainer = {
            getFrameworkId: () => "WDA",
            getSystemAlias: () => "",
