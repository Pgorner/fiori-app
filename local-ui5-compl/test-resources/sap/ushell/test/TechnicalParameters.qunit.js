...
sap.ui.define([
    ...
    [{
        testDescription: "UI5 application with undefined componentData",
        ...
        QUnit.test("getParameterValue: returns the correct array of values when " + oFixture.testDescription, function (assert) {
            ...
            var fnDone = assert.async(),
                fnErrorLogStub = sinon.stub(Log, "error");
    ...
    QUnit.test("Calls getParameters with oFilterOptions=undefined", function (assert) {
        ...
        // Assert
        assert.strictEqual(aResult.length, 10, "The correct number of parameters is returned");
    });
