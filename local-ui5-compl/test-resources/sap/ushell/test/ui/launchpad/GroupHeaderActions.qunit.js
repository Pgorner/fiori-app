...
sap.ui.define([
    ...
    QUnit.test("isOverflow is false and tileActionModeActive is false with visible Content", async function (assert) {
        // Arrange
    ...
    QUnit.test("isOverflow is true and tileActionModeActive is false with visible Content", async function (assert) {
        // Arrange
        var oTestButton = new Button("testButton");
    ...
    QUnit.test("isOverflow is false and tileActionModeActive is true with visible Content", async function (assert) {
        // Arrange
        var oTestButton = new Button("testButton");
        this.oGroupHeaderActions.setIsOverflow(false);
    ...
    QUnit.test("isOverflow is true and tileActionModeActive is true with visible Content", async function (assert) {
        // Arrange
        var oTestButton = new Button("testButton");
        this.oGroupHeaderActions.setIsOverflow(true);
        this.oGroupHeaderActions.setTileActionModeActive(true);
    ...
    QUnit.test("isOverflow is false and tileActionModeActive is false with invisible Content", async function (assert) {
        // Arrange
    ...
    QUnit.test("isOverflow is true and tileActionModeActive is false with invisible Content", async function (assert) {
        // Arrange
        var oTestButton = new Button("testButton", { visible: false });
        this.oGroupHeaderActions.setIsOverflow(true);
        this.oGroupHeaderActions.setTileActionModeActive(false);
    ...
    QUnit.test("isOverflow is false and tileActionModeActive is true with invisible Content", async function (assert) {
        // Arrange
        var oTestButton = new Button("testButton", { visible: false });
        this.oGroupHeaderActions.setIsOverflow(false);
        this.oGroupHeaderActions.setTileActionModeActive(true);
    ...
    QUnit.test("isOverflow is true and tileActionModeActive is true with invisible Content", async function (assert) {
        // Arrange
        var oTestButton = new Button("testButton", { visible: false });
        this.oGroupHeaderActions.setIsOverflow(true);
        this.oGroupHeaderActions.setTileActionModeActive(true);
    ...
    QUnit.test("OverflowButton default parameters", async function (assert) {
        // Act
        await nextUIUpdate();
    ...
    QUnit.test("ActionSheet default parameters", async function (assert) {
        // Act
