...
sap.ui.define([
    ...
    return Controller.extend("sap.ushell.demo.AppStateSample2.view.List", {
        /**
        ...
        onInit: function () {
            ...
            this.getView().byId("MasterPage").setTitle("AppStateSample2 Instance #" + this.getOwnerComponent().INSTANCECOUNTER);
            oPage.setShowFooter(true);
            var oActionSheet = new ActionSheet({
                placement: PlacementType.Top,
                buttons: [new AddBookmarkButton()]
            });
            ...
            oComponentModel.bindProperty("/appState/CollectionName").attachChange(function () {
                try {
                    ...
                    Log.warning("Could not excecute selectListItemByCollectionName (yet)",
                        e.toString(), "sap.ushell.demo.AppStateSample2.view.List");
                }
            }.bind(this));
