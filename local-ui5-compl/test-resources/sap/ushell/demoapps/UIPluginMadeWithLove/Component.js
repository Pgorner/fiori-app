...
sap.ui.define([
    ...
    function getRenderer () {
        return new Promise(function (resolve, reject) {
            ...
            if (!oShellContainer) {
                return reject("Cannot render outside unified shell");
            }

            oRenderer = oShellContainer.getRendererInternal();
            if (oRenderer) {
            ...
            fnOnRendererCreated = function (oEvent) {
                ...
                reject("Cannot render outside unified shell");
            };
    ...
    function fnRender (oContext, oRenderer) {
        ...
        var oPluginParameters = oContext.getComponentData().config;
