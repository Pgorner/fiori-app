...
], (function (TablePersoController, Component, Item, Controller, JSONModel, VariantSetAdapter, Container) {
    "use strict";
    ...
    return Controller.extend("sap.ushell.demo.AppPersSample3.App", {
        onInit: function () {
            ...
            Promise.all([
                ...
                var oPersonalizationService = aServices[0];
