...
], function (UIComponent, jQuery, Container) {
    "use strict";

    return UIComponent.extend("sap.ushell.demo.AllMyApps.Component", {
        // use inline declaration instead of component.json to save 1 round trip
        metadata: { manifest: "json" },

        createContent: function () {
            Container.getServiceAsync("AllMyApps").then(function (oAllMyAppsService) {
