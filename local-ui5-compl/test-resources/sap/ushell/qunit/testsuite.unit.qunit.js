...
sap.ui.define(function () {
    ...
    return {
        name: "Unit TestSuite for sap.ushell",
        defaults: {
            qunit: {
                version: 2,
                testTimeout: 60000
            ...
            page: "test-resources/sap/ushell/qunit/teststarter.unit.qunit.html?test={name}",
        ...
        tests: {
            ...
            "../test/components/contentFinder/CatalogService": {
                title: "sap/ushell/components/contentFinder/CatalogService"
            },
