...
sap.ui.define([
    ...
    "sap/ui/core/Element",
    "./ExpressionBasicRenderer"
], function(jQuery, library, Control, InstructionRenderer, ExpressionBase, Formatting, DateFormat, NumberFormat, MetadataAnalyser, Element, ExpressionBasicRenderer) {
    "use strict";
    ...
    var ExpressionBasic = ExpressionBase.extend("sap.rules.ui.ExpressionBasic", {
        ...
        _onChangeByIndex: function(instructionIndex, sPrefix, iOriginalIndex) {
            ...
            var suggestionsPart = library.SuggestionsPart;
            var suggestions;
        ...
        _createInstructions: function(suggestions) {
            ...
            for (var i = 0; i < suggestions.length; i++) {
                ...
                if (Array.isArray(suggestion)) {
                    ...
                    if (suggestion.BDT === library.ExpressionType.Number) {
					...
					if (model && model instanceof Array && !model[0].metadata.HasValueSource) {
						...
						if (oModel && !oModel.getMetaModel().oModel) {
							var fnMetaDataLoaded = function() {
								...
								var oMetadataAnalyzer = new MetadataAnalyser(tempModel);
        ...
        _reload: function() {
            ...
            var suggestions = Element.getElementById(this.getExpressionLanguage())._getBasicSuggestions(this.getValue());
        ...
        onAfterRendering: function() {
            ...
            this.$().on("change", null, function(event) {
        ...
        renderer: ExpressionBasicRenderer
    });
