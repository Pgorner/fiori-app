...
sap.ui.define([
...
], function(jQuery, library, ExpressionBasic, InstructionRenderer, coreLibrary, Element, DecisionTableCellExpressionBasicRenderer) {
    "use strict";
    ...
    var DecisionTableCellExpressionBasic = ExpressionBasic.extend("sap.rules.ui.DecisionTableCellExpressionBasic", {
        ...
        _reload: function() {
            ...
            if (!this.sHeaderValue && !this.FixedOperatorValue) {
                ...
                ExpressionBasic.prototype._reload.apply(this, arguments);
                return;
            } else {
        ...
        _onChangeByIndex: function(instructionIndex, sPrefix) {
           ExpressionBasic.prototype._onChangeByIndex.apply(this, [this.offSet + instructionIndex, this.sHeaderValue + this.FixedOperatorValue, instructionIndex]);
        },
        
        renderer: DecisionTableCellExpressionBasicRenderer
    });
    ...
    DecisionTableCellExpressionBasic.prototype.onAfterRendering = function() {
        ExpressionBasic.prototype.onAfterRendering.apply(this, arguments);
    ...
    DecisionTableCellExpressionBasic.prototype.onBeforeRendering = function() {
        ExpressionBasic.prototype.onBeforeRendering.apply(this, arguments);
    };
            ...
            if (oResult.deferredResult) {
                oResult.deferredResult.done(function(oResult) {
                    if (this.oDecisionTableCell) {
						...
						var valueStatePath = this.oDecisionTableCell.getValueStatePath();
						var dtModel = this.oDecisionTableCell.getModel("dtModel");
						if (oResult.status === library.ValidationStatus.Error) {
							...
							if (!this.oDecisionTableCell._oPopover || !this.oDecisionTableCell._oPopover.isOpen()) {
								dtModel.setProperty(valueStatePath.slice(8), coreLibrary.ValueState.Error);
							} else {
								dtModel.setProperty(valueStatePath.slice(8), coreLibrary.ValueState.None);
							}
