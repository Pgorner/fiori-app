...
sap.ui.define([
        ...
        "sap/ui/core/Lib",
        "./DecisionTableSettingsOldRenderer"
    ],
    function(library, Control, SimpleForm, Label, Switch, Select, Table, Text, CheckBox, Input, Button, ExpressionAdvanced, VerticalLayout, ExpressionType, coreLib, DecisionTableSettingsOldRenderer) {
        "use strict";
        ...
        var oDecisionTableSettingsOld = Control.extend("sap.rules.ui.DecisionTableSettingsOld", {
            ...
            renderer: DecisionTableSettingsOldRenderer
        });

        oDecisionTableSettingsOld.prototype.init = function() {
        ...
        oDecisionTableSettingsOld.prototype.onBeforeRendering = function() {
         ...
         * @private
         */
        oDecisionTableSettingsOld.prototype._prepareNewRule = function() {

            var oModel = this._getModel();
            var oContext = this.getBindingContext();

            // rule's data
            var ruleFormat = library.RuleFormat.Advanced; // TODO: take from configuration
            oModel.setProperty("Type", library.RuleType.DecisionTable, oContext, true);
         ...
         * @private
         */
        oDecisionTableSettingsOld.prototype._createDecisionTable = function(oData, mParameters) {
            var oModel = this._getModel();
            var oContext = this.getBindingContext();
         ...
         * @private
         */
        oDecisionTableSettingsOld.prototype._createRow = function(oData, mParameters) {
         ...
         * @private
         */
        oDecisionTableSettingsOld.prototype._createCondition = function(oData, mParameters) {
         ...
         * @private
         */
        oDecisionTableSettingsOld.prototype._createCellsForNewColumn = function(oData, mParameters) {
         ...
         * @private
         */
        oDecisionTableSettingsOld.prototype._createCellsForNewRow = function(oData, mParameters) {
         ...
         * @private
         */
        oDecisionTableSettingsOld.prototype._createResult = function(oData, mParameters) {
         ...
         * @private
         */
        oDecisionTableSettingsOld.prototype._createResultParameter = function(oData, mParameters) {
         ...
         * @private
         */
        oDecisionTableSettingsOld.prototype._removeColumn = function(oColumnContext, mParameters) {
            var oModel = this._getModel();
         ...
         * @private
         */
        oDecisionTableSettingsOld.prototype._removeCellsForColumn = function(oData, mParameters) {
            var oModel = this._getModel();
            var oContext = this.getBindingContext();
            var rowKeys = oModel.getProperty("DecisionTable/DecisionTableRows", oContext);
        ...
        oDecisionTableSettingsOld.prototype._createTable = function() {
        ...
        oDecisionTableSettingsOld.prototype._createLayout = function() {
        ...
        oDecisionTableSettingsOld.prototype._setFixedOperatorOnExpressionChange = function(displayExpression, colId) {
        ...
        oDecisionTableSettingsOld.prototype.setExpressionLanguage = function (oExpressionLanguage){
        ...
        oDecisionTableSettingsOld.prototype._getColumnControlObject = function(oBindingContext) {
            var mode = this._internalModel.getProperty("/advancedMode/current");
            if (mode === library.RuleFormat.Advanced) {
                var oExpressionLanguage = sap.ui.getCore().byId(this.getExpressionLanguage());
                        ...
                        events: {
                            change: function(oEvent) {
                                ...
                                //Workaround to fix RULES-4723
							      var result = oExpressionLanguage.convertDecisionTableExpressionToDisplayValue(oSource.getValue(), "", "", library.ExpressionType.All);
							      var value;
        ...
        oDecisionTableSettingsOld.prototype._tableColumnsFactory = function(sId, oContext) {
         ...
         * @private
         */
        oDecisionTableSettingsOld.prototype._prepareNewRuleWorkaround = function() {
         ...
         * @private
         */
        oDecisionTableSettingsOld.prototype._addConditionWorkaround = function(oData, mParameters) {
         ...
         * @private
         */
        oDecisionTableSettingsOld.prototype._removeColumnWorkaround = function(oColumnContext, mParameters) {
            var oModel = this._getModel();
         ...
         *  @param {map} mParameters? - Optional parameter map containing any of the following properties:
         */
        oDecisionTableSettingsOld.prototype._saveWorkaround = function(mParameters) {
            var oModel = this._getModel();
            oModel.submitChanges(mParameters);
        };


        oDecisionTableSettingsOld.prototype._getModel = function() {
        ...
        oDecisionTableSettingsOld.prototype._getBindModelName = function() {
            var path = "";
            var modelName = this.getModelName();
        ...
        oDecisionTableSettingsOld.prototype._initSettingsModel = function() {
            var initialData = {};
        ...
        oDecisionTableSettingsOld.prototype._getAdvancedModeData = function() {
            var mode;
            ...
            if (ruleFormat === library.RuleFormat.Advanced) {
                mode = library.RuleFormat.Advanced;
            } else {
                mode = library.RuleFormat.Advanced; // TODO: should be: this.getRuleFormat();
            }

            switch (mode) {
                case library.RuleFormat.All:
                    advancedModeData = {
                        current: library.RuleFormat.Basic,
                        enabled: true,
                        visible: true
                    };
                    break;

                case library.RuleFormat.Basic:
                    advancedModeData = {
                        current: library.RuleFormat.Basic,
                        enabled: false,
                        visible: false
                ...
                case library.RuleFormat.Advanced:
                    advancedModeData = {
                        current: library.RuleFormat.Advanced,
                        enabled: false,
                        visible: true
                    };
        ...
        oDecisionTableSettingsOld.prototype._getHitPoliciesData = function() {
        ...
        oDecisionTableSettingsOld.prototype._getFixedOperatorDataForExpression = function(sExpression) {
        ...
        oDecisionTableSettingsOld.prototype._setAdvancedMode = function(oControlEvent) {
            var bAdvancedModeStatus = oControlEvent.getParameter("selected");
            var ruleFormat = bAdvancedModeStatus ? library.RuleFormat.Advanced : library.RuleFormat.Basic;
        ...
        oDecisionTableSettingsOld.prototype._updateRemoveRowEnabled = function() {
        ...
        oDecisionTableSettingsOld.prototype.getButtons = function(oDialog) {
