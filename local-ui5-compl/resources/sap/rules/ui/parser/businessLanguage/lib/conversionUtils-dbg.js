sap.ui.define([
	...
	"sap/rules/ui/parser/businessLanguage/lib/localeConversion",
	"sap/rules/ui/parser/businessLanguage/lib/parseUtils",
	"sap/rules/ui/parser/resources/vocabulary/lib/constantsBase",
	"sap/ui/core/library",
	"sap/base/i18n/Formatting",
    "sap/ui/core/format/DateFormat",
    "sap/ui/core/LocaleData"
], function(hrfException, constantsLib, localeConversionLib, parseUtils, vocabularyConstants, coreLibrary, Formatting, DateFormat, LocaleData) {
    "use strict";
...
//		newValue = ( newValue.indexOf("'") !== 0 ) ? "'" + newValue + "'" : newValue;
	...
	conversionUtilsLib.prototype.isValueListDateType = function(dtStr) {
		...
		var oFormatDate = DateFormat.getInstance({
