...
sap.ui.define([], function () {
  ...
  function createTemplateDetails(oContext, gen) {
    const res = {
      ...
      fureys: [oContext.sina._createSearchResultSetItemAttribute({
        id: "SALARY",
        valueHighlighted: "",
        isHighlighted: false,
        label: "Salary",
        ...
        isHighlighted: false,
        label: "A small town north of Sydney",
        value: '{ "type": "Point", "coordinates": [53.34528, -6.35889] }',
        valueFormatted: '{ "type": "Point", "coordinates": [53.34528, -6.35889] }',
        metadata: gen.getMetadataById(gen.metadata, "LOC_4326")
      }), oContext.sina._createSearchResultSetItemAttribute({
        id: "DISCIPLINE",
        valueHighlighted: "",
        ...
        isHighlighted: false,
        label: "Picture",
        value: "https://en.wikipedia.org/wiki/The_Fureys#/media/File:Finbar_&_Eddie_Furey.jpg",
        valueFormatted: "https://en.wikipedia.org/wiki/The_Fureys#/media/File:Finbar_&_Eddie_Furey.jpg",
        metadata: gen.getMetadataById(gen.metadata, "PIC")
      })]
    };
    return res;
