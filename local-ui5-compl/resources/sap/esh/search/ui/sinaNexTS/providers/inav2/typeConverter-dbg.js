...
sap.ui.define(["../../sina/util", "../../sina/AttributeType", "../../sina/ComparisonOperator", "../../core/errors"], function (sinaUtil, ____sina_AttributeType, ____sina_ComparisonOperator, ____core_errors) {
  ...
  const DateConversionError = ____core_errors["DateConversionError"];
  const NotImplementedError = ____core_errors["NotImplementedError"];
  const TimeConversionError = ____core_errors["TimeConversionError"];
  ...
  function sina2InaTimestamp(value) {
    ...
    const result = this.addLeadingZeros(year.toString(), 4) + "-" + this.addLeadingZeros(month.toString(), 2) + "-" + this.addLeadingZeros(day.toString(), 2) + " " + this.addLeadingZeros(hour.toString(), 2) + ":" + this.addLeadingZeros(minute.toString(), 2) + ":" + this.addLeadingZeros(seconds.toString(), 2) + "." + this.addLeadingZeros(microseconds.toString(), 6);
    return result;
  }
