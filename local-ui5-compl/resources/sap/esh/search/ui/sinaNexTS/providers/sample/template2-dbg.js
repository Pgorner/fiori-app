  ...
  function createTemplate(oContext) {
    ...
    if (oContext.searchQuery && oContext.searchQuery.filter && oContext.searchQuery.filter.dataSource && oContext.sina && oContext.sina.getDataSource("Scientists")) {
      ...
      gen.searchResultSetItemArray2.push(oContext.sina._createSearchResultSetItem({
        ...
        titleDescriptionAttributes: [],
        defaultNavigationTarget: oContext.sina.createNavigationTarget({
          text: "Alien species pathways to the Galapagos Islands, Ecuador",
      ...
      gen.searchResultSetItemArray2.push(oContext.sina._createSearchResultSetItem({
        ...
        titleDescriptionAttributes: [],
        defaultNavigationTarget: oContext.sina.createNavigationTarget({
          text: "Barry Williamson on the Hunt for Atlantis",
      ...
      gen.searchResultSetItemArray2.push(oContext.sina._createSearchResultSetItem({
        ...
        titleDescriptionAttributes: [],
        defaultNavigationTarget: oContext.sina.createNavigationTarget({
          text: "The Mystery of the Stones at Baalbek",
      ...
      gen.searchResultSetItemArray2.push(oContext.sina._createSearchResultSetItem({
        ...
        titleDescriptionAttributes: [],
        defaultNavigationTarget: oContext.sina.createNavigationTarget({
          text: "Wycliffe Well Australia's premier UFO hotspot",
      ...
      gen.searchResultSetItemArray2.push(oContext.sina._createSearchResultSetItem({
        ...
        titleDescriptionAttributes: [],
        defaultNavigationTarget: oContext.sina.createNavigationTarget({
          text: "Gobekli Tepe: The World's First Temple?",
