...
sap.ui.define([
    ...
    "../utils/InsightsUtils"
], function(Control, SimpleForm, Input, Label, Title, Text, VBox, Page,
    FlexBox, ScrollContainer, Toolbar, OverflowToolbar, ToolbarSpacer, HBox, Card, Panel, Button, ResourceModel, DeviceType, Transformations, Device, MessageStrip, AppConstants, SimpleFormLayout, InMemoryCachingHost, InsightsUtils) {
