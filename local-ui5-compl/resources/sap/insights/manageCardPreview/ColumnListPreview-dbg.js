...
sap.ui.define([
    ...
    "../utils/InsightsUtils"
            ...
            SegmentedButtonItem, Transformations, Filter, FilterOperator, JSONModel, InMemoryCachingHost, AppConstants, Element, InsightsUtils) {
   ...
   * @alias sap.insights.manageCardPreview.ColumnListPreview
    ...
    ColumnList.prototype.onBeforeRendering = function () {
        ...
        const defaultColumns = Transformations.getDefaultColumns(this.oConfCard);
        /* default colummns will be returned if card type is list card and no columns are already selected */
        if (defaultColumns.length) {
            this.oConfCard = Transformations.selectColumnsForListCard(this.oConfCard, defaultColumns);
