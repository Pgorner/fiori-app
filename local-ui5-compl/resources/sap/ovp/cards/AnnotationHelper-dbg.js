...
sap.ui.define([
    ...
    function isFirstDataPointPercentageUnit(iContext, aCollection) {
        ...
        if (sPath) {
            ...
            if (bODataV4 && oProperty) {
                var sUOMValue = oProperty[sEntityName][sPath]["annotations"]["@" + ANNOTATIONTYPE.UOM];
                return sUOMValue === "%";
            }
        }
        return false;
    ...
    function getFormattedFiscalData(sFiscalData, sAnnotationType) {
        if (sAnnotationType === 'com.sap.vocabularies.Common.v1.IsFiscalYearPeriod') {
            ...
            var oFormatter = new PeriodDateFormat(null, Object.assign({ format: sFormat, calendarType: coreLibrary.CalendarType.Gregorian }, oFormatOptions));
