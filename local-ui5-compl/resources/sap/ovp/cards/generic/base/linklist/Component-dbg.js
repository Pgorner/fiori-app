...
sap.ui.define([
    ...
    CardComponent,
    AnnotationHelper // this is required for v2 & v4 linklist card to load(formatter).
) {
    "use strict";

    return CardComponent.extend("sap.ovp.cards.generic.base.linklist.Component", {
        ...
        metadata: {
            properties: {
                ...
                controllerName: {
                    type: "string",
                    defaultValue: "sap.ovp.cards.generic.base.linklist.BaseLinklist"
                },
                communicationPath: {
                    type: "string",
