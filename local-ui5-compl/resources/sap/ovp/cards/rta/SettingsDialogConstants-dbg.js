...
sap.ui.define([], function () {
    ...
    return {
        ...
        cardSettingsArrayLevel: {
            staticContent: {
                text: ["title", "subTitle", "imageAltText"],
                settings: ["imageUri", "targetUri", "openInNewWindow", "semanticObject", "action"]
            },
            tabs: {
                text: ["value"],
                settings: [
                ...
                onlyTabLevelProps: ["value"],
                checkForRemoval: ["entitySet"]
            }
        },
        cardSettingsForComplex: {
            text: ["title", "subTitle", "valueSelectionInfo", "itemText"],
            settings: [
                "listType",
                "listFlavor",
                "sortOrder",
        ...
        cardSettingsWithText: [
            ...
            "itemText",
            {
                staticContent: ["title", "subTitle", "imageAltText"]
            },
            {
                tabs: ["value"]
            }
        ...
        oI18nValueProperty: {
            title: "title",
            subTitle: "subTitle",
            valueSelectionInfo: "valueSelectionInfo"
        },
        ...
        _aRefreshRequired: [
            ...
            {
                formElementId: "sapOvpSettingsSwitchInsight",
                updateProperty: "enableAddToInsights"
            },
            {
        ...
        _updateManifestProperties: [
            ...
            {
                formElementId: "sapOvpSettingsSwitchInsights",
                updateProperty: "enableAddToInsights"
            },
            {
        ...
        NewCardSettings: [
            {
                ...
                text: ["title", "subTitle", "listFlavor", "requireAppAuthorization"]
            },
            {
                template: "sap.ovp.cards.list",
                cardSettings: [
            ...
            },
            {
                ...
                text: ["title", "subTitle", "requireAppAuthorization", "addODataSelect", "valueSelectionInfo"]
            },
            {
                template: "sap.ovp.cards.stack",
                cardSettings: ["title", "subTitle", "entitySet", "requireAppAuthorization", "annotationPath", "addODataSelect"],
                text: ["title", "subTitle", "requireAppAuthorization", "addODataSelect"]
            },
            {
                template: "sap.ovp.cards.charts.analytical",
                cardSettings: [
                ...
                text: ["title", "subTitle", "requireAppAuthorization", "valueSelectionInfo"]
            }
        ]
    };
}, /* bExport= */ true);
