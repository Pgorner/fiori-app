...
sap.ui.define([
    ...
    var ShellHeader = Control.extend("sap.ushell.ui.ShellHeader", /** @lends sap.ushell.ui.ShellHeader.prototype */ {
        metadata: {
            library: "sap.ushell",
            properties: {
                /*
    ...
    ShellHeader.prototype.getLogo = function () {
        ...
        var sCustomCompanyLogoUrl = this.getCustomCompanyLogoUrl();
    ...
    ShellHeader.prototype._adjustAppTitleTooltip = function () {
        var oAppTitle = Element.getElementById("shellAppTitle");
        if (oAppTitle) {
            ...
            if (oSpanElement) {
                ...
                var bAllMyAppsMenu = (bDefaultShellMode || bLegacyHomeState) && bAllMyAppsEnabled;

                var oNavMenu = Element.getElementById(oAppTitle.getNavigationMenu());
    ...
    ShellHeader.prototype._rerenderLogoNavigationFilter = function (oShellNavigationInternal, sNewHash, sOldHash) {
        var bAppSpecificChange = oShellNavigationInternal.hashChanger.isInnerAppNavigation(sNewHash, sOldHash);
