...
sap.ui.define([
            ...
            return new Promise(function (resolve, reject) {
                ...
                sap.ui.require([
                    ...
                    this.oSimpleForm = new SimpleForm({
                        id: "bookmarkFormId",
                        layout: layoutLibrary.form.SimpleFormLayout.ResponsiveGridLayout,
                        content: [oDialogView],
                        editable: true
    ...
    AddBookmarkButton.prototype._handleOKButtonPressSpacesMode = function () {
        ...
        if (!bValid) {
            sap.ushell.Container.getServiceAsync("MessageInternal").then(function (oMessageService) {
                oMessageService.info(resources.i18n.getText("SaveAsTileDialog.MessageToast.ValidationFailed"));
            });
            return;
        }
