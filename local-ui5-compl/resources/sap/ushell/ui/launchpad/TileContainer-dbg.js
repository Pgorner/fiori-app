...
sap.ui.define([
    ...
    /**
     * @alias sap.ushell.ui.launchpad.TileContainer
     * @class
     * @classdesc Constructor for a new ui/launchpad/TileContainer.
    ...
    TileContainer.prototype.onAfterRendering = function () {
        ...
        EventBus.getInstance().publish("launchpad", "GroupHeaderVisibility");
