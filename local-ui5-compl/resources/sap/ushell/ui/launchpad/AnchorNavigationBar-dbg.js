...
sap.ui.define([
     ...
     * @private
     */
    var AnchorNavigationBar = Bar.extend("sap.ushell.ui.launchpad.AnchorNavigationBar", /** @lends sap.ushell.ui.launchpad.AnchorNavigationBar.prototype */{
        metadata: {
            library: "sap.ushell",
            properties: {
    ...
    AnchorNavigationBar.prototype._togglePopover = function () {
        sap.ui.require([
            ...
            if (this.oPopover.isOpen()) {
                ...
                var oSelectedGroup = Element.getElementById(sSelectedGroupId);
