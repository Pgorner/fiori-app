    ...
    Tile.prototype.init = function () {
        this.addDelegate({
            onkeyup: function (oEvent) {
                var oKeyEvent = oEvent.originalEvent;
                var bSpace = oKeyEvent.code === "Space" || oEvent.keyCode === 32;
                var bEnter = oKeyEvent.code === "Enter" || oEvent.keyCode === 13;
                var bModifierKey = oKeyEvent.altKey || oKeyEvent.shiftKey || oKeyEvent.ctrlKey || oKeyEvent.metaKey;
