...
sap.ui.define([
     ...
     * @since 1.78
     */
    var VizInstanceCdm = VizInstance.extend("sap.ushell.ui.launchpad.VizInstanceCdm", /** @lends sap.ushell.ui.launchpad.VizInstanceCDM.prototype */ {
        metadata: {
            library: "sap.ushell"
        },
    ...
    VizInstanceCdm.prototype.setPreview = function (bPreview) {
        var bRefresh = !!this.getProperty("preview") && !bPreview;
