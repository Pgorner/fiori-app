...
sap.ui.define([
    ...
    /**
     * @alias sap.ushell.ui.launchpad.CatalogsContainer
     * @class
     *
     ...
     * @private
     */
    var CatalogsContainer = Control.extend("sap.ushell.ui.launchpad.CatalogsContainer", /** @lends sap.ushell.ui.launchpad.CatalogsContainer.prototype */{
        metadata: {
            library: "sap.ushell",
            properties: {
