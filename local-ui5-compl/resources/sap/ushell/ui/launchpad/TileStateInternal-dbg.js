...
/**
 * @file Provides control "sap.ushell.ui.launchpad.TileStateInternal"
...
sap.ui.define([
    ...
    /**
     * @alias sap.ushell.ui.launchpad.TileStateInternal
     * @class
     ...
     * @private
     */
    var TileStateInternal = Control.extend("sap.ushell.ui.launchpad.TileStateInternal", /** @lends sap.ushell.ui.launchpad.TileStateInternal.prototype */ {
        metadata: {
            library: "sap.ushell",
            properties: {
                // load state
    ...
    TileStateInternal.prototype.init = function () {
     ...
     * @private
     */
    TileStateInternal.prototype.onclick = function (/*oEvent*/) {
        this.firePress();
    };
     ...
     * @private
     */
    TileStateInternal.prototype._onPress = function (oEvent) {
    ...
    TileStateInternal.prototype._getBusyContainer = function () {
    ...
    TileStateInternal.prototype.exit = function () {
    ...
    TileStateInternal.prototype.setState = function (oState, isSuppressed) {
        this.setProperty("state", oState, isSuppressed);
        return this;
    };

    return TileStateInternal;
});
