    ...
    UserActivityLogClass.prototype = {
        ...
        getMessageInfo: function (/*sUserText*/) {
            return {
                ...
                userLog: this.getLog(),
                formFactor: ushellUtils.getFormFactor()
            };
        },
        ...
        _tileOnTapDecorator: function (origFunc) {
            ...
            return function (/*event, ui*/) {
                ...
                if (this.isA("sap.ushell.ui.launchpad.PlusTile")) {
                    ...
                    // Get tile title
                    var oTile = Element.getElementById(this.getId());
         ...
         *
         * @param {int} type either ACTION (0) or ERROR (1)
        ...
        _getShellState: function () {
            const sShellMode = StateManager.getShellMode() || "default";
            return `${sShellMode}-${StateManager.getLaunchpadState()}`;
        },
