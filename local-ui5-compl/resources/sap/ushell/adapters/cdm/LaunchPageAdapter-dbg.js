...
sap.ui.define([
    ...
    function LaunchPageAdapter (oUnused, sParameter, oAdapterConfiguration) {
         ...
         *  The corresponding site object
         *
         * @returns {jQuery.Promise[]} An array of promises each belonging to a respective tile.
         *
         * @private
         */
         ...
         *  The corresponding site object
         *
         * @returns {jQuery.Promise[]} An array of promises each belonging to a respective link.
         *
         * @private
         */
        ...
        /**
         * Asynchronously checks if a tile intent is supported
         *
         * @param {object} oTile
         *  Tile object
