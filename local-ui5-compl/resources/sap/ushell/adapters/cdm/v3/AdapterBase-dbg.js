...
sap.ui.define([
    ...
    AdapterBase.prototype._ensureLoaded = function () {
        ...
        this._loaded = new Promise(function (fnResolve, fnReject) {
            this._getSiteData()
                .then(function (oSite) {
     ...
     *
     * @returns {jQuery.Promise[]} An array of promises each belonging to a respective item.
     *
     * @private
     * @deprecated As of version 1.120
     */
     ...
     *
     * @returns {jQuery.Promise[]}
     *  An array of promises each belonging to a respective tile.
     *
     * @private
     * @deprecated As of version 1.120
     */
     ...
     *  The corresponding site object
     * @returns {jQuery.Promise[]}
     *  An array of promises each belonging to a respective link.
     *
     * @private
     * @deprecated As of version 1.120
     */
    ...
    AdapterBase.prototype._resolveTileByVizId = function (oTile, oSite) {
        ...
        if (sAppId) {
            ...
            oHarmonizedOutbound = readUtils.harmonizeTarget(oOutbound);
            sHash = this._toHashFromOutbound(oHarmonizedOutbound);
        } else {
    ...
    AdapterBase.prototype._enhanceTileComponentData = function (oTile, oComponentData) {
        ...
        if (sContentProviderId) {
            oPrefixDataSourcePromise = Container.getServiceAsync("ClientSideTargetResolution")
