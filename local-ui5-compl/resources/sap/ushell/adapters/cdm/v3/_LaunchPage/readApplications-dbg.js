...
sap.ui.define([
    ...
    /**
     * Returns the application's technical attributes
     * @param {object} oApplication The application
     * @returns {string[]} The application's technical attributes or undefined if not present
     *
     * @private
     * @since 1.115.0
     */
    readApplications.getTechnicalAttributes = function (oApplication) {
        return ObjectPath.get(["sap.app", "tags", "technicalAttributes"], oApplication);
    };
