...
sap.ui.define([
...
], function (Log, deepExtend, cdmSiteUtils, extend, Version, jQuery, Config, Container) {
    "use strict";
        ...
        Container.getServiceAsync("PersonalizationV2")
            .then(async function (oPersonalizationService) {
                ...
                oPersonalizer.getPersData()
                    .then(function (oPersonalizationContainer) {
    ...
    PagesCommonDataModelAdapter.prototype.getVisualizations = function () {
        return Container.getServiceAsync("VisualizationDataProvider").then(function (oVisualizationDataProvider) {
            return Promise.all([
