...
sap.ui.define([
     ...
     * platform.</p>
     *
     * <p>The adapter can deal with the pre 1.34 format for the NavTargetResolutionAdapter
     * {config: {applications: { ... }}}.
    ...
    var ClientSideTargetResolutionAdapter = function (oSystem, sParameters, oConfig) {
        ...
        var sProductName = Container.getLogonSystem().getProductName() || "";
     ...
     *
     * @returns {jQuery.Promise} Resolves to an object containing the resolution result
            ...
            if (oApplications.hasOwnProperty(sIntentName) && sIntentName.indexOf("_") !== 0) {
                ...
                if (oInbound.resolutionResult.additionalInformation &&
                    ...
                    if (oApplication.applicationDependencies) {
                        ...
                        // Can additionalInformation contain something trailing the UI5 component?
