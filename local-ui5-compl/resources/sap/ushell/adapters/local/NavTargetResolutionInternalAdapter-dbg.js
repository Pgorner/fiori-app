...
sap.ui.define([
     ...
     * @private
     */
    var NavTargetResolutionInternalAdapter = function (oUnused, sParameter, oAdapterConfiguration) {
        ...
        this.resolveHashFragment = function (sHashFragment) {
            ...
            if (!sHashFragment && !oApplications[sHashFragment]) {
                ...
                var iIndex = sHashFragment.indexOf("&/");
                if (iIndex >= 0) {
        ...
        this.getSemanticObjectLinks = function (sSemanticObject, mParams) {
            ...
            if (!sSemanticObject) {
                ...
                Container.getServiceAsync("URLParsing").then(function (oURLParsingService) {
                    var sParameters = oURLParsingService.paramsToString(mParams);
                    Log.info("getSemanticObjectLinks: " + sSemanticObject);
                    for (var sIntent in oApplications) {
