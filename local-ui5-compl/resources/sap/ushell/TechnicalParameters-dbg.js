...
sap.ui.define([
    ...
    var oTechnicalParameters = {
        ...
        // We still treat this as a technical parameter to avoid issues with existing usages (e.g. bookmarks) which might
        // leak this parameter into the startupParameters
        // Was used by RTA to determine draft app which user starts to adapt but don't want to activate immediately.
        "sap-ui-fl-version": {
            injectFrom: "startupParameter",
            isIntentParameter: true,
            getValue: function (sParameterName, oApplicationComponent) {
     ...
     *
     * @returns {*}
     * results for the given parameter name from the application component
     */
    function getValueFromComponent (sParameterName, oApplicationComponent) {
        if (oApplicationComponent) {
     ...
     *
     * @returns {*}
     * results for the given parameter name from the application container
     */
     ...
     *
     * @returns {string[]} All technical parameter names defined in this file
     *
     * @private
     */
     ...
     * @returns {*} The results for the given parameter name
     */
