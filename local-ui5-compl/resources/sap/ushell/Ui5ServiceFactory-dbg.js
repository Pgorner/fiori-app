...
sap.ui.define([
    ...
    function createServiceFactory (sUshellServiceName, bAddCallProtection) {
        ...
        /**
         * @alias sap.ushell.Ui5ServiceFactory
         * @namespace
         *
         * @private
         */
        var Ui5ServiceFactory = ServiceFactory.extend("sap.ushell.ui5service." + sUshellServiceName + "Factory", /** @lends sap.ushell.Ui5ServiceFactory.prototype */ {
