    ...
    ComponentKeysHandler.prototype = {
        ...
        _init: function () {
            ...
            if (!this.oLaunchPageService) {
                return Container.getServiceAsync("FlpLaunchPage").then(function (oLaunchPageService) {
        ...
        _moveTile: function (sDirection) {
            ...
            if (oTargetTile) {
                ...
                var oDashboardView = Element.getElementById("sapUshellDashboardPage").getParent();
        ...
        _getGroupAndTilesInfo: function () {
            ...
            var oCurTile = Element.closestTo(jqTile[0]);

            oCurTile.isLink = jqTile.hasClass("sapUshellLinkTile") || jqTile.hasClass("sapMGTLineMode");

            var oGroup = Element.closestTo(jqTile.closest(".sapUshellTileContainer")[0]);
         ...
         * @param {Object} jqFocused jQuery of the focuced element
         * @private
         * @deprecated As of version 1.120
         */
        ...
        _setTileFocus: function (oTileElement) {
            ...
            var oTileControl = Element.getElementById(oTileElement.getAttribute("id"));
        ...
        _homeEndButtonsHandler: function (selector, oEvent, jqFocused) {
            if (jqFocused.hasClass("sapUshellAnchorItem")) {
                ...
                if (jqGroup) {
                    var oGroup = Element.closestTo(jqGroup[0]);
        ...
        _spaceButtonHandler: function (oEvent, jqFocused) {
            ...
            if (jqClosestButton.length && !this.oModel.getProperty("/tileActionModeActive")) {
                var oButtonControl = Element.closestTo(jqClosestButton[0]);
                if (oButtonControl) {
                ...
                if (sCurrentCoreView === "appFinder" && !Config.last("/core/workPages/contentFinderStandalone")) {
                    ...
                    if (bFocusPassedFirstTime) {
                        if (oEvent.shiftKey) { // backwards navigation
                            ...
                            var openCloseSplitAppButton = Element.getElementById("openCloseButtonAppFinderSubheader");
