...
sap.ui.define([
    ...
    return UIComponent.extend("sap.ushell.components.visualizationOrganizer.Component", {
        ...
        open: function (oOpenBy, oVizInfo) {
            var oPopover = Element.getElementById("sapUshellVisualizationOrganizerPopover");
        ...
        _applyOrganizationChangeToSection: function (oOpenBy, oVizInfo, oSectionContext) {
            return Container.getServiceAsync("Pages").then(function (oPageService) {
                var oVizChangeChain;
        ...
        _applyOrganizationChange: function (oVisualizationChanges, bShowMessage) {
            ...
            var oPagesService;
            var oVizChangeChain = Container.getServiceAsync("Pages").then(function (PagesService) {
        ...
        _resetPopup: function (oEvent) {
            var oPopover = Element.getElementById("sapUshellVisualizationOrganizerPopover");
            var oPagesList = Element.getElementById("sapUshellVisualizationOrganizerSpacesList");
            var oSearchField = Element.getElementById("sapUshellVisualizationOrganizerSearch");
            var oToggleButton = Element.getElementById("sapUshellVisualizationOrganizerSelectedPages");
        ...
        _onSearch: function (oEvent) {
            var oSelectedPagesButton = Element.getElementById("sapUshellVisualizationOrganizerSelectedPages");
