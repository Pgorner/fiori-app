...
sap.ui.define([
...
], function (Controller, Core, JSONModel, Edition, mLib, Menu, MenuItem, AddBookmarkButton, GridContainerItemLayoutData, EventHub, Container) {
  ...
  return Controller.extend("sap.ushell.components.cepsearchresult.app.Main", {
    ...
    onInit: function () {
      ...
      var oShellRenderer = Container?.getRendererInternal();
