...
sap.ui.define([
  ...
  var Paginator = Control.extend(
    "sap.ushell.components.cepsearchresult.app.util.controls.Paginator", /** @lends sap.ushell.components.cepsearchresult.app.cards.serchresult.controls.Paginator.prototype */ {
    metadata: {
      properties: {
        pageSize: {
          type: "int",
