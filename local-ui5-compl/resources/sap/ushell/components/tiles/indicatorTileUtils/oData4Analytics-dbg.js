...
sap.ui.define([
     ...
     * @class
     * @classdesc Representation of an OData model with analytical annotations defined by OData4SAP.
     */
     ...
     * @class
     * @classdesc Handle to an OData model by the URI pointing to it.
     */
     ...
     * @class
     * @classdesc Handle to an already instantiated SAP UI5 OData model.
     */
     ...
     * @this (QueryResult)
     * @class
     * @classdesc Representation of an entity type annotated with sap:semantics="aggregate".
     */
     ...
     * @class
     * @classdesc Representation of an entity type annotated with sap:semantics="parameters".
     */
     ...
     * @class
     * @classdesc Representation of a property annotated with sap:parameter.
     */
     ...
     * @class
     * @classdesc Representation of a property annotated with sap:aggregation-role="measure".
     */
    ...
    sap.ushell.components.tiles.indicatorTileUtils.odata4analytics.QueryResultRequest.prototype = {
         ...
         *
         * @param {string[]} aDimensionName Array of dimension names to be part of the aggregation level.
         ...
         *
         * @param {string[]} aDimensionName Array of dimension names to be added to the already defined aggregation level.
         */
         ...
         *
         * @param {string[]} aDimensionName Array of dimension names to be removed from the already defined aggregation level.
         */
         ...
         *
         * @param {string[]} aMeasureName Array of measure names to be part of the query result request.
