...
sap.ui.define([
    ...
    return UIComponent.extend("sap.ushell.components.tiles.cdm.applauncherdynamic.Component", {
        ...
        createContent: function () {
            ...
            } else if (oIndicatorDataSource && oIndicatorDataSource.url) {
                oP13n.serviceUrl = oIndicatorDataSource.url;
                oP13n.serviceRefreshInterval = oIndicatorDataSource.refreshInterval;
            }
         ...
         * @since 1.116.0
         */
        tileSetPreview: function (bPreview) {
            if (this._oController) {
                this._oController.previewHandler(bPreview);
            }
        },
