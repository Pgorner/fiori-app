...
sap.ui.define([
    ...
    return Controller.extend("sap.ushell.components.shell.NavigationBarMenu.controller.NavigationBarMenu", /** @lends sap.ushell.components.shell.NavigationBarMenu.controller.NavigationBarMenu.prototype */ {
        ...
        openNavigationBarMenuPopover: function (oEvent) {
            ...
            this._pPopoverPromise.then((oNavigationBarMenuPopover) => {
        ...
        handlePinButtonPress: function (oEvent) {
            ...
            const bIsPinned = this.oModel.getProperty(sSpacePath + "/pinned");
            if (!bIsPinned) {
            ...
            const oNavigationBarMenuPopover = this.byId("NavigationBarMenuPopover");
        ...
        _handleSpacesSwap: function (bSwapDirectionUp) {
            ...
            for (let i = 0; i < aPinnedSpaces.length; ++i) {
                ...
                const iSourcePinnedSortOrder = this.oModel.getProperty(oSourceContext.getPath()).pinnedSortOrder;
                ...
                const iTargetPinnedSortOrder = this.oModel.getProperty(oTargetContext.getPath()).pinnedSortOrder;
