...
sap.ui.define([
    ...
    return Controller.extend("sap.ushell.components.shell.Settings.userLanguageRegion.LanguageRegionSelector", {
        onInit: function () {
            ...
            this.oUserInfoServicePromise
                .then(function (UserInfo) {
                    ...
                    var bIsEnableSetLanguage = Container.getRendererInternal("fiori2").getShellConfig().enableSetLanguage || false;
                    ...
                    const oCuaFlags = {
                        ...
                        numberFormat: _isEnabled("DECIMAL_NOTATION"),
        ...
        _getABAPNumberFormat: function () {
            var sABAPNumberFormat = Formatting.getABAPNumberFormat();
