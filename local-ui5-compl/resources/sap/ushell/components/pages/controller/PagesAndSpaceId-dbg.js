...
sap.ui.define([
...
], function (resources, Config, Container) {
    "use strict";
    ...
    PagesAndSpaceId.prototype.getPageAndSpaceId = function (sShellHash) {
        return Container.getServiceAsync("URLParsing").then(function (urlParsingService) {
    ...
    PagesAndSpaceId.prototype._getUserDefaultSpaceAndPage = function () {
        return new Promise(function (resolve, reject) {
            Promise.all([ Container.getServiceAsync("Menu"), this.getUserMyHomeEnablement()]).then(function (aResults) {
