...
sap.ui.define([
     ...
     * @private
     */
    return UIComponent.extend("sap.ushell.components.pages.Component", /** @lends sap.ushell.components.pages.Component.prototype */{
        metadata: {
            manifest: "json",
            library: "sap.ushell",
        ...
        init: function () {
            ...
            SharedComponentUtils.getEffectiveHomepageSetting(
            ...
            this._oPagesService = Container.getServiceAsync("Pages");
