...
sap.ui.define([
...
], function (mobileLibrary, Element, Config, Container, EventHub, resources) {
    "use strict";
    ...
    function getCatalogView () {
        return Element.getElementById("catalogView");
    }
    /**
    ...
    function getAppFinderView () {
        return Element.getElementById("appFinderView");
    }
