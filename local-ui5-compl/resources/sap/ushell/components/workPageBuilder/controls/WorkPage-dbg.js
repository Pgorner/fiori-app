...
sap.ui.define([
    ...
    var IllustratedMessageSize = mobileLibrary.IllustratedMessageSize;
    ...
    var WorkPage = Control.extend("sap.ushell.components.workPageBuilder.controls.WorkPage", /** @lends sap.ushell.components.workPageBuilder.controls.WorkPage.prototype */ {
        metadata: {
            ...
            properties: {
                ...
                /**
                 * Specifies whether the page title is visible.
                 */
                showTitle: { type: "boolean", group: "Misc", defaultValue: true, bindable: true },
                /**
                ...
                /**
                 * The current breakpoint which will be added to the page attributes
                 */
                breakpoint: { type: "string", defaultValue: "lt-lp-4", bindable: true }
            },
            ...
            events: {
                ...
                addFirstRow: {},
                /**
                 * Fired after the WorkPage has been rendered.
                 */
                afterRendering: {}
            }
        },
    ...
    /**
     * Hook to fire afterRendering event.
     */
    WorkPage.prototype.onAfterRendering = function () {
 ...
 */
    ...
    WorkPage.prototype._createIllustratedMessage = function () {
        return new IllustratedMessage(`${this.getId()}-emptyWorkpageMessage`, {
            ...
            additionalContent: [
                new Button(`${this.getId()}-addFirstRowButton`, {
