...
sap.ui.define([
     ...
     */
    var WorkPageButton = Control.extend("sap.ushell.components.workPageBuilder.controls.WorkPageButton", /** @lends sap.ushell.components.workPageBuilder.controls.WorkPageButton.prototype */ {
            metadata: {
                library: "sap.ushell",
                properties: {
                    /**
    ...
    WorkPageButton.prototype.getIconControl = function () {
        if (!this.getAggregation("_icon")) {
            this.setAggregation("_icon", new Icon(`${this.getId()}-icon`, {
                src: this.getIcon(),
