...
sap.ui.define([
    ...
    var WorkPageColumnResizer = Control.extend("sap.ushell.components.workPageBuilder.controls.WorkPageColumnResizer", /** @lends sap.ushell.components.workPageBuilder.controls.WorkPageColumnResizer.prototype */ {
            metadata: {
                library: "sap.ushell",
                events: {
                    /**
            ...
            renderer: {
                ...
                render: function (rm, workPageColumnResizer) {
                    ...
                    rm.class("workPageDivider");
                    rm.attr("tabindex", "0");
                    rm.openEnd(); // div - tag

                    rm.openStart("div");
                    rm.class("workPageDividerInner");
                    rm.openEnd(); // div - tag
