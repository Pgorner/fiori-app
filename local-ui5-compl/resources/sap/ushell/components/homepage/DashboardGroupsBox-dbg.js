...
sap.ui.define([
     ...
     * @private
     */
    var DashboardGroupsBox = baseObject.extend("sap.ushell.components.homepage.DashboardGroupsBox", /** @lends sap.ushell.components.homepage.DashboardGroupsBox.prototype */{
        metadata: {
        ...
        _updateGroupHeaderVisibility: function () {
            ...
            var bEditMode = this.oModel.getProperty("/tileActionModeActive");
            var bAnchorbar = this.oController.getView().oAnchorNavigationBar.getVisible();
            var iFirstVisible;
