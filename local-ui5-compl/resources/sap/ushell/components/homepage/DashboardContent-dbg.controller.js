    ...
    return Controller.extend("sap.ushell.components.homepage.DashboardContent", {
        ...
        dashboardTilePress: function (oEvent) {
            ...
            if (Device.system.desktop) {
                var oRenderer = sap.ushell.Container.getRendererInternal();
        ...
        _getIndexOfTopGroupInViewPort: function () {
            ...
            var oScrollableElement = oViewDomRef.getElementsByTagName("section")[0];
            var jqTileContainers = jQuery(oScrollableElement).find(".sapUshellTileContainer").not(".sapUshellHidden");
        ...
        _handleGroupDeletion: function (oGroupBindingCtx) {
            sap.ui.require(["sap/m/MessageBox"], function (MessageBox) {
                ...
                sap.ushell.Container.getServiceAsync("MessageInternal").then(function (oMessageSrvc) {
        ...
        _scrollToGroupByName: function (sChannelId, sEventId, oData) {
            ...
            sap.ushell.Container.getServiceAsync("FlpLaunchPage").then(function (oLaunchPageSrv) {
            ...
            if (!bIntersect) {
                sap.ushell.Container.getServiceAsync("FlpLaunchPage").then(function (oLaunchPageSrv) {
                    ...
                    oPromise.fail(function () {
                        sap.ushell.Container.getServiceAsync("MessageInternal").then(function (msgService) {
