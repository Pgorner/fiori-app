...
sap.ui.define([
    ...
    ActionMode.prototype._activate = function () {
        ...
        var oDashboardGroups = Element.getElementById("dashboardGroups");
        oDashboardGroups.addLinksToUnselectedGroups();

        // Change action mode button display in the user actions menu
        var oTileActionsButton = Element.getElementById("ActionModeBtn");
    ...
    ActionMode.prototype._deactivate = function () {
        ...
        var tileActionsMenu = Element.getElementById("TileActions");
    ...
    ActionMode.prototype._openActionsMenu = function (oEvent) {
        ...
        if (!oActionSheetTarget) {
            var oMoreAction = Element.getElementById(oTileControl.getId() + "-action-more");
            oActionSheetTarget = (oMoreAction || oTileControl);
        }

        var oActionSheet = Element.getElementById("TileActions");
        if (!oActionSheet) {
