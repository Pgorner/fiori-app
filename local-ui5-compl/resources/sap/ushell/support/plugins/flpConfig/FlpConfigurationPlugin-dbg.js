...
sap.ui.define([
    ...
    function _onPressExpand (/*oEvent*/) {
        ...
        var sSelectedKey = Element.getElementById("sap-ui-support-flpConfigurationPlugin-TabBar").getSelectedKey();
        var oFlpConfig = Element.getElementById("sap-ui-support-flpConfigurationPlugin-TabBar").getModel().getData();
        ...
        if (Array.isArray(oFlpConfig[sSelectedKey])) {
            ...
            if (iHierarchyCount > 0) {
                ...
                MessageBox.error(new Label({
                    text: Element.getElementById("sap-ui-support-flpConfigurationPlugin-TabBar")
    ...
    flpConfigPlugin.prototype.onPressSearchNewModel = function (oEvent) {
        ...
        var oFlpConfig = Element.getElementById("sap-ui-support-flpConfigurationPlugin-TabBar").getModel("Full");
