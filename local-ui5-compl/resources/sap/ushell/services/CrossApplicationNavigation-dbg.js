...
sap.ui.define([
    ...
    function CrossApplicationNavigation (oContainerInterface, sParameters, oServiceConf) {
        ...
        this.hrefForExternal = function (oArgs, oComponent, bAsync) {
            ...
            oArgsClone = crossApplicationNavigationUtils.injectStickyParameters({
                args: oArgsClone,
            ...
            return ShellNavigationInternal.hrefForExternalSync(oArgsClone, undefined, oComponent);
        };
         ...
         * @returns {jQuery.Promise} Resolves the expanded shell hash as first argument.
         *
         * @public
         */
        ...
        this._checkIfAppNeedsToBeReloaded = function (navTarget, currentApplication, currentApplicationIntent, shellNavigationHashChanger) {
            ...
            if (!UrlParsing.haveSameIntentParameters(oTargetIntent, currentApplicationIntent)) {
         ...
         * @returns {jQuery.Promise} Resolves to an object of the following form when a relevant link object exists:
         *   <pre>
         *   {
         ...
         * @returns {jQuery.Promise} Resolves with an array of link objects containing (at least) the following properties:
         * <pre>
         *   {
         ...
         *
         * @param {string} [vArgs.semanticObject] Optional, matches any semantic objects if undefined
         * @param {string} [vArgs.action] Optional, matches any actions if undefined
         * @param {object} [vArgs.params] Optional business parameters
         * @param {boolean} [vArgs.withAtLeastOneUsedParam] Optional, defaults to false. If true, returns only the links that use at least one (non sap-) parameter from 'params'.
         * @param {string} [vArgs.sortResultsBy] Optional parameter that decides on how the returned results will be sorted.
         * @param {boolean} [vArgs.treatTechHintAsFilter] Optional, defaults to false. If true, only apps that match exactly the supplied technology (e.g. sap-ui-tech-hint=WDA) will be considered.
         * @param {sap.ui.core.Component} vArgs.ui5Component Mandatory, the UI5 component invoking the service, shall be a root component.
         * @param {string} [vArgs.appStateKey] Optional, application state key to add to the generated links, SAP internal usage only.
         * @param {boolean} [vArgs.compactIntents=false] Optional, whether intents should be returned in compact format. Defaults to false.
         * @param {string[]} [vArgs.tags] Optional, if specified, only returns links that match inbound with certain tags.
         *
         * @returns {jQuery.Promise} Resolves with an array of link objects containing (at least) the following properties:
         *  <pre>
         *   {
         ...
         *
         * @returns {jQuery.Promise} Resolves with an array of strings representing the semantic objects
         ...
         * </pre>
         * @param {object} [oComponent] The root component of the application
         * @returns {jQuery.Promise} Resolves to an array of objects indicating whether the intent is supported or not. Each object has a property
         ...
         *
         * This method should be accessed by the Unified Inbox and Copilot only.
         *
         ...
         * @returns {jQuery.Promise} Resolves the component instance.
         * @since 1.32.0
         * @private
        ...
        this.createComponentInstance = function (sIntent, oConfig, oOwnerComponent) {
            ...
            ComponentInstantiation.createComponentInstance(sIntent, oComponentData, oOwnerComponent)
                .then(oDeferred.resolve)
                .catch(oDeferred.reject);
         ...
         *   this method and should not be passed in `componentData`:
         *     -- componentData.startupParameters, componentData.config, componentData["sap-xapp-state"].
         * @returns {Promise<object>} Resolves the component data.
         * @since 1.88.0
         * @private
        ...
        /**
         * Checks the component config object
         *
         * @param {object} oConfig The component config object.
         * @returns {string|null} Returns an error message if an error was found, otherwise null
         * @private
         * @since 1.129.0
         */
         ...
         * @returns {jQuery.Promise} Resolves the app state object.
         ...
         * @returns {jQuery.Promise} Resolves the data of an AppState object, or an empty <code>{}</code> javascript
         ...
         *
         * @ui5-restricted SAP Internal usage only, beware! internally public, cannot be changed, but not part of the public documentation and exposure to WebDynpro ABAP
         * @private
         */
         ...
         * @returns {jQuery.Promise} Resolves an array of individual save promise objects is returned as argument
         ...
         * @returns {jQuery.Promise} Resolves the intent.
         * @protected
         */
