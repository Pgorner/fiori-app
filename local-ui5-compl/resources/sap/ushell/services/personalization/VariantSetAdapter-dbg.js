 ...
 * @deprecated since 1.120 Please use {@link sap.ushell.services.PersonalizationV2.VariantSetAdapter} instead
 */
sap.ui.define([
     ...
     *
     * @class
     * @classdesc Wrapper object to expose a variant interface on a ContextContainer object obtained from the Personalization service:
     * <pre>
