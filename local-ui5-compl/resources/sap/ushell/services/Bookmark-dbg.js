...
sap.ui.define([
     ...
     */
    function Bookmark () {
        this._oLaunchPageServicePromise = sap.ushell.Container.getServiceAsync("FlpLaunchPage");
        ...
        this.updateBookmarks = function (sUrl, oParameters, sContentProviderId) {
            ...
            if (Config.last("/core/spaces/enabled")) {
                Promise.all([
                    ...
                    .then(function ([oPagesService, sNewUrl]) {
                        oParameters.url = sNewUrl;
                ...
                Promise.all([
                    ...
                    .then(function ([LaunchPageService, sNewUrl]) {
                        oParameters.url = sNewUrl;
        ...
        this._changeUrlStatesToPersistent = async function (sUrl) {
            ...
            var bAppStateConfigPersistent = AppState.getPersistentWhenShared();
