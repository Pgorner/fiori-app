...
sap.ui.define([
    ...
    function UITracer (oContainerInterface, sParameter, oConfig) {
        ...
        if (oUshellContainer) {
            this._initialized = oUshellContainer.getFLPPlatform().then(function (sPlatform) {
                if (sPlatform === "MYHOME") {
                ...
                return oUshellContainer.getServiceAsync("CommonDataModel").then(function (oCDMModel) {
