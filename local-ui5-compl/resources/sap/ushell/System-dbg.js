...
sap.ui.define([], function () {
     ...
     * @class
     * @classdesc A representation of a system
    ...
    /**
     * Returns whether the SysInfoBar should be displayed or not.
     *
     * @returns {boolean} True if the SysInfoBar should be displayed.
     * @since 1.114.0
     */
    System.prototype.getSysInfoBar = function () {
        return !!this._oData.sysInfoBar;
    };

    /**
     * Returns the color string for the SysInfoBar.
     *
     * @returns {string} Color string.
     * @since 1.114.0
     */
    System.prototype.getSysInfoBarColor = function () {
        return this._oData.sysInfoBarColor;
    };

    /**
     * Returns the main string for the SysInfoBar.
     *
     * @returns {string} Main string.
     * @since 1.114.0
     */
    System.prototype.getSysInfoBarMainText = function () {
        return this._oData.sysInfoBarMainText;
    };

    /**
     * Returns the secondary string for the SysInfoBar.
     *
     * @returns {string} Secondary string.
     * @since 1.114.0
     */
    System.prototype.getSysInfoBarSecondaryText = function () {
        return this._oData.sysInfoBarSecondaryText;
    };

    /**
     * Returns the icon string for the SysInfoBar.
     *
     * @returns {string} Icon URL.
     * @since 1.114.0
     */
    System.prototype.getSysInfoBarIcon = function () {
        return this._oData.sysInfoBarIcon;
    };
