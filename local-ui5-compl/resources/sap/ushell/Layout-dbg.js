 ...
 * @fileoverview Classical home page layout
 */
sap.ui.define([
    ...
    CollisionModule.prototype = {
        ...
        init: function (settings) {
            ...
            this.rightToLeft = Localization.getRTL();
        ...
        saveLinkBoundingRects: function (elLink) {
            var oLink = Element.getElementById(elLink.getAttribute("id"));
        ...
        layoutStartCallback: function (element) {
            this.init();
            this.item = Element.getElementById(element.getAttribute("id"));
        ...
        _getDestGroupObject: function ($targetGroup) {
            return $targetGroup ? Element.getElementById(($targetGroup.getAttribute("id"))) : this.endGroup;
        },
        ...
        _handleOverflowCollision: function (moveX) {
            var oAnchor = Element.getElementById("anchorNavigationBar");
    ...
    LayoutConstructor.prototype = {
        ...
        _initDeferred: new Promise(function (fnResolve) { fnPromiseResolve = fnResolve; }),
        ...
        init: function (cfg) {
            ...
            EventBus.getInstance().subscribe("launchpad", "tabBarChange", this._onTabBarChange, this);
