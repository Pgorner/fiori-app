            ...
            if (AppRuntimeContext.getIsScube()) {
                this.getLinksLocal(oArgs).then(function (arrResult1) {
                    ...
                    AppRuntimeService.postMessageToFLP(
                        "sap.ushell.services.CrossApplicationNavigation.getLinks", oArgs).then(function (arrResult2) {
                ...
                removeComponent(oArgs);
                AppRuntimeService.postMessageToFLP(
                    "sap.ushell.services.CrossApplicationNavigation.getLinks", oArgs).then(oDeferred.resolve, oDeferred.reject);
            }
