...
sap.ui.define([
    ...
    var AccessKeysHandler = EventProvider.extend("sap.ushell.renderer.AccessKeysHandler", {
    ...
    AccessKeysHandler.prototype._focusItemInOverflowPopover = function (sItemId, iCounter) {
        var oOverflowPopup = Element.getElementById("headEndItemsOverflow");
    ...
    AccessKeysHandler.prototype._focusItemInUserMenu = function (sItemId, iCounter) {
        var oUserMenu = Element.getElementById("sapUshellUserActionsMenuPopover");
    ...
    AccessKeysHandler.prototype._handleAccessOverviewKey = function (bAdvancedShellActions) {
        var bSearchAvailable = this.oConfigModel.getProperty("/searchAvailable"),
            bPersonalization = this.oConfigModel.getProperty("/personalization"),
    ...
    AccessKeysHandler.prototype._focusAppFinderButton = function () {
        ...
        var oConfig = Container.getRendererInternal("fiori2").getShellConfig();
    ...
    AccessKeysHandler.prototype._handleAltShortcutKeys = function (oEvent, bAdvancedShellActions) {
        var oShellHeader = Element.getElementById("shell-header"),
            oUserMenu = Element.getElementById("sapUshellUserActionsMenuPopover"),
            oNotificationsPopup = Element.getElementById("shellNotificationsPopover");
    ...
    AccessKeysHandler.prototype._handleCtrlShortcutKeys = function (oEvent, bAdvancedShellActions) {
        if (oEvent.shiftKey) {
            if (oEvent.keyCode === 70) { // CTRL + SHIFT + F
                ...
                var oSearchBtn = Element.getElementById("sf");
                if (oSearchBtn) {
            ...
            var oSettingsBtn = Element.getElementById("userSettingsBtn");
            ...
            if (Config.last("/core/spaces/enabled")) {
                ...
                var oDoneButton = Element.getElementById("sapUshellDashboardFooterDoneBtn");
