...
sap.ui.define([
    ...
    var Renderer = UIComponent.extend("sap.ushell.renderer.Renderer", /** @lends sap.ushell.renderer.Renderer.prototype */ {
        ...
        init: function () {
            ...
            oRouter.getRoute("appfinder").attachMatched(function (oEvent) {
                ...
                var oComponent = Component.getComponentById(this.createId("Shell-appfinder-component"));
                ...
                AppLifeCycleAI.switchViewState("app", false, "Shell-appfinder");
                AppMeta.setAppIcons();
            ...
            oRouter.getRoute("wzsearch").attachMatched(function (oEvent) {
                AppLifeCycleAI.getShellUIService().setBackNavigation();
                AppLifeCycleAI.switchViewState("app", false, "cepsearchresult-app");
            });
    ...
    Renderer.prototype._prepareHomepage = function (oEvent) {
        ...
        var sCustomHomeTitle = Config.last("/core/shell/homePageTitle");
        var sHomeTitle = resources.getTranslationFromJSON(sCustomHomeTitle) || resources.i18n.getText("homeBtn_tooltip");

        var sRootIntent = this.getShellConfig().rootIntent;
        var bIsRootIntentFlpHome = !sRootIntent || ushellUtils.isFlpHomeIntent(sRootIntent);
        ...
        AppMeta.setAppIcons(); // For the custom theme the favicon should be loaded get from theme parameter
    ...
    Renderer.prototype._getHomeAppTarget = function () {
        return Container.getServiceAsync("Ui5ComponentLoader").then(function (Ui5ComponentLoader) {
    ...
    Renderer.prototype.removeFooterById = function (footerId) {
        ...
        var oFooter = Element.getElementById(footerId);
        if (oFooter) {
            oFooter.destroy();
        }
    };
    ...
    Renderer.prototype.removeFooter = function () {
        ...
        if (this.lastFooterId) {
            var oFooter = Element.getElementById(this.lastFooterId);
            if (oFooter) {
                oFooter.destroy();
            }
    ...
    Renderer.prototype.addFloatingButton = function (oParameters) {
        ...
        var that = this;
        var oControlInstance;
        var sControlType = oParameters.controlType || "sap.m.Button";
        var oControlProperties = oParameters.oControlProperties;
        var bIsVisible = oParameters.bIsVisible;
        var bCurrentState = oParameters.bCurrentState;
        var aStates = oParameters.aStates;
    ...
    Renderer.prototype._isBuiltInIntent = function (oParsedHash) {
        if (!Renderer._aBuiltInRoutes) {
            var aRoutes = this.getManifestEntry("/sap.ui5/routing/routes");
