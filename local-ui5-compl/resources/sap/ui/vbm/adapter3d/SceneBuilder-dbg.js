...
sap.ui.define([
	...
	"sap/base/Log",
	"./../library"
], function(BaseObject, Utilities, PolygonHandler, ModelHandler, THREE, DecalGeometry, html2canvas, Log, library) {
	"use strict";
	...
	SceneBuilder.prototype.synchronize = function() {
		...
		return new Promise(function(resolve, reject) {
			...
			var window = library.findInArray(that._context.windows, function(window) {
				return window.type === "default";
			});

			var scene = window && library.findInArray(that._context.scenes, function(scene) {
