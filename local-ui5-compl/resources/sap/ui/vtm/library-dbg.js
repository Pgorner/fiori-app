...
sap.ui.define([
        ...
        "sap/ui/vk/library",    // library dependency
        "./ArrayUtilities",
        "./MatrixComponent",
        "./MatrixUtilities",
        "./TreeItemUtilities",
    ...
    function(
         ...
         * @deprecated Since version 1.96.10
         * @namespace
         * @name sap.ui.vtm
         * @author SAP SE
         * @version 1.132.0
        ...
        var vtmLibrary = core.initLibrary({
            name: "sap.ui.vtm",
            dependencies: [
         ...
         */
         vtmLibrary.createVtm = function(sId, mSettings) {
         ...
         */
         vtmLibrary.getResourceBundle = function() {
            if (!resourceBundle) {
         ...
         */
         vtmLibrary.createMeasureId = function(object, measureName) {
         ...
         * @returns {string} The measure id string that was constructed for this measurement.
         */
        vtmLibrary.measure = function(object, measureName, task) {
        ...
        vtmLibrary.Matrix = SapUiBaseDataType.createType("sap.ui.vtm.Matrix", {
        ...
        /**
         * Interface for extensions which provide a behavior when an icon in the {@link sap.ui.vtm.InternalColumnDescriptor.MessageStatus} column is clicked.
         * @since 1.50
        ...
        /**
         * Interface for extensions which provide a behavior when the icon in the column header for the {@link sap.ui.vtm.InternalColumnDescriptor.MessageStatus} column is clicked.
         * @since 1.50
        ...
        /**
         * Interface for extensions which provide a behavior when an icon in the {@link sap.ui.vtm.InternalColumnDescriptor.Visibility} column is clicked.
         * @since 1.50
        ...
        /**
         * Interface for extensions which provide a behavior when the icon in the column header for the {@link sap.ui.vtm.InternalColumnDescriptor.Visibility} column is clicked.
         * @since 1.50
