...
sap.ui.define([
	...
	ODataControlFactory.prototype._createEdmDisplay = function(oSettings) {
		var oInnerControl,
			...
			bIsObjectStatus = oEdmProperty && oEdmProperty.criticalityInfo;
							...
							if (bTitleActive) {
								...
								oSmartLink = new SmartLink({
									...
									navigationTargetsObtained: function(oEvent) {
										var oObjectIdentifier = Element.getElementById(oEvent.getSource().getControl());
			...
			.then(function onMetaModelLoaded() {
				...
				if ((sMode !== "display" && // In display mode we ignore the textInEditModeSource
					...
					if (typeof vValueListAnnotationPath === "string") {
						...
						if (this._oMetaData.functionImportProperty && this._oMetaData.functionImportProperty["com.sap.vocabularies.Common.v1.ValueList"]) {
							return this._oHelper.getAnalyzer()._getFunctionImportValueListAnnotationLazy(this._oMetaData.functionImport, this._oMetaData.functionImportProperty);
						} else {
