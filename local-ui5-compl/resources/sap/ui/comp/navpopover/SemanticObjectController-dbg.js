...
sap.ui.define([
	...
	SemanticObjectController.prototype.registerControl = function(oControl) {
		...
		if (oControl.setNavigationTargetsObtainedCallback && this.getNavigationTargetsObtainedCallback()) {
			oControl.setNavigationTargetsObtainedCallback(this.getNavigationTargetsObtainedCallback());
		}
