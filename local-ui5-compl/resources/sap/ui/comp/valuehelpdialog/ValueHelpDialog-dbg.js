...
sap.ui.define([
	...
	ValueHelpDialog.prototype.update = function() {
		...
		if (!this._oDefaultSmartTable) {
			this._oTable?.getBinding("rows")?.attachEventOnce("dataReceived", function() {
				...
				this._addInvisibleMessageSearchAndTableCount(nRowCount);
			}, this);
		}
	 ...
	 * @private
	 */
	ValueHelpDialog.prototype._addInvisibleMessageSearchAndTableCount = function(nRowCount) {
		var sInvisibleMessage = this._oRb.getText("VALUEHELPDLG_SEARCH_RESULT_COUNT", [nRowCount]);
