...
sap.ui.define([
	 ...
	 * @private
	 */
	MetadataAnalyser.prototype._getFunctionImportValueListAnnotationLazy = function(oFunctionImport, oFunctionImportProperty) {
		...
		if (oValueList) {
			...
			return this._loadValueListAnnotationForFunctionImport(oFunctionImport.name, oFunctionImportProperty.name);
	};
	 ...
	 * @private
	 */
	MetadataAnalyser.prototype._loadValueListAnnotationForFunctionImport = function(sFunctionImportName, sParameterName) {
		var mAnnotation = {
				additionalAnnotations: []
			}, sPath,
		...
		var oPromise = new Promise(function(fResolve, fReject) {
			if (sPath && this._oMetaModel) {
				var oValueListsPromise = this._oMetaModel.getODataValueLists(oContext);
				oValueListsPromise.then(function(mValueList) {
