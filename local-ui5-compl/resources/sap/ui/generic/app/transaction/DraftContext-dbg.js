...
sap.ui.define(["sap/ui/base/Object", "sap/ui/generic/app/util/ModelUtil","sap/base/Log"], function(BaseObject, ModelUtil, Log) {
	"use strict";
	...
	DraftContext.prototype._getODataDraftEntitySet = function(sEntitySet) {
		...
		if (oEntitySet) {
			...
			Log.warning("EntitySet " + sEntitySet + " is not available in the main model");
		}
