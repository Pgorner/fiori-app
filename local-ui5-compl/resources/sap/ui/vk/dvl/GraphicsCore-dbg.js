...
sap.ui.define([
			...
			var downloadManager = new DownloadManager(sources, null, this._authorizationHandler, this._retryCount)
				...
				.attachAllItemsCompleted(function(event) {
					for (var i = 0; i < sourceData.length; i++) {
						this._sourceData.push(sourceData[i]);
					}
	 ...
	 * @public
	 * @deprecated Since version 1.50.0. Create instance of {@link sap.ui.vk.ViewStateManager} instead.
	 */
	 ...
	 * @returns {this} <code>this</code> to allow method chaining.
	 * @public
	 * @deprecated Since version 1.50.0. Use your reference to {@link sap.ui.vk.ViewStateManager} to properly destroy this object.
	 */
