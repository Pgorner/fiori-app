...
sap.ui.define([
	 ...
	 * Updates a hotspot.
	 *
	 * Historically, hotspots created from geometry were nodes without child nodes and own geometry.
	...
	HotspotHelper.prototype.mergeHotspots = function(scene, hotspots) {
		...
		if (pageIndex != null) {
			targetNode.pageIndex = pageIndex;
		}
