	...
	function(
		...
		RedlineConversation.prototype.exportJSON = function() {
			...
			if (pageId >= 0) {
				...
				json.sceneView = this.getViewId();
				json.viewInfo = this.getViewInfo();
				json.animationOffset = this.getAnimationOffset();
			}
		...
		RedlineConversation.prototype.importJSON = function(json) {
			...
			if (json.hasOwnProperty("pageId")) {
				this.setPageId(json.pageId);
			}
			return userIds;
		};
