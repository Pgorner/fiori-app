...
sap.ui.define([
	...
	RedlineElementText.prototype.renderElement = function(renderManager, halo) {
		...
		renderManager.style("font-size", `calc(${this.getFontSize()}px * var(--sapUiVizKitRedlineScale, 1))`);
		...
		renderManager.style("width", `calc(${this.getWidth()}px * var(--sapUiVizKitRedlineScale, 1))`);
		renderManager.style("height", `calc(${(this.getHeight() || this.getFontSize() * 1.2)}px * var(--sapUiVizKitRedlineScale, 1))`);
		renderManager.openEnd();
