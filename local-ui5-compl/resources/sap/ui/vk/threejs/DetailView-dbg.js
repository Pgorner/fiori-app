...
sap.ui.define([
	...
	DetailView.prototype._render = function(renderer, camera, scene, boundingBox, cameraLight) {
		...
		if (cameraLight?.isDirectionalLight) {
			dvCamera.updateMatrixWorld();
			cameraLight.position.setFromMatrixColumn(dvCamera.matrixWorld, 2);
