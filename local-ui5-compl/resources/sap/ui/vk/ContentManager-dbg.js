...
sap.ui.define([
	...
	/**
	 * Set the consumption scenario for metering differention.
	 * This value is passed in SAP-ConsumptionScenario HTTP headers in requests
	 * made to the EPD Visualization backend when viewing.
	 *
	 ...
	 * @since 1.114.0
	 */
	ContentManager.prototype.setConsumptionScenario = function(consumptionScenario) {
	...
	/**
	 * Updates the already loaded content.
	 *
	 * @param {sap.ui.vk.ContentResource[]} contentResources The content resources from which the original content was loaded.
	 * @param {any} content The content to update.
	 * @param {object} parameters The parameters to use for updating the content. The parameters can be different for different content types.
	 * @returns {Promise<any>} A promise that is resolved when the content has been updated.
	 * @private
	 */
