...
sap.ui.define([
	 ...
	 */
	var CreateEllipseToolGizmo = CreateParametricGizmo.extend("sap.ui.vk.tools.CreateEllipseToolGizmo", /** @lends sap.ui.vk.tools.CreateEllipseToolGizmo.prototype */ {
		metadata: {
			library: "sap.ui.vk"
		}
	});
	 ...
	 * @private
	 */
	CreateEllipseToolGizmo.prototype._stopAdding = function(addElement) {
		var activeElement = this._activeElement;
