...
sap.ui.define([
	 ...
	 */
	var CreateTextToolGizmo = CreateParametricGizmo.extend("sap.ui.vk.tools.CreateTextToolGizmo", /** @lends sap.ui.vk.tools.CreateTextToolGizmo.prototype */ {
		metadata: {
			library: "sap.ui.vk"
		}
	});
	...
	CreateTextToolGizmo.prototype._editText = function(textElement) {
		...
		var editForm = this._editForm = new Popover({
			showHeader: false,
			placement: PlacementType.PreferredLeftOrFlip,
			content: new VBox({
				items: [
					new RichTextEditor({
						width: "500px",
