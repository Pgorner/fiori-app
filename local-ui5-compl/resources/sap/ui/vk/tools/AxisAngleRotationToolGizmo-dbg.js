...
sap.ui.define([
	...
	AxisAngleRotationToolGizmo.prototype._onVisibilityChanged = function(event) {
	...
	AxisAngleRotationToolGizmo.prototype._updateNodeRotation = function(nodeInfo) {
		const quaternion = this._calculateRotationQuaternion(nodeInfo);
		const node = nodeInfo.node;
		node.quaternion.multiplyQuaternions(quaternion, nodeInfo.quaternion);
		node.updateMatrix();
	...
	AxisAngleRotationToolGizmo.prototype._rotate = function(euler, noSnapping) {
