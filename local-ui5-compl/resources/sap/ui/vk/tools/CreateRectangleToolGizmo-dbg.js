...
sap.ui.define([
	 ...
	 */
	var CreateRectangleToolGizmo = CreateParametricGizmo.extend("sap.ui.vk.tools.CreateRectangleToolGizmo", /** @lends sap.ui.vk.tools.CreateRectangleToolGizmo.prototype */ {
		metadata: {
			library: "sap.ui.vk"
		}
	});
	...
	CreateRectangleToolGizmo.prototype.show = function(viewport, tool) {
		viewport.addStyleClass("sapVizKitViewportCreateToolActive");
	...
	CreateRectangleToolGizmo.prototype.hide = function() {
		this._viewport.removeStyleClass("sapVizKitViewportCreateToolActive");
		this._viewport = null;
		this._tool = null;
		this._root = null;
	};
	...
	CreateRectangleToolGizmo.prototype._startAdding = function(pos) {
		...
		this._setPageIndexIfExists(node);
	 ...
	 * @param {boolean} addElement An indicator to add the element to the scene or not.
	 * @private
	 */
	CreateRectangleToolGizmo.prototype._stopAdding = function(addElement) {
		var activeElement = this._activeElement;
		...
		if (addElement) {
			...
			this._root.remove(activeElement.parent);
		}
	};
