...
sap.ui.define([
	...
	'sap/m/MessageBox',
	'./library'
], function(coreLibrary, NumberFormat, ExportUtils, MLibrary, Dialog, Button, ProgressIndicator, Text, MessageBox, Library) {
	'use strict';
		...
		return new Promise(function(fnResolve, fnReject) {
			...
			ExportUtils.getResourceBundle().then(function(oResourceBundle) {
				...
				dialog.updateStatus = function(iFetched, iTotal, sMessage) {
					...
					ExportUtils.announceExportStatus(Status.UPDATE, {values: [iFetched, iTotal]});
