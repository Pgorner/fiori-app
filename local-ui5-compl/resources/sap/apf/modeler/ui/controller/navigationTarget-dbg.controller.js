sap.ui.define([
	...
	function _instantiateSubView(oController) {
		...
		oController.getView().attachEvent(modelerConstants.events.UPDATESUBVIEWINSTANCESONRESET, oContextMappingView.getController().updateSubViewInstancesOnReset.bind(oContextMappingView.getController()));
	...
	function _setNavTargetType(oController) {
		var staticValuesBuilder = new StaticValuesBuilder(oTextReader, optionsValueModelBuilder);
	...
	return Controller.extend("sap.apf.modeler.ui.controller.navigationTarget", {
		onInit : function() {
			...
			viewValidatorForNavigationTarget = new ViewValidator(oController.getView());
