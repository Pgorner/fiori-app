...
sap.ui.define([
	...
	"sap/base/Log"
],function(CoreFilter, constants, exportToGlobal, Log){
	'use strict';
	/**
	 * @public
	 * @class Filter object
	...
	var Filter = function(oMessageHandler) {
		...
		this.addAnd = function(sId) {
			Log.error("Method 'addAnd' is deprecated since 1.23.0", "Will be discarded with 1.26.0.");
		};
		/**
		 * @public
		 * @function
	 ...
	 * @returns {sap.apf.constants.FilterOperators} 
	 */
	...
	var FilterAnd = function(oMessageHandler, sId) {
		...
		this.getCompoundExpressions = function() {
			Log.error("Method 'getExpressions' is deprecated since 1.23.0", "Will be discarded with 1.26.0.");
		};
		/**
		 * @public
		 * @function
		...
		this.addAndTerm = function(oTerm) {
			Log.error("Method 'addAndTerm' is deprecated since 1.23.0", "Will be discarded with 1.26.0.");
		};
		/**
		 * @private
		 * @function
		...
		this.addExpression = function(oExpression) {
			...
			oMessageHandler.check((constants.aSelectOpt.includes(oExpression.operator)), "Filter oExpression.operator " + oExpression.operator + " not supported");
	...
	var FilterOr = function(oMessageHandler, sId, oAnd) {
		...
		this.addOrTerm = function(oTerm) {
			Log.error("Method 'addOr' is deprecated since 1.23.0", "Will be discarded with 1.26.0.");
		};
		/**
		 * @private
		 * @function
	...
	exportToGlobal("sap.apf.utils.Filter", Filter);
