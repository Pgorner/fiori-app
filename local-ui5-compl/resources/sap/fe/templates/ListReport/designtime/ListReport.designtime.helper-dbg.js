...
sap.ui.define(["sap/fe/core/CommonUtils"], function (CommonUtils) {
  ...
  function getDesigntimeSettings() {
    ...
    const variantManagement = {
      ...
      enums: [{
        id: "Control",
        name: "RTA_CONFIGURATION_LR_VM_ENUM_CONTROL"
      }, {
        id: "None",
        name: "RTA_CONFIGURATION_LR_VM_ENUM_NONE"
      }, {
        id: "Page",
        name: "RTA_CONFIGURATION_LR_VM_ENUM_PAGE"
      }],
      keyUser: true
    };
    const initialLoad = {
      ...
      enums: [{
        id: "Auto",
        name: "RTA_CONFIGURATION_LR_INITIALLOAD_ENUM_AUTO"
      }, {
        id: "Enabled",
        name: "RTA_CONFIGURATION_LR_INITIALLOAD_ENUM_ENABLED"
      }, {
        id: "Disabled",
        name: "RTA_CONFIGURATION_LR_INITIALLOAD_ENUM_DISABLED"
      }],
      keyUser: true
    };
    const hideFilterBar = {
  ...
  function getGlobalSettings() {
    ...
    const sideEffectsEventsInteractionType = {
      ...
      enums: [{
        id: "None",
        name: "RTA_CONFIGURATION_LR_SE_ENUM_NONE"
      }, {
        id: "Confirmation",
        name: "RTA_CONFIGURATION_LR_SE_ENUM_CONF"
      }, {
        id: "Notification",
        name: "RTA_CONFIGURATION_LR_SE_ENUM_NOTF"
      }]
    };
   ...
   */
  _exports.getGlobalSettings = getGlobalSettings;
  ...
  function getGlobalSettingsValues(globalSettings, control) {
    const propertyValues = {};
   ...
   */
  _exports.getGlobalSettingsValues = getGlobalSettingsValues;
  function getGlobalSettingsValue(globalSetting, control) {
    let propertyValue = "";
    const appComponent = CommonUtils.getAppComponent(control);
   ...
   */
  _exports.getGlobalSettingsValue = getGlobalSettingsValue;
  ...
  function getSettingsGlobal(propertyValues) {
    const items = [];
  ...
  _exports.getSettingsGlobal = getSettingsGlobal;
  return _exports;
}, false);
//# sourceMappingURL=ListReport.designtime.helper-dbg.js.map
