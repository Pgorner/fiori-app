	...
	adaptNavigationContext: function (
		...
		try {
			...
			if (filterBar && !selectionVariant.isEmpty()) {
				let filterBarSelectionVariant = controller.getFilterBarSelectionVariant();
				const oData = {
					selectionVariant: filterBarSelectionVariant
				};
				let modifiedOData = {
					selectionVariant: {}
				};
				...
				filterBarSelectionVariant = modifiedOData?.selectionVariant as SelectionVariant;
