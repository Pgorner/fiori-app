...
sap.ui.define(["sap/fe/core/CommonUtils"], function (CommonUtils) {
  ...
  const MessageHandlerExtension = {
    getShowBoundMessagesInMessageDialog: function () {
      ...
      return !CommonUtils.getIsEditable(this.base) || this.base.getView().getBindingContext("internal").getProperty("isActionParameterDialogOpen") || this.base.getView().getBindingContext("internal").getProperty("getBoundMessagesForMassEdit");
    }
  };
