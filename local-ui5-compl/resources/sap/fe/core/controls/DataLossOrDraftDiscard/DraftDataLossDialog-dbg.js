 ...
 */
sap.ui.define(["sap/fe/base/ClassSupport", "sap/fe/core/helpers/ResourceModelHelper", "sap/fe/core/helpers/StableIdHelper", "sap/m/Button", "sap/m/CustomListItem", "sap/m/Dialog", "sap/m/Label", "sap/m/List", "sap/m/Text", "sap/m/VBox", "sap/ui/base/ManagedObject", "sap/ui/core/CustomData", "sap/ui/core/library", "sap/fe/base/jsx-runtime/jsx", "sap/fe/base/jsx-runtime/jsxs", "sap/fe/base/jsx-runtime/Fragment"], function (ClassSupport, ResourceModelHelper, StableIdHelper, Button, CustomListItem, Dialog, Label, List, Text, VBox, ManagedObject, CustomData, library, _jsx, _jsxs, _Fragment) {
  "use strict";
  ...
  let DraftDataLossDialog = (_dec = defineUI5Class("sap.fe.core.controls.DataLossOrDraftDiscard.DraftDataLossDialog"), _dec2 = defineReference(), _dec3 = defineReference(), _dec(_class = (_class2 = /*#__PURE__*/function (_ManagedObject) {
     ...
     */;
    _proto.getItems = function getItems(hasActiveEntity) {
