...
sap.ui.define(["sap/fe/base/BindingToolkit", "sap/fe/core/converters/controls/Common/Action", "sap/fe/core/converters/controls/ListReport/FilterBar", "sap/fe/core/converters/helpers/ConfigurableObject", "../../helpers/TypeGuards", "../ManifestSettings", "../controls/Common/DataVisualization", "../controls/Common/KPI", "../helpers/ID"], function (BindingToolkit, Action, FilterBar, ConfigurableObject, TypeGuards, ManifestSettings, DataVisualization, KPI, ID) {
  ...
  const convertPage = function (converterContext, capabilities) {
    ...
    const disableDraftEditStateFilter = lrTableVisualizations.every(tableVisualization => {
