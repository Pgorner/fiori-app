...
sap.ui.define(["sap/fe/core/converters/ManifestSettings", "sap/ui/Device"], function (ManifestSettings, Device) {
  ...
  let ManifestWrapper = /*#__PURE__*/function () {
    ...
    _proto.getHeaderFacets = function getHeaderFacets() {
      return this.mergeFn({}, this.oManifestSettings.controlConfiguration?.["@com.sap.vocabularies.UI.v1.HeaderFacets"]?.facets, this.oManifestSettings.content?.header?.facets);
    }
    ...
    _proto.getSections = function getSections() {
      return this.mergeFn({}, this.oManifestSettings.controlConfiguration?.["@com.sap.vocabularies.UI.v1.Facets"]?.sections, this.oManifestSettings.content?.body?.sections);
    }
