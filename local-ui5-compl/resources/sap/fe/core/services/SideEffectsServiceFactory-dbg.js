 ...
 */
sap.ui.define(["sap/base/Log", "sap/fe/core/converters/MetaModelConverter", "sap/fe/core/helpers/TypeGuards", "sap/fe/core/helpers/WebSocket", "sap/fe/core/templating/PropertyHelper", "sap/ui/core/service/Service", "sap/ui/core/service/ServiceFactory", "../templating/DataModelPathHelper"], function (Log, MetaModelConverter, TypeGuards, WebSocket, PropertyHelper, Service, ServiceFactory, DataModelPathHelper) {
  "use strict";
  ...
  let SideEffectsService = /*#__PURE__*/function (_Service) {
    ...
    _proto.getDataModelPropertiesFromAPath = function getDataModelPropertiesFromAPath(propertyPath, entityType) {
      ...
      let propertyRelativePath, testEntityTypeName, regexPattern, match;
