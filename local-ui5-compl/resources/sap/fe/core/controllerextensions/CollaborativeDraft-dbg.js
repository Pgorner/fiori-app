...
sap.ui.define(["sap/fe/base/ClassSupport", "sap/ui/core/Element", "../templating/UIFormatters", "./BaseControllerExtension", "./collaboration/CollaborationCommon"], function (ClassSupport, Element, UIFormatters, BaseControllerExtension, CollaborationCommon) {
  ...
  let CollaborationDraft = (_dec = defineUI5Class("sap.fe.core.controllerextensions.CollaborationDraft"), _dec(_class = /*#__PURE__*/function (_BaseControllerExtens) {
    ...
    _proto.handleContentFocusIn = function handleContentFocusIn(focusEvent) {
      let fieldpAPI = focusEvent.getSource();
      // We send the event only if the focus was previously out of the FieldAPI
      if (fieldpAPI.isA("sap.m.Tokenizer")) {
        fieldpAPI = fieldpAPI.getParent()?.getParent();
      }
      ...
      if (fieldpAPI.isA("sap.ui.mdc.MultiValueField") || targetOutsideOfControlDomRef) {
        ...
        if (lastFocusId && lastFocusId !== fieldpAPI.getId() && this.getLastFocusFieldGroups() === fieldpAPI.getFieldGroupIds().join(",")) {
    ...
    _proto.handleContentFocusOut = function handleContentFocusOut(fieldGroupEvent) {
      ...
      if (!control.isA("sap.ui.mdc.MultiValueField")) {
        while (control && !control?.isA("sap.fe.macros.field.FieldAPI")) {
     ...
     */;
    _proto.setLastFocusInformation = function setLastFocusInformation(focusedFieldAPI) {
    ...
    _proto.getCollaborationPath = function getCollaborationPath(field) {
      ...
      if (field.isA("sap.fe.macros.field.FieldAPI")) {
