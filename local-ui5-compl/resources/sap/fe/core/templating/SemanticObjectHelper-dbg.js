...
sap.ui.define(["sap/fe/base/BindingToolkit", "sap/fe/core/helpers/TypeGuards"], function (BindingToolkit, TypeGuards) {
  ...
  const manageSemanticObjectsForCurrentUser = function (semanticObject, dataModelPath, settings) {
    const property = dataModelPath.targetObject;
    const internalDataModel = settings.models.internal || settings.appComponent?.getModel("internal");
