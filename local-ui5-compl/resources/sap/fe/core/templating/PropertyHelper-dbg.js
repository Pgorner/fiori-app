...
sap.ui.define(["sap/fe/core/helpers/TypeGuards", "sap/fe/core/templating/SemanticObjectHelper"], function (TypeGuards, SemanticObjectHelper) {
  ...
  const hasValueHelp = function (property) {
    return !!property.annotations?.Common?.ValueList || !!property.annotations?.Common?.ValueListReferences || !!property.annotations?.Common?.ValueListWithFixedValues || !!property.annotations?.Common?.ValueListMapping;
  };
