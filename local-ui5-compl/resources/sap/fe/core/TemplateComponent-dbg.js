 ...
 */
sap.ui.define(["sap/fe/base/ClassSupport", "sap/fe/core/CommonUtils", "sap/fe/core/converters/MetaModelConverter", "sap/ui/core/UIComponent"], function (ClassSupport, CommonUtils, MetaModelConverter, UIComponent) {
  "use strict";
  ...
  let TemplateComponent = (_dec = defineUI5Class("sap.fe.core.TemplateComponent"), _dec2 = implementInterface("sap.ui.core.IAsyncContentCreation"), _dec3 = implementInterface("sap.fe.core.buildingBlocks.IBuildingBlockOwnerComponent"), _dec4 = property({
    ...
    type: "string"
  }), _dec17 = event(), _dec18 = event(), _dec19 = event(), _dec(_class = (_class2 = /*#__PURE__*/function (_UIComponent) {
    function TemplateComponent() {
       ...
       */
      _initializerDefineProperty(_this, "content", _descriptor10, _this);
      /**
       * Whether or not you can reach this page directly through semantic bookmarks
       */
      _initializerDefineProperty(_this, "allowDeepLinking", _descriptor11, _this);
      /**
       * Defines the context path on the component that is refreshed when the app is restored using keep alive mode
       */
      _initializerDefineProperty(_this, "refreshStrategyOnAppRestore", _descriptor12, _this);
      _initializerDefineProperty(_this, "viewType", _descriptor13, _this);
      _initializerDefineProperty(_this, "viewName", _descriptor14, _this);
      _initializerDefineProperty(_this, "_jsxViewName", _descriptor15, _this);
      _initializerDefineProperty(_this, "containerDefined", _descriptor16, _this);
      _initializerDefineProperty(_this, "heroesBatchReceived", _descriptor17, _this);
      _initializerDefineProperty(_this, "workersBatchReceived", _descriptor18, _this);
      return _this;
    }
    ...
    writable: true,
    initializer: null
  }), _descriptor11 = _applyDecoratedDescriptor(_class2.prototype, "allowDeepLinking", [_dec12], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  }), _descriptor12 = _applyDecoratedDescriptor(_class2.prototype, "refreshStrategyOnAppRestore", [_dec13], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  }), _descriptor13 = _applyDecoratedDescriptor(_class2.prototype, "viewType", [_dec14], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: function () {
  ...
  }), _descriptor14 = _applyDecoratedDescriptor(_class2.prototype, "viewName", [_dec15], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  }), _descriptor15 = _applyDecoratedDescriptor(_class2.prototype, "_jsxViewName", [_dec16], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: function () {
  ...
  }), _descriptor16 = _applyDecoratedDescriptor(_class2.prototype, "containerDefined", [_dec17], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  }), _descriptor17 = _applyDecoratedDescriptor(_class2.prototype, "heroesBatchReceived", [_dec18], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  }), _descriptor18 = _applyDecoratedDescriptor(_class2.prototype, "workersBatchReceived", [_dec19], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
