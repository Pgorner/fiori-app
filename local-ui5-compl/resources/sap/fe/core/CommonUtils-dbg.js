  ...
  async function createRootContext(programmingModel, view, appComponent) {
    ...
    if (context) {
      ...
      if (rootContextPath) {
        ...
        const existingBindingContextOnPage = appComponent.getRootViewController().getInstancedViews().find(pageView => pageView.getBindingContext()?.getPath() === rootContextPath)?.getBindingContext();
