 ...
 */
sap.ui.define(["sap/base/Log", "sap/fe/base/ClassSupport", "sap/fe/base/jsx-runtime/jsx", "sap/fe/controls/easyFilter/Token", "sap/m/Button", "sap/m/FlexBox", "sap/m/Popover", "sap/m/Tokenizer", "sap/m/VBox", "sap/m/library", "sap/ui/core/Control", "sap/ui/core/CustomData", "sap/ui/core/Lib", "sap/ui/core/library", "sap/base/util/deepClone", "sap/fe/base/BindingToolkit", "sap/fe/controls/easyFilter/EasyFilterInput", "sap/m/MessageStrip", "sap/m/OverflowToolbar", "sap/m/ToolbarSpacer", "sap/ui/performance/trace/FESRHelper", "./AINotice", "./utils", "sap/fe/base/jsx-runtime/jsx", "sap/fe/base/jsx-runtime/Fragment", "sap/fe/base/jsx-runtime/jsxs"], function (Log, ClassSupport, jsx, Token, Button, FlexBox, Popover, Tokenizer, VBox, library, Control, CustomData, Lib, coreLibrary, deepClone, BindingToolkit, EasyFilterInput, MessageStrip, OverflowToolbar, ToolbarSpacer, FESRHelper, AINotice, EasyFilterUtils, _jsx, _Fragment, _jsxs) {
  "use strict";
  ...
  let EasyFilterBarContainer = (_dec = defineUI5Class("sap.fe.controls.easyFilter.EasyFilterBarContainer"), _dec2 = property({
    ...
    type: "array"
  }), _dec7 = defineReference(), _dec8 = defineReference(), _dec9 = aggregation({
    type: "sap.ui.core.Control"
  }), _dec10 = event(), _dec11 = event(), _dec12 = event(), _dec13 = event(), _dec14 = event(), _dec15 = event(), _dec16 = defineState(), _dec(_class = (_class2 = /*#__PURE__*/function (_Control) {
    function EasyFilterBarContainer(properties, others) {
      ...
      _initializerDefineProperty(_this, "easyFilterInput", _descriptor6, _this);
      _initializerDefineProperty(_this, "tokenizer", _descriptor7, _this);
      _initializerDefineProperty(_this, "content", _descriptor8, _this);
      _initializerDefineProperty(_this, "tokensChanged", _descriptor9, _this);
      _initializerDefineProperty(_this, "queryChanged", _descriptor10, _this);
      _initializerDefineProperty(_this, "showValueHelp", _descriptor11, _this);
      _initializerDefineProperty(_this, "clearFilters", _descriptor12, _this);
      _initializerDefineProperty(_this, "beforeQueryProcessing", _descriptor13, _this);
      _initializerDefineProperty(_this, "afterQueryProcessing", _descriptor14, _this);
      _initializerDefineProperty(_this, "state", _descriptor15, _this);
    ...
    writable: true,
    initializer: null
  }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "easyFilterInput", [_dec7], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  }), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "tokenizer", [_dec8], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
    ...
    writable: true,
    initializer: null
  }), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, "tokensChanged", [_dec10], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  }), _descriptor10 = _applyDecoratedDescriptor(_class2.prototype, "queryChanged", [_dec11], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  }), _descriptor11 = _applyDecoratedDescriptor(_class2.prototype, "showValueHelp", [_dec12], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  }), _descriptor12 = _applyDecoratedDescriptor(_class2.prototype, "clearFilters", [_dec13], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  }), _descriptor13 = _applyDecoratedDescriptor(_class2.prototype, "beforeQueryProcessing", [_dec14], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  }), _descriptor14 = _applyDecoratedDescriptor(_class2.prototype, "afterQueryProcessing", [_dec15], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  }), _descriptor15 = _applyDecoratedDescriptor(_class2.prototype, "state", [_dec16], {
    configurable: true,
    enumerable: true,
    writable: true,
