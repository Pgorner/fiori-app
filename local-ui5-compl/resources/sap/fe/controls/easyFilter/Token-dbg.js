        ...
        if (totalSelectedValues === 1) {
          ...
          if (tokenInfo) {
            ...
            if (EasyFilterUtils.isBetweenSelectedValues(firstOperator)) {
              this.setProperty("value", EasyFilterUtils.mapOperatorForBetweenOperator(firstOperator, firstKeySpecificValue, type, dataType === "Edm.DateTimeOffset"), true);
            } else {
              this.setProperty("value", EasyFilterUtils.mapOperator(firstOperator, firstSelectedValue, type, dataType === "Edm.DateTimeOffset"), true);
            }
          }
        } else {
