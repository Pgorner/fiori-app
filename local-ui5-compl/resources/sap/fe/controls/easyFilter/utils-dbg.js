 ...
 */
sap.ui.define(["sap/ui/core/Lib", "sap/ui/core/format/DateFormat", "sap/ui/model/FilterOperator", "sap/ui/model/odata/type/DateTimeOffset"], function (Lib, DateFormat, FilterOperator, DateTimeOffset) {
  "use strict";
  ...
  function areItemsSame(arr1, arr2) {
    ...
    for (let i = 0; i < arr1.length; i++) {
      if (arr1[i].operator !== arr2[i].operator || !arr1[i].selectedValues.every((value, index) => value === arr2[i].selectedValues[index])) {
        return false;
      }
    }
