...
sap.ui.define(["sap/fe/base/ClassSupport", "sap/fe/core/buildingBlocks/BuildingBlock", "sap/fe/core/helpers/ModelHelper", "sap/fe/core/helpers/TypeGuards", "sap/fe/macros/field/FieldHelper", "sap/fe/macros/internal/valuehelp/ValueHelpTemplating"], function (ClassSupport, BuildingBlock, ModelHelper, TypeGuards, FieldHelper, ValueHelpTemplating) {
  ...
  let ValueHelp = (_dec = defineUI5Class("sap.fe.macros.ValueHelp"), _dec2 = association({
    ...
    function ValueHelp(props, others) {
       ...
       */
      _initializerDefineProperty(_this, "opensOnFocus", _descriptor7, _this);
      /**
       * Specifies whether the ValueHelp can be used with a MultiValueField
       */
      _initializerDefineProperty(_this, "useMultiValueField", _descriptor8, _this);
      _initializerDefineProperty(_this, "navigationPrefix", _descriptor9, _this);
      _initializerDefineProperty(_this, "requiresValidation", _descriptor10, _this);
      _initializerDefineProperty(_this, "_flexId", _descriptor11, _this);
  ...
  }), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "opensOnFocus", [_dec8], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: function () {
  ...
  }), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, "useMultiValueField", [_dec9], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: function () {
  ...
  }), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, "navigationPrefix", [_dec10], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  }), _descriptor10 = _applyDecoratedDescriptor(_class2.prototype, "requiresValidation", [_dec11], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: function () {
  ...
  }), _descriptor11 = _applyDecoratedDescriptor(_class2.prototype, "_flexId", [_dec12], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
