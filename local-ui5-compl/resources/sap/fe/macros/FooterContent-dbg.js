...
sap.ui.define(["sap/base/Log", "sap/fe/base/BindingToolkit", "sap/fe/base/ClassSupport", "sap/fe/core/buildingBlocks/BuildingBlock", "sap/fe/core/controls/CommandExecution", "sap/fe/core/converters/ManifestSettings", "sap/fe/core/converters/MetaModelConverter", "sap/fe/core/converters/annotations/DataField", "sap/fe/core/helpers/BindingHelper", "sap/fe/core/helpers/FPMHelper", "sap/fe/core/helpers/ModelHelper", "sap/fe/core/library", "sap/fe/core/templating/CriticalityFormatters", "sap/fe/macros/messages/MessageButton", "sap/m/Button", "sap/m/DraftIndicator", "sap/m/Menu", "sap/m/MenuButton", "sap/m/MenuItem", "sap/m/OverflowToolbar", "sap/m/ToolbarSpacer", "sap/ui/core/InvisibleText", "sap/fe/templates/ObjectPage/ObjectPageTemplating", "sap/m/OverflowToolbarLayoutData", "sap/fe/base/jsx-runtime/jsx", "sap/fe/base/jsx-runtime/jsxs"], function (Log, BindingToolkit, ClassSupport, BuildingBlock, CommandExecution, ManifestSettings, MetaModelConverter, DataField, BindingHelper, FPMHelper, ModelHelper, library, CriticalityFormatters, MessageButton, Button, DraftIndicator, Menu, MenuButton, MenuItem, OverflowToolbar, ToolbarSpacer, InvisibleText, ObjectPageTemplating, OverflowToolbarLayoutData, _jsx, _jsxs) {
  ...
  let FooterContent = (_dec = defineUI5Class("sap.fe.macros.FooterContent"), _dec2 = implementInterface("sap.ui.core.Toolbar"), _dec3 = implementInterface("sap.m.IBar"), _dec4 = property({
    ...
    _proto.getTextSaveButton = function getTextSaveButton() {
      ...
      return ifElse(ifElse(this.dataViewModelPath.startingEntitySet.annotations.Session?.StickySessionSupported !== undefined, UI.IsCreateMode, Draft.IsNewObject), createButtonText, saveButtonText);
    };
