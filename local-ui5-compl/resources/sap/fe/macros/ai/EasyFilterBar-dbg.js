...
sap.ui.define(["sap/base/Log", "sap/fe/base/ClassSupport", "sap/fe/controls/easyFilter/EasyFilterBarContainer", "sap/fe/core/buildingBlocks/BuildingBlock", "sap/fe/core/controllerextensions/BusyLocker", "sap/fe/core/helpers/ModelHelper", "sap/fe/core/helpers/TypeGuards", "sap/fe/core/templating/PropertyHelper", "sap/fe/macros/filter/FilterUtils", "sap/fe/macros/filterBar/DraftEditState", "sap/ui/core/Element", "sap/ui/model/FilterOperator", "sap/ui/model/json/JSONModel", "sap/ui/model/odata/type/Date", "sap/ui/model/odata/type/DateTimeOffset", "sap/ui/model/odata/type/TimeOfDay", "sap/fe/base/jsx-runtime/jsx"], function (Log, ClassSupport, EasyFilterBarContainer, BuildingBlock, BusyLocker, ModelHelper, TypeGuards, PropertyHelper, FilterUtils, DraftEditState, UI5Element, FilterOperator, JSONModel, Date1, DateTimeOffset, TimeOfDay, _jsx) {
  ...
  let EasyFilterBar = (_dec = defineUI5Class("sap.fe.macros.EasyFilterBar"), _dec2 = implementInterface("sap.fe.core.controllerextensions.viewState.IViewStateContributor"), _dec3 = association({
    ...
    _proto.getCodeListForProperty = async function getCodeListForProperty(key, propertyPath) {
      ...
      const select = defaultValueList.Parameters.map(param => param.ValueListProperty).join(",");
