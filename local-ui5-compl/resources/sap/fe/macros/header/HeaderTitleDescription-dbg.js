 ...
 */
sap.ui.define(["sap/fe/base/ClassSupport", "sap/fe/core/buildingBlocks/BuildingBlock", "sap/fe/core/converters/helpers/DataFieldHelper", "sap/fe/core/helpers/TitleHelper", "sap/m/Label", "sap/m/Title", "sap/m/VBox", "sap/m/library", "sap/ui/core/library", "../field/FieldTemplating", "./HeaderHelper", "sap/fe/base/jsx-runtime/jsx", "sap/fe/base/jsx-runtime/jsxs"], function (ClassSupport, BuildingBlock, DataFieldHelper, TitleHelper, Label, Title, VBox, library, coreLibrary, FieldTemplating, HeaderHelper, _jsx, _jsxs) {
  "use strict";
  ...
  let HeaderTitleDescription = (_dec = defineUI5Class("sap.fe.macros.header.HeaderTitleDescription"), _dec2 = property({
    ...
    _proto.getTitle = function getTitle(dataModelObjectPath, headerInfo, owner) {
    ...
    _proto.createContent = function createContent() {
      ...
      if (headerInfo && (headerInfo.Title || headerInfo.Description)) {
        return _jsxs(VBox, {
          ...
          children: [this.getTitle(dataModelObjectPath, headerInfo, owner), this.getDescription(dataModelObjectPath, headerInfo)]
        });
      }
    };
