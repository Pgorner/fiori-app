...
sap.ui.define(["sap/base/Log", "sap/fe/base/ClassSupport", "sap/fe/macros/library", "sap/m/FlexBox", "sap/m/Label", "sap/m/library", "sap/suite/ui/microchart/AreaMicroChart", "sap/suite/ui/microchart/ColumnMicroChart", "sap/suite/ui/microchart/ComparisonMicroChart", "sap/suite/ui/microchart/LineMicroChart", "sap/ui/core/Control", "sap/ui/core/format/NumberFormat", "sap/ui/model/odata/v4/ODataListBinding", "sap/ui/model/odata/v4/ODataMetaModel", "sap/ui/model/type/Date"], function (Log, ClassSupport, macroLib, FlexBox, Label, mobilelibrary, AreaMicroChart, ColumnMicroChart, ComparisonMicroChart, LineMicroChart, Control, NumberFormat, ODataV4ListBinding, ODataMetaModel, DateType) {
  ...
  let MicroChartContainer = (_dec = defineUI5Class("sap.fe.macros.microchart.MicroChartContainer"), _dec2 = property({
    ...
    function MicroChartContainer() {
      ...
      _initializerDefineProperty(_this, "navigationType", _descriptor11, _this);
      _initializerDefineProperty(_this, "calendarPattern", _descriptor12, _this);
      _initializerDefineProperty(_this, "onTitlePressed", _descriptor13, _this);
      _initializerDefineProperty(_this, "microChart", _descriptor14, _this);
      _initializerDefineProperty(_this, "_uomLabel", _descriptor15, _this);
      _initializerDefineProperty(_this, "microChartTitle", _descriptor16, _this);
      return _this;
    }
