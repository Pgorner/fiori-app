 ...
 */
sap.ui.define(["sap/fe/base/ClassSupport", "sap/fe/core/buildingBlocks/templating/BuildingBlockSupport", "sap/fe/macros/controls/BuildingBlockWithTemplating", "sap/fe/macros/microchart/MicroChart.block"], function (ClassSupport, BuildingBlockSupport, BuildingBlockWithTemplating, MicroChartBlock) {
  "use strict";
   ...
   */
  let MicroChart = (_dec = defineUI5Class("sap.fe.macros.microchart.MicroChart", convertBuildingBlockMetadata(MicroChartBlock)), _dec2 = xmlEventHandler(), _dec(_class = (_class2 = /*#__PURE__*/function (_BuildingBlockWithTem) {
    function MicroChart(props, others) {
      return _BuildingBlockWithTem.call(this, props, others) || this;
    }
    _exports = MicroChart;
    _inheritsLoose(MicroChart, _BuildingBlockWithTem);
