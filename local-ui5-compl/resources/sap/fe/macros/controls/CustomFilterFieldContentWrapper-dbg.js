...
sap.ui.define(["sap/fe/base/ClassSupport", "sap/fe/macros/filterBar/SemanticDateOperators", "sap/ui/base/ManagedObjectObserver", "sap/ui/core/Control", "sap/ui/mdc/condition/Condition", "sap/ui/mdc/enums/ConditionValidated", "sap/ui/mdc/field/ConditionsType", "sap/ui/model/json/JSONModel"], function (ClassSupport, SemanticDateOperators, ManagedObjectObserver, Control, Condition, ConditionValidated, ConditionsType, JSONModel) {
  ...
  var _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _CustomFilterFieldContentWrapper;
  var _exports = {};
  ...
  let CustomFilterFieldContentWrapper = (_dec = defineUI5Class("sap.fe.macros.controls.CustomFilterFieldContentWrapper"), _dec2 = implementInterface("sap.ui.core.IFormContent"), _dec3 = property({
    ...
    multiple: false,
    isDefault: true
  }), _dec7 = event(), _dec(_class = (_class2 = (_CustomFilterFieldContentWrapper = /*#__PURE__*/function (_Control) {
