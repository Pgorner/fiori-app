 ...
 */
sap.ui.define(["sap/fe/base/BindingToolkit", "sap/fe/core/controls/Any", "sap/fe/core/helpers/StableIdHelper", "sap/fe/macros/field/Field", "sap/fe/macros/table/massEdit/library", "sap/m/Select", "sap/ui/core/Item", "sap/ui/mdc/enums/FieldEditMode", "../../field/FieldRuntimeHelper", "sap/fe/base/jsx-runtime/jsx"], function (BindingToolkit, Any, ID, Field, library, Select, Item, FieldEditMode, FieldRuntimeHelper, _jsx) {
  "use strict";
  ...
  let MassEditField = /*#__PURE__*/function () {
      ...
      switch (selectedItem.key) {
        ...
        case SpecificSelectKeys.ReplaceKey:
          if (this.field) {
             ...
             */
            const unitValue = this.properties.propertyInfo.unitPropertyPath ? this.field.getBindingContext()?.getProperty(this.properties.propertyInfo.unitPropertyPath) : undefined;
            const selectOptions = this.properties.selectItems.find(item => this.properties.propertyInfo.unitPropertyPath && item.propertyValue === bindingValue && item.unitValue === unitValue || !this.properties.propertyInfo.unitPropertyPath && item.text === bindingValue);
     ...
     */;
    _proto.postConfiguration = async function postConfiguration() {
      if (this.field) {
    ...
    _proto.createField = function createField() {
      if (this.properties.inputType !== "CheckBox") return _jsx(Field, {
