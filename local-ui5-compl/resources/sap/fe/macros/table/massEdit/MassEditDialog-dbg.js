 ...
 */
sap.ui.define(["sap/base/Log", "sap/fe/core/CommonUtils", "sap/fe/core/controllerextensions/messageHandler/messageHandling", "sap/fe/core/converters/ManifestSettings", "sap/fe/core/helpers/StableIdHelper", "sap/fe/core/library", "sap/m/Button", "sap/m/Dialog", "sap/m/Label", "sap/m/MessageBox", "sap/m/MessageStrip", "sap/m/MessageToast", "sap/ui/core/Lib", "sap/ui/layout/form/Form", "sap/ui/layout/form/FormContainer", "sap/ui/layout/form/FormElement", "sap/ui/layout/form/ResponsiveGridLayout", "sap/ui/model/json/JSONModel", "./MassEditField", "./MassEditSideEffects", "sap/fe/base/jsx-runtime/jsx", "sap/fe/base/jsx-runtime/Fragment", "sap/fe/base/jsx-runtime/jsxs"], function (Log, CommonUtils, messageHandling, ManifestSettings, ID, FELibrary, Button, Dialog, Label, MessageBox, MessageStrip, MessageToast, Library, Form, FormContainer, FormElement, ResponsiveGridLayout, JSONModel, MassEditField, MassEditSideEffects, _jsx, _Fragment, _jsxs) {
  "use strict";
  ...
  let MassEditDialog = /*#__PURE__*/function () {
    ...
    _proto.create = async function create() {
      if (!this.dialog) {
        ...
        const dialog = _jsx(Dialog, {
          ...
          title: tableTitle ? this.resourceBundle.getText("C_MASS_EDIT_DIALOG_TITLE_TYPENAME_PLURAL", [tableTitle, this.contexts.length.toString()]) : this.resourceBundle.getText("C_MASS_EDIT_DIALOG_TITLE_WITHOUT_TYPENAME_PLURAL", [this.contexts.length.toString()]),
    ...
    _proto.saveChanges = async function saveChanges(fieldValuesInfo) {
      ...
      this.contexts.forEach((selectedContext, idx) => {
        for (const {
          control,
          values
    ...
    _proto.createCustomContainer = async function createCustomContainer() {
      const manifestSettings = this.table.getParent().getTableDefinition().control.massEdit;
      return manifestSettings.customFragment ? await this.view.getController().getExtensionAPI().loadFragment({
        id: "customMassEdit",
