 ...
 */
sap.ui.define(["sap/fe/core/CommonUtils", "sap/fe/macros/designtime/Designtime.helper", "sap/fe/macros/table/designtime/Table.designtime.helper"], function (CommonUtils, Designtime_helper, Table_designtime_helper) {
  "use strict";
  ...
  const designTime = {
    actions: {
      settings: {
        fe: {
          name: "Configuration",
          // TODO: add i18n and check with KM
