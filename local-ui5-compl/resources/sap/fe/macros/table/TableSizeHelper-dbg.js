 ...
 */
sap.ui.define(["sap/base/Log", "sap/fe/core/helpers/SizeHelper", "sap/fe/core/helpers/TypeGuards", "sap/fe/core/templating/DisplayModeFormatter", "sap/m/table/Util"], function (Log, SizeHelper, TypeGuards, DisplayModeFormatter, TableUtil) {
  "use strict";
  ...
  const TableSizeHelper = {
    ...
    getMDCColumnWidthFromDataField: function (dataField, properties, convertedMetaData) {
      ...
      const property = properties.find(prop => prop.metadataPath && convertedMetaData.resolvePath(prop.metadataPath)?.target?.fullyQualifiedName === dataField?.fullyQualifiedName);
