...
sap.ui.define(["sap/base/Log", "sap/base/util/merge", "sap/fe/core/CommonUtils", "sap/fe/core/converters/ConverterContext", "sap/fe/core/converters/MetaModelConverter", "sap/fe/core/converters/controls/ListReport/FilterBar", "sap/fe/core/helpers/MetaModelFunction", "sap/fe/core/helpers/ModelHelper", "sap/fe/core/templating/DisplayModeFormatter", "sap/fe/macros/CommonHelper", "sap/fe/macros/DelegateUtil", "sap/fe/macros/filterBar/SemanticDateOperators", "sap/ui/core/Element", "sap/ui/mdc/condition/Condition", "sap/ui/mdc/condition/ConditionConverter", "sap/ui/mdc/enums/ConditionValidated", "sap/ui/mdc/odata/v4/TypeMap", "sap/ui/mdc/p13n/StateUtil", "sap/ui/mdc/util/FilterUtil", "sap/ui/model/Filter", "sap/ui/model/FilterOperator", "sap/ui/model/odata/v4/ODataUtils"], function (Log, merge, CommonUtils, ConverterContext, MetaModelConverter, FilterBarConverter, MetaModelFunction, ModelHelper, DisplayModeFormatter, CommonHelper, DelegateUtil, SemanticDateOperators, Element, Condition, ConditionConverter, ConditionValidated, TypeMap, StateUtil, FilterUtil, Filter, FilterOperator, ODataUtils) {
  ...
  const oFilterUtils = {
    ...
    createConverterContext: function (oFilterControl, sEntityTypePath, metaModel, appComponent) {
      ...
      return ConverterContext.createConverterContextForMacro(oVisualizationObjectPath.startingEntitySet.name, oMetaModel, oAppComponent?.getDiagnostics(), merge, oVisualizationObjectPath.contextLocation, manifestSettings);
    },
