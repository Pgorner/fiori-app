...
sap.ui.define(["sap/base/Log", "sap/base/util/ObjectPath", "sap/fe/core/CommonUtils", "sap/fe/core/controllerextensions/collaboration/CollaborationCommon", "sap/fe/core/converters/MetaModelConverter", "sap/fe/core/helpers/TypeGuards", "sap/fe/macros/filter/FilterUtils", "sap/fe/macros/internal/valuehelp/ValueListHelper", "sap/m/inputUtils/highlightDOMElements", "sap/ui/mdc/ValueHelpDelegate", "sap/ui/mdc/condition/Condition", "sap/ui/mdc/enums/ConditionValidated", "sap/ui/mdc/odata/v4/TypeMap", "sap/ui/mdc/p13n/StateUtil", "sap/ui/model/FilterType", "../internal/valuehelp/AdditionalValueHelper"], function (Log, ObjectPath, CommonUtils, CollaborationCommon, MetaModelConverter, TypeGuards, FilterUtils, ValueListHelper, highlightDOMElements, ValueHelpDelegate, Condition, ConditionValidated, TypeMap, StateUtil, FilterType, AdditionalValueHelper) {
  ...
  return Object.assign({}, ValueHelpDelegate, {
    ...
    findConditionsForContext: function (valueHelp, content, context, conditions) {
      ...
      const vhPayload = payload.qualifiers[payload.valueHelpQualifier];
      const vhKeys = ValueListHelper.getTechnicalKeys(vhPayload?.vhParameters ?? [], vhPayload?.vhKeys);
        ...
        if (context?.getObject(keyPath) === condition?.values[0]) {
          ...
          if (vhKeys.length === 1 || payload?.useMultiValueField || !conditionPayloadMap) {
            ...
            return vhKeys.every(function (vhkey) {
              return context?.getObject(vhkey) === conditionSelectedRow[vhkey];
            });
          }
        }
      });
    ...
    showTypeahead: async function (valueHelp, content) {
      ...
      if (field.isA("sap.ui.mdc.FilterField") || field.isA("sap.ui.mdc.MultiValueField")) {
        ...
        if (fieldValue || fieldTextValue) {
          ...
          const isDigitSequence = field.getModel().getMetaModel().getObject(`${payload.propertyPath}${AnnotationIsDigitSequence}`) ?? false;
          if (field.hasPendingUserInput() || isDigitSequence && fieldValue === "0") {
