 ...
 */
sap.ui.define(["sap/fe/base/BindingToolkit", "sap/fe/core/helpers/StableIdHelper", "sap/fe/core/helpers/TypeGuards", "sap/fe/core/templating/DataModelPathHelper", "sap/fe/core/templating/PropertyHelper", "sap/fe/core/templating/UIFormatters", "sap/fe/macros/field/FieldHelper", "sap/fe/core/converters/MetaModelConverter", "sap/fe/macros/internal/valuehelp/AdditionalValueFormatter", "sap/ui/core/CustomData", "sap/ui/mdc/ValueHelp", "sap/ui/mdc/valuehelp/Dialog", "sap/ui/mdc/valuehelp/Popover", "sap/ui/mdc/valuehelp/content/Conditions", "sap/ui/mdc/valuehelp/content/MTable", "sap/fe/base/jsx-runtime/jsx"], function (BindingToolkit, StableIdHelper, TypeGuards, DataModelPathHelper, PropertyHelper, UIFormatters, FieldHelper, MetaModelConverter, additionalValueFormatter, CustomData, ValueHelp, Dialog, Popover, Conditions, MTable, _jsx) {
  "use strict";
  ...
  const getValueHelpTemplate = function (metaPath, vhContent) {
    ...
    if (dataModelObjectPath.targetObject) {
      const valueHelpId = generateID(vhContent._flexId, vhContent.idPrefix, getTargetObjectPath(originalProperty, true), getTargetObjectPath(dataModelObjectPath, true));
