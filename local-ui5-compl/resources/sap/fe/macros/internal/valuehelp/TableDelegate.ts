...
ODataTableDelegate._createPropertyInfos = async function (table: Table, model: ODataModel): Promise<ValueHelpTableColumn[]> {
...
function getPropertyMaxConditions(filterRestrictionsInfo: FilterRestrictionsInfoType, property: ValueHelpTableColumn | Property): number {
