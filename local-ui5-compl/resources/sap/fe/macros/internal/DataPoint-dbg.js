...
sap.ui.define(["sap/base/Log", "sap/fe/base/BindingToolkit", "sap/fe/base/ClassSupport", "sap/fe/core/buildingBlocks/BuildingBlock", "sap/fe/core/helpers/StableIdHelper", "sap/fe/core/helpers/TypeGuards", "sap/fe/core/templating/CriticalityFormatters", "sap/fe/core/templating/DataModelPathHelper", "sap/fe/core/templating/PropertyHelper", "sap/fe/core/templating/SemanticObjectHelper", "sap/fe/core/templating/UIFormatters", "sap/fe/macros/controls/ConditionalWrapper", "sap/fe/macros/field/FieldTemplating", "sap/fe/macros/internal/helpers/DataPointTemplating", "sap/fe/macros/quickView/QuickView", "sap/m/ObjectNumber", "sap/m/ObjectStatus", "sap/m/ProgressIndicator", "sap/m/RatingIndicator", "../field/FieldRuntimeHelper", "./DataPointFormatOptions", "sap/fe/base/jsx-runtime/jsx"], function (Log, BindingToolkit, ClassSupport, BuildingBlock, StableIdHelper, TypeGuards, CriticalityFormatters, DataModelPathHelper, PropertyHelper, SemanticObjectHelper, UIFormatters, ConditionalWrapper, FieldTemplating, DataPointTemplating, QuickView, ObjectNumber, ObjectStatus, ProgressIndicator, RatingIndicator, FieldRuntimeHelper, DataPointFormatOptions, _jsx) {
  ...
  let DataPoint = (_dec = defineUI5Class("sap.fe.macros.internal.DataPoint"), _dec2 = association({
    ...
    _proto.createObjectNumber = function createObjectNumber(dataModelPath) {
      ...
      const unit = this.formatOptions?.measureDisplayMode === "Hidden" ? undefined : compileExpression(UIFormatters.getBindingForUnitOrCurrency(this.valueDataModelPath));
    ...
    /**
     * Creates an ObjectNumber control with an eventual wrapper.
     * @param dataModelPath
     * @returns The control for the content
     */;
    _proto.createObjectNumberWithEventualWrapper = function createObjectNumberWithEventualWrapper(dataModelPath) {
      if (this?.formatOptions?.isAnalytics ?? false) {
        return _jsx(ConditionalWrapper, {
          condition: UIFormatters.hasValidAnalyticalCurrencyOrUnit(this.valueDataModelPath),
          children: {
            contentTrue: this.createObjectNumber(dataModelPath),
            contentFalse: _jsx(ObjectNumber, {
              id: this.idPrefix ? generate([this.idPrefix, "ObjectNumber-Field-display-differentUnit"]) : undefined,
              number: "*",
              visible: this.visible,
              emphasized: "false",
              class: this.formatOptions?.dataPointStyle === "large" ? "sapMObjectNumberLarge" : undefined,
        ...
        return this.createObjectNumber(dataModelPath);
      }
    }
    ...
    _proto.createDependents = function createDependents() {
      if (this.hasQuickView) {
        return new QuickView(this.valueDataModelPath, this.metaPath, this.contextPath ?? "").createContent(true);
      }
      return undefined;
    }
    ...
    _proto.createContent = function createContent() {
      ...
      switch (this.visualization) {
        ...
        case "ObjectNumber":
          {
            return this.createObjectNumberWithEventualWrapper(this.dataModelPath);
          }
        default:
          {
