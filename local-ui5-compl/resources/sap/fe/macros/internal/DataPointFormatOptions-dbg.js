...
sap.ui.define(["sap/fe/base/ClassSupport", "sap/fe/macros/controls/BuildingBlockObjectProperty"], function (ClassSupport, BuildingBlockObjectProperty) {
  ...
  let DataPointFormatOptions = (_dec = defineUI5Class("sap.fe.macros.internal.DataPointFormatOptions"), _dec2 = property({
    ...
    function DataPointFormatOptions() {
      var _this;
      ...
      _initializerDefineProperty(_this, "isAnalytics", _descriptor4, _this);
      _initializerDefineProperty(_this, "measureDisplayMode", _descriptor5, _this);
      _initializerDefineProperty(_this, "showEmptyIndicator", _descriptor6, _this);
      _initializerDefineProperty(_this, "showLabels", _descriptor7, _this);
      return _this;
    }
    ...
    writable: true,
    initializer: null
  }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "isAnalytics", [_dec5], {
    configurable: true,
    enumerable: true,
    writable: true,
  ...
  }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "measureDisplayMode", [_dec6], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "showEmptyIndicator", [_dec7], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: function () {
  ...
  }), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "showLabels", [_dec8], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: function () {
