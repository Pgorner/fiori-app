    ...
    switch (sDisplayMode) {
      ...
      default:
        if (oPropertyDataModelObjectPath.targetObject?.annotations?.Common?.Timezone && oPropertyDataModelObjectPath.targetObject.type === "Edm.DateTimeOffset") {
          ...
          oBindingExpression = _computeBindingWithUnitOrCurrency(oPropertyDataModelObjectPath, oFormattedValue, bHideMeasure || dataPointFormatOptions?.measureDisplayMode === "Hidden");
        }
    }
