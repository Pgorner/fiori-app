...
sap.ui.define(["sap/fe/base/BindingToolkit", "sap/fe/base/ClassSupport", "sap/fe/core/helpers/BindingHelper", "sap/fe/core/helpers/StableIdHelper", "sap/fe/core/helpers/TypeGuards", "sap/fe/core/templating/DataModelPathHelper", "sap/fe/core/templating/PropertyFormatters", "sap/fe/core/templating/UIFormatters", "sap/fe/macros/field/FieldHelper", "sap/fe/macros/field/FieldTemplating", "sap/fe/macros/internal/valuehelp/ValueHelpTemplating", "sap/ui/core/CustomData", "sap/ui/mdc/MultiValueField", "sap/ui/mdc/field/MultiValueFieldItem", "sap/fe/core/buildingBlocks/BuildingBlock", "sap/fe/core/controllerextensions/collaboration/CollaborationCommon", "sap/fe/core/controls/FormElementWrapper", "sap/fe/core/formatters/CollaborationFormatter", "sap/fe/core/helpers/ModelHelper", "sap/fe/core/templating/PropertyHelper", "sap/fe/macros/multivaluefield/FormatOptions", "sap/m/Avatar", "sap/m/HBox", "sap/ui/base/Event", "sap/ui/core/Element", "./ValueHelp", "./field/FieldRuntime", "sap/fe/base/jsx-runtime/jsx"], function (BindingToolkit, ClassSupport, BindingHelper, ID, TypeGuards, DataModelPathHelper, PropertyFormatters, UIFormatters, FieldHelper, FieldTemplating, ValueHelpTemplating, CustomData, MultiValueField, MultiValueFieldItem, BuildingBlock, CollaborationCommon, FormElementWrapper, CollaborationFormatters, ModelHelper, PropertyHelper, FormatOptions, Avatar, HBox, UI5Event, Element, ValueHelp, FieldRuntime, _jsx) {
  ...
  let MultiValueFieldBlock = (_dec = defineUI5Class("sap.fe.macros.MultiValueField"), _dec2 = implementInterface("sap.ui.core.IFormContent"), _dec3 = property({
     ...
     * @param collectionBindingDisplay
     * @param collectionBindingEdit
    ...
    _proto._overrideValue = function _overrideValue(collectionBindingDisplay, collectionBindingEdit, itemDataModelObjectPath, textExpression, key) {
      if (this.items) {
        const model = this.items.model ?? this.items.modelName;
        collectionBindingDisplay = {
          path: `${model}>${this.items.path}`
        };
        collectionBindingEdit = {
          path: `${model}>${this.items.path}`
        };
    ...
    _proto._getMultiInputSettings = function _getMultiInputSettings(propertyDataModelObjectPath, formatOptions) {
      ...
      const collectionBindingDisplay = {
        path: collectionPath,
        templateShareable: false
      };
      const collectionBindingEdit = this.useParentBindingCache ? {
        path: collectionPath,
        templateShareable: false
      } : {
        path: collectionPath,
      ...
      return {
        displayOnly,
        ...this._overrideValue(collectionBindingDisplay, collectionBindingEdit, itemDataModelObjectPath, textExpression, key)
      };
    }
     ...
     * @returns The possible ValueHelp control.
     */;
    _proto.getPossibleValueHelp = function getPossibleValueHelp() {
      const targetObject = this.dataModelPath.targetObject;
      if (this.id && isProperty(targetObject) && hasValueHelp(targetObject)) {
        // depending on whether this one has a value help annotation included, add the dependent
        return _jsx(ValueHelp, {
          idPrefix: this.vhIdPrefix,
          metaPath: getContextRelativeTargetObjectPath(this.dataModelPath),
    ...
    _proto.createContent = function createContent() {
      ...
      if (metaContextPath) {
        ...
        const valueHelpProperty = FieldHelper.valueHelpProperty(metaContext);
        const valueHelpPropertyContext = odataMetaModel?.createBindingContext(valueHelpProperty, metaContext);
        ...
        const vhControl = this.getPossibleValueHelp();
        let valueHelp;
        if (vhControl && vhControl.getContent()) {
          valueHelp = vhControl.getContent().getId();
        } else {
          //calculate valueHelp
          valueHelp = ValueHelpTemplating.generateID(undefined, this.vhIdPrefix, PropertyFormatters.getRelativePropertyPath(valueHelpPropertyContext, {
            context: context
        ...
        const multiValueField = _jsx(MultiValueField, {
          ...
          label: label,
          change: FieldRuntime.handleChangeMultiValueField.bind(FieldRuntime, controller),
        ...
        if (this.collaborationEnabled) {
          const avatar = _jsx(Avatar, {
            ...
            press: () => {
              FieldRuntime.showCollaborationEditUser(avatar, view);
            }
          });
          ...
          multiValueField?.addEventDelegate({
            onfocusin: evt => {
              ...
              controller.collaborativeDraft?.handleContentFocusIn({
                getSource: () => currentMultiValueField
              });
    ...
    _proto.updateEditMode = function updateEditMode() {
      ...
      } else if (this.readOnly === false && this.items) {
