 ...
 */
sap.ui.define(["sap/fe/base/ClassSupport", "sap/fe/core/helpers/StableIdHelper", "sap/fe/macros/field/FieldAPI", "sap/m/Label", "sap/ui/core/InvisibleText", "sap/ui/layout/form/ColumnElementData", "../MacroAPI"], function (ClassSupport, StableIdHelper, FieldAPI, Label, InvisibleText, ColumnElementData, MacroAPI) {
  "use strict";
  ...
  let FormContainerAPI = (_dec = defineUI5Class("sap.fe.macros.form.FormContainerAPI"), _dec2 = property({
    ...
    FormContainerAPI.setTextAreaLabelVisibility = function setTextAreaLabelVisibility(formContainer) {
      ...
      if (formElements.length === 1) {
        ...
        if (fields.length === 1) {
          const control = FieldAPI.getControlInFieldWrapper(fields[0].getContent());
