...
sap.ui.define(["sap/fe/core/buildingBlocks/templating/BuildingBlockSupport", "sap/fe/core/buildingBlocks/templating/BuildingBlockTemplatingBase", "sap/fe/core/converters/MetaModelConverter", "sap/fe/core/converters/controls/Common/Form", "sap/fe/core/templating/DataModelPathHelper"], function (BuildingBlockSupport, BuildingBlockTemplatingBase, MetaModelConverter, Form, DataModelPathHelper) {
  ...
  let FormContainerBlock = (_dec = defineBuildingBlock({
    ...
    type: "boolean"
  }), _dec15 = blockAggregation({
    type: "sap.fe.macros.form.FormElement"
  }), _dec16 = blockEvent(), _dec(_class = (_class2 = /*#__PURE__*/function (_BuildingBlockTemplat) {
    function FormContainerBlock(props, externalConfiguration, settings) {
       ...
       */
      _initializerDefineProperty(_this, "designtimeSettings", _descriptor11, _this);
      _initializerDefineProperty(_this, "actions", _descriptor12, _this);
      _initializerDefineProperty(_this, "useSingleTextAreaFieldAsNotes", _descriptor13, _this);
      _initializerDefineProperty(_this, "formElements", _descriptor14, _this);
      // Just proxied down to the Field may need to see if needed or not
      _initializerDefineProperty(_this, "onChange", _descriptor15, _this);
    ...
    writable: true,
    initializer: null
  }), _descriptor13 = _applyDecoratedDescriptor(_class2.prototype, "useSingleTextAreaFieldAsNotes", [_dec14], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  }), _descriptor14 = _applyDecoratedDescriptor(_class2.prototype, "formElements", [_dec15], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: function () {
