...
sap.ui.define(["sap/ui/core/Lib", "sap/ui/mdc/condition/FilterOperatorUtil", "sap/ui/mdc/condition/Operator", "sap/ui/mdc/enums/ConditionValidated", "sap/ui/mdc/enums/OperatorValueType", "sap/ui/model/Filter", "sap/ui/model/FilterOperator", "sap/ui/model/json/JSONModel"], function (Library, FilterOperatorUtil, Operator, ConditionValidated, OperatorValueType, Filter, FilterOperator, JSONModel) {
  ...
  const EDITSTATE = {
    ...
    getEditStates: function (isDraftCollaborative) {
     ...
     */
    getFilterForEditState: function (editState) {
      switch (editState) {
     ...
     */
    addDraftEditStateOperator: function () {
      FilterOperatorUtil.addOperator(new Operator({
        ...
        validateInput: true,
        checkValidated: function (condition) {
...
//# sourceMappingURL=DraftEditState-dbg.js.map
