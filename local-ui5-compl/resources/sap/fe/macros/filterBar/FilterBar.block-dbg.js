      ...
      _this.processSelectionFields = () => {
        ...
        if (_this.showDraftEditState) {
          ...
          draftEditState = _jsx(MDCFilterField, {
            ...
            valueHelp: generate([_this.id, "FilterFieldValueHelp", "DraftEditingStatus"]),
            display: "Description",
            children: {
              dependents: _jsx(MDCValueHelp, {
                id: generate([_this.id, "FilterFieldValueHelp", "DraftEditingStatus"]),
                children: {
                  typeahead: _jsx(Popover, {
                    children: _jsx(FixedList, {
                      useFirstMatch: "true",
                      children: {
                        items: draftStates.map(state => {
                          return _jsx(FixedListItem, {
                            text: state.display
                          }, state.id);
                        })
                      }
