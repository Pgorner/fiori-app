...
sap.ui.define(["sap/base/Log", "sap/fe/base/ClassSupport", "sap/fe/core/controllerextensions/messageHandler/messageHandling", "sap/fe/core/helpers/ResourceModelHelper", "sap/fe/macros/messages/MessagePopover", "sap/m/Button", "sap/m/ColumnListItem", "sap/m/FormattedText", "sap/m/library", "sap/ui/core/Core", "sap/ui/core/CustomData", "sap/ui/core/Element", "sap/ui/core/Lib", "sap/ui/core/Messaging", "sap/ui/core/message/MessageType", "sap/ui/core/mvc/View", "sap/ui/model/Filter", "sap/ui/model/FilterOperator", "sap/ui/model/Sorter", "sap/ui/thirdparty/jquery", "./MessageButtonHelper"], function (Log, ClassSupport, messageHandling, ResourceModelHelper, MessagePopover, Button, ColumnListItem, FormattedText, library, Core, CustomData, UI5Element, Library, Messaging, MessageType, View, Filter, FilterOperator, Sorter, jQuery, messageButtonHelper) {
  ...
  let MessageButton = (_dec = defineUI5Class("sap.fe.macros.messages.MessageButton"), _dec2 = aggregation({
    ...
    _proto._activeTitlePress = async function _activeTitlePress(oEvent) {
      ...
      const oTargetMdcTable = oMessage.controlIds.map(function (controlId) {
          ...
          try {
            ...
            if (oTargetMdcTable.data("tableType") === "GridTable" && oRefError.rowIndex !== "") {
              ...
              try {
                ...
                if (aTargetMdcTableRow.length > 0 && aTargetMdcTableRow[0]) {
                  iNewFirstVisibleRow = aTargetMdcTableRow[0].getParent().getFirstVisibleRow() ?? 0;
    ...
    _proto._applyFiltersAndSort = function _applyFiltersAndSort() {
      let oValidationFilters, oValidationAndContextFilter, oFilters, sPath, oSorter, oDialogFilter, objectPageLayoutSections;
