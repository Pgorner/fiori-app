 ...
 */
sap.ui.define(["sap/base/util/merge", "sap/base/util/uid", "sap/fe/base/ClassSupport", "sap/fe/core/buildingBlocks/BuildingBlock", "sap/fe/core/converters/ConverterContext", "sap/ui/core/Component", "sap/ui/core/UIArea"], function (merge, uid, ClassSupport, BuildingBlock, ConverterContext, Component, UIArea) {
  "use strict";
  ...
  let MacroAPI = (_dec = defineUI5Class("sap.fe.macros.MacroAPI"), _dec2 = implementInterface("sap.ui.core.IFormContent"), _dec3 = aggregation({
    ...
    return MacroAPI;
  }(BuildingBlock), _MacroAPI.namespace = "sap.fe.macros", _MacroAPI.macroName = "Macro", _MacroAPI.fragment = "sap.fe.macros.Macro", _MacroAPI.hasValidation = true, _MacroAPI.getConverterContext = function (oDataModelPath, contextPath, mSettings) {
