 ...
 */
sap.ui.define(["sap/fe/base/ClassSupport", "sap/fe/core/buildingBlocks/BuildingBlock", "sap/sac/df/FilterPanel", "sap/sac/df/utils/MetaPathHelper", "sap/fe/base/jsx-runtime/jsx"], function (ClassSupport, BuildingBlock, DFFilterPanel, MetaPathHelper, _jsx) {
  "use strict";
   ...
   * @experimental
   */
  let FilterPanel = (_dec = defineUI5Class("sap.fe.ina.blocks.FilterPanel"), _dec2 = property({
    type: "string",
    required: true
  }), _dec3 = property({
    type: "string",
    ...
    function FilterPanel(idOrSettings, settings) {
      var _this;
    ...
    _exports = FilterPanel;
    _inheritsLoose(FilterPanel, _BuildingBlock);
    var _proto = FilterPanel.prototype;
...
//# sourceMappingURL=FilterPanel-dbg.js.map
