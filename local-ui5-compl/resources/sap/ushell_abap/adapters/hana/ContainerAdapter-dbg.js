...
sap.ui.define([
    ...
    /**
     * @namespace sap.ushell_abap.adapters.hana
     * @description Default namespace for Unified Shell adapters for the HANA platform. They can usually
    ...
    /**
     * @alias sap.ushell_abap.adapters.hana.ContainerAdapter
     * @class
     * @classdesc The Unified Shell's container adapter which does the bootstrap for the HANA platform.
    ...
    return function (oSystem) {
         ...
         *
         * @returns {jQuery.Promise} Resolved when logout is finished, even when it failed
         * @since 1.11.0
         */
