...
sap.ui.define([
   ...
   /**
     ...
     *   }
     *   </pre>
     * @returns {jQuery.Promise} Resolves to an object containing the resolution result as in
     *   {@link sap.ushell.services.ClientSideTargetResolution#resolveHashFragment}
     * @private
     */
     ...
     * @returns {jQuery.Promise} Resolves to an array of Inbounds in ClientSideTargetResolution format.
     * @private
     */
     ...
     *
     * @returns {jQuery.Promise} Resolves the target mappings.
     */
     ...
     *   }
     *   </pre>
     * @returns {object[]} an array of inbounds suitable for ClientSideTargetResolution service consumption.
    ...
    ClientSideTargetResolutionAdapter.prototype._constructShellHashForLpdCust = function (oInbound, oParams) {
        var sLpdCustShellHash = "",
            ...
            oTargetMappingOriginal = ObjectPath.get("resolutionResult._original", oInbound);
     ...
     * @returns {jQuery.Promise} Resolves to a system alias data object. A live object is returned!
     ...
     * @returns {jQuery.Promise} Resolves to a system alias data object in OData JSON format.
    ...
    ClientSideTargetResolutionAdapter.prototype.getUrlTemplateContext = function (oDirectStartResponse) {
        ...
        var oUrlTemplate = this._oURLTemplates[oDirectStartResponse.urlTemplate.id];
        if (!oUrlTemplate) {
