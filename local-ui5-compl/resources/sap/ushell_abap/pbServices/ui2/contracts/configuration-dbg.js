...
sap.ui.define([
     ...
     * @description The namespace for the CHIP API's <code>configuration</code> contract, which allows
     ...
     * @description The namespace for the CHIP API's <code>writeConfiguration</code> contract which
