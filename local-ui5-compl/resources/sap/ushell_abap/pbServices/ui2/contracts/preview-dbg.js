 ...
 */
 sap.ui.define([
     ...
     */
    Preview.setEnvironmentType = function (sEnvironment) {
     ...
     */
    Preview.getEnvironmentType = function () {
        return this.environment;
    };

    /**
     * @namespace chip.preview
     * @description The namespace for the CHIP API's <code>preview</code> contract, which
    ...
    Chip.addContract("preview", /* @returns {object} */ function (oChipInstance) {
        ...
        this.getEnvironmentType = function () {
            return Preview.getEnvironmentType();
        };
         ...
         * @description The namespace for the contract interface (to be used by a page builder) for
