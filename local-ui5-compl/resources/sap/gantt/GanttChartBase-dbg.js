...
sap.ui.define([
	...
	var GanttChartBase = Control.extend("sap.gantt.GanttChartBase", /** @lends sap.gantt.GanttChartBase.prototype */ {
		metadata: {
			...
			properties: {
				 ...
				 *
				 * @deprecated Since version 1.50.7.
				 *
	 ...
	 * @function
	 *
	 * @param {(Date|string|Array)} vDate A date object or a 14-digit timestamp string in this format: YYYYMMDDHHMMSS.
	 ...
	 * @function
	 *
	 * @param {array} aUid Array of the UIDs of the UI elements to be selected
	 * @public
	 */
	 ...
	 * @returns {this} Gantt Chart instance
	 *
	 ...
	 * @returns {this} Reference to the GanttChart control, which can be used for chaining
	 *
	 ...
	 * @returns {this} A reference to the GanttChartBase control, which can be used for chaining
	 * @public
	 */
