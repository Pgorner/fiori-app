	...
	var ContainerToolbarPlaceholder = Control.extend("sap.gantt.simple.ContainerToolbarPlaceholder", /** @lends sap.gantt.simple.ContainerToolbarPlaceholder.prototype */ {
		metadata: {
			...
			properties: {
				 ...
				 * @private
				 */
				_show: {type: "boolean", defaultValue: false, visibility: "hidden"}
			},
			aggregations: {
				/**
				 * Represented control.
		...
		renderer: {
			...
			render: function (oRm, oContainerToolbarPlaceholder) {
				...
				if (oContainerToolbarPlaceholder.getType() === "Spacer") {
					...
					oRm.openStart("div", oContainerToolbarPlaceholder).openEnd();
					oRm.renderControl(oControl);
					oRm.close("div");
				}
			}
