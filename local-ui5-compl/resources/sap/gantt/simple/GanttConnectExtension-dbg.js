...
sap.ui.define([
...
], function(jQuery, KeyCodes, Core, library, GanttExtension, CoordinateUtils, GanttUtils, Utility, GanttChartConfigurationUtils) {
	"use strict";
	...
	GanttConnectExtension.prototype._getIndicatorData = function(oShape) {
		...
		var oFrame, leftAnchorPosition, rightAnchorPosition;
		if (oShape.getDomRef("nonLabelGroup")) {
			oFrame = oShape.getDomRef("nonLabelGroup").getBBox();
			leftAnchorPosition = 3 / 4;
			rightAnchorPosition = 3 / 4;
		} else {
			oFrame = oShape.getDomRef().getBBox();
