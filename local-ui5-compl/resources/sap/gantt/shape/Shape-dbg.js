...
sap.ui.define([
	 ...
	 * 	<li>A formatted attribute from data. Example: <code>{tooltip: "{time:Timestamp} the stock price falls to {price:Number}."}</code>
	 ...
	 * 		and the date and time values for the key timestamp are formatted by the configurations provided by {@link sap.gantt.misc.Format}.</li>
	 * </ul>
	 *
