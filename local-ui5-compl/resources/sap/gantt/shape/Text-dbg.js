 ...
 */
sap.ui.define([
	"sap/gantt/shape/Shape", "sap/gantt/misc/Format", "sap/ui/Device"
], function (Shape, Format, Device) {
	"use strict";
	...
	Text.prototype.getStyle = function(oData, oRowInfo) {
		...
		var oAllStyles = Object.assign(sInheritedStyle, oStyles);
		return oAllStyles;
	};
	return Text;
}, true);
