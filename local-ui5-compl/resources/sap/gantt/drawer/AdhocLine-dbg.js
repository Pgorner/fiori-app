...
sap.ui.define([
...
], function (library, Utility, Drawer, Format, GanttChartConfigurationUtils) {
	"use strict";
	...
	AdhocLine.prototype.drawSvg = function ($GanttChartSvg, aAdhocLineConfig, oStatusSet, sLayer) {
		...
		var oVisibleStartTime = GanttChartConfigurationUtils.getRTL() ? oStatusSet.aTimeBoundary[1] : oStatusSet.aTimeBoundary[0],
		oVisibleEndTime = GanttChartConfigurationUtils.getRTL() ? oStatusSet.aTimeBoundary[0] : oStatusSet.aTimeBoundary[1];
