...
sap.ui.define([
	...
	"sap/gantt/misc/Format", "sap/ui/core/Core", "sap/gantt/misc/Utility", "sap/gantt/drawer/ShapeInRow", "sap/ui/core/Element"
], function (jQuery, Device, BaseObject, ShapeManager, Format, Core, Utility, ShapeInRowDrawer, Element) {
	"use strict";
	/**
	...
	ShapeResizeHandler.prototype._getShapeInstance = function (oShapeData, sClassId) {
		...
		if (mShapeInstance) {
			...
			var oTopShapeInstance = Element.getElementById(sClassId).getParent();
