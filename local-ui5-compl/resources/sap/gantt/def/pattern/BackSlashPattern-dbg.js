...
sap.ui.define([
	...
	BackSlashPattern.prototype.getDefString = function (bRemoveClone) {
		var sId = this.getId();
		//If bRemoveClone remove the Text "-__Clone##" from the Id
		return "<pattern class='pattern' id='" + (bRemoveClone ? sId.slice(0,sId.indexOf("-__clone")) : sId) +
