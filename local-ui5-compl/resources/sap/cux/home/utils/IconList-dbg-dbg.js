  ...
  const ICONS = {
    "SAP-icons": {
      ...
      icons: {
        ...
        "travel-expense": ["plane", "dollar", "money", "trip", "expense", "travel", "holiday", "flight", "budget", "billing", "invoice", "cost", "payments"],
        ...
        group: ["group", "team", "people", "communication", "collaborate", "teamwork", "peer to peer", "design thinking", "work", "together", "project", "customers", "audience", "category"],
        "check-availability": ["date picker", "calendar", "month", "week", "day", "appointment", "search", "look up", "check", "availability", "find"],
        ...
        "e-care": ["e care", "digital customer care", "service", "electronic", "leaf", "leaves", "nature", "organic", "health", "environment"],
        ...
        "create-leave-request": ["holiday", "vacation", "leave", "request", "deck chair", "sun", "create", "add", "plus", "additional", "another", "more"],
        ...
        "create-entry-time": ["document", "page", "file", "attachment", "timesheet", "clock", "hours", "days", "workday", "create entry time", "add", "plus", "additional", "another", "more"],
        ...
        "business-card": ["business card", "contact", "networking", "colleague", "person", "address", "identification", "details", "profile"],
        ...
        "course-program": ["document", "page", "file", "attachment", "course", "education", "course", "learning", "e book", "bookmark", "open", "knowledge", "coursebook", "program"],
        "add-coursebook": ["education", "course", "learning", "e book", "bookmark", "open", "knowledge", "course book", "program", "add", "plus", "additional", "another", "more"],
        ...
        "pushpin-on": ["document", "page", "file", "attachment", "pin", "pushpin", "stick", "unstick", "snap", "remove pin", "unpin", "off", "on"],
        "pushpin-off": ["pin", "pushpin", "stick", "unstick", "snap", "remove pin", "unpin", "off", "on"],
        unfavorite: ["remove", "unfavorite", "star"],
        "learning-assistant": ["education", "course", "learning", "e book", "bookmark", "open", "knowledge", "school", "college", "help", "tutor", "assistant", "teacher", "professor"],
        ...
        collaborate: ["group", "team", "people", "colleagues", "communication", "collaborate", "teamwork", "peer to peer", "design thinking", "work", "together", "project"],
        ...
        supplier: ["supplier", "package", "product", "satisfaction", "returns", "deliveries", "warehouse", "person", "seller", "buyer", "inventory"],
        ...
        "e-learning": ["education", "course", "e learning", "e book", "bookmark", "open", "knowledge", "school", "college", "computer", "screen"],
        manager: ["manager", "company", "overview", "inform", "board", "leader", "conference", "meeting", "keynote", "speech", "presentation"],
        ...
        private: ["person", "individual", "user", "customer", "human", "locked", "in use", "occupied", "restricted", "private", "forbidden"],
        ...
        "monitor-payments": ["report", "bill", "billing", "sales", "expense", "quote", "envelope", "invoice", "dollar", "money", "monitor payments"],
        ...
        "collections-insight": ["collections", "insight", "report", "bill", "billing", "sales", "expense", "quote", "envelope", "invoice", "dollar", "money"],
        "clinical-tast-tracker": ["clinical", "task", "tracker", "clipboard", "medical", "checklist", "check boxes"],
        "citizen-connect": ["citizen connect", "people", "colleagues", "communication", "collaborate", "teamwork", "peer to peer", "design thinking", "work", "together", "project"],
        ...
        "idea-wall": ["idea", "wall", "collaborate", "teamwork", "peer to peer", "design thinking", "work", "together", "project", "improve"],
        "cart-5": ["cart", "trolley", "basket", "shopping", "item", "sap"],
        "cart-4": ["cart", "trolley", "basket", "shopping", "item", "add", "put in", "insert", "add", "plus", "additional", "another", "more"],
        ...
        simulate: ["calculator", "calculate", "count", "numbers", "counting", "simulate", "divide", "calculation", "tot up", "digits", "algorithm", "mathematician", "mathematics"],
        ...
        provision: ["analytics", "chart", "display", "data", "table", "columns", "rows", "grid", "waffle", "settings", "modify", "customize"],
        ...
        "customer-and-supplier": ["customer and supplier", "package", "product", "satisfaction", "returns", "warehouse", "person", "seller", "buyer", "inventory"],
        crop: ["crop", "clip", "snip", "cut", "picture", "image", "shape", "obect"],
        "add-contact": ["person", "contact", "business card", "customer", "details", "address", "information", "add", "plus", "additional", "another", "more"],
        ...
        badge: ["badge", "insignia", "star", "service", "identity", "authority", "legitimate", "coat of arms", "membership", "award", "rank"],
        ...
        "add-activity-2": ["activity", "activities", "tasks", "to do", "list", "check list", "correct", "success", "tick mark", "add", "plus", "additional", "another", "more"],
        ...
        "resize-horizontal": ["resize", "horizontal", "column", "screen", "bigger", "smaller", "enlarge", "reduce", "arrows", "lines", "side to side"],
        "resize-vertical": ["resize", "vertical", "row", "screen", "bigger", "smaller", "enlarge", "reduce", "arrows", "lines", "up and down"],
        ...
        "date-time": ["date", "time"],
        "user-settings": ["settings", "cogwheel", "configuration", "settings", "tools", "modify", "customize", "person", "user", "runtime authoring"],
        "key-user-settings": ["settings", "cogwheel", "configuration", "settings", "tools", "modify", "customize", "administrator", "key user", "runtime authoring"],
        "developer-settings": ["settings", "cogwheel", "configuration", "settings", "tools", "modify", "customize", "developer", "runtime authoring"],
        ...
        "project-definition-triangle-2": ["analytics", "chart", "display", "data", "gantt", "shape", "triangle", "project", "definition"],
        ...
        "decrease-line-height": ["decrease", "line height", "leading", "text edit", "spacing", "rich-text", "less space", "reduce", "compress", "arrows"],
        "increase-line-height": ["increase", "line height", "leading", "text edit", "spacing", "rich-text", "more space", "enlarge", "expand", "arrows"],
        ...
        pixelate: ["pixel", "tool", "screenshot", "image", "edit", "modify", "distort", "pixelate", "squares", "dots", "resolution", "noise"],
        "horizontal-combination-chart": ["analytics", "chart", "display", "data", "combination", "line-chart", "bar", "horizontal"],
        "add-employee": ["customer", "user", "person", "individual", "contacts", "add", "additional", "employee", "hr", "human resources", "plus"],
        ...
        combine: ["merge", "arrow", "combine", "glue", "together", "join", "meld", "unite", "aggregate", "interflow", "runtime authoring", "runtime adaptation", "ui adaptation", "arrows-right"],
        split: ["split", "arrow", "separate", "break", "cleave", "clove", "cut up", "runtime authoring", "runtime adaptation", "ui adaptation", "arrows-right"],
    ...
    "SAP-icons-TNT": {
      ...
      icons: {
        ...
        "message-start-event": ["mail", "circle", "email", "e-mail", "electronic mail", "envelope", "mail", "correspondence", "receiving", "sending", "standard"],
        "message-end-event": ["mail", "circle", "email", "e-mail", "electronic mail", "envelope", "mail", "correspondence", "receiving", "sending", "standard"],
    ...
    BusinessSuiteInAppSymbols: {
      ...
      icons: {
        ...
        phase: ["planning", "scheduling", "program", "project", "scheduling", "shape", "gantt", "chart", "display", "analytics", "chevron"],
        checklist: ["planning", "scheduling", "program", "project", "scheduling", "shape", "gantt", "chart", "display", "analytics", "checklist"],
        "mirrored-task": ["planning", "scheduling", "program", "project", "scheduling", "shape", "gantt", "chart", "display", "analytics", "mirrored task"],
        "sub-project": ["planning", "scheduling", "program", "project", "scheduling", "shape", "gantt", "chart", "display", "analytics", "sub project"],
        "checklist-item": ["planning", "scheduling", "program", "project", "scheduling", "shape", "gantt", "chart", "display", "analytics", "checklist item"],
        ...
        "project-definition": ["shape", "gantt", "chart", "display", "analytics", "triangle", "project", "definition", "planning", "scheduling"],
        ...
        "substraction-b-a": ["circles", "substraction", "analytics", "analyze objects", "filter", "segmentation", "segment", "target group", "b-a"],
        "substraction-a-b": ["circles", "substraction", "analytics", "analyze objects", "filter", "segmentation", "segment", "target group", "a-b"],
        intersection: ["circles", "intersection", "analytics", "analyze objects", "filter", "segmentation", "segment", "target group"],
        union: ["circles", "intersection", "analytics", "analyze objects", "filter", "segmentation", "segment", "target group", "union", "merge", "combine"],
        top: ["arrow", "top"],
        bottom: ["arrow", "bottom"],
        ...
        "vip-customer": ["person", "individual", "user", "customer", "human", "circle", "profile", "me", "favorite", "favourite", "star"],
        "undesirable-customer": ["person", "individual", "user", "customer", "human", "circle", "profile", "me", "star", "unfavourite", "remove"],
        ...
        "display-ads": ["screen", "monitor", "website", "information", "layout", "screendesign", "shopping", "online", "social media", "facebook"],
...
//# sourceMappingURL=IconList-dbg-dbg.js.map
