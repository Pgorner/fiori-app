...
sap.ui.define(["sap/m/Bar", "sap/m/Button", "sap/m/List", "sap/m/Page", "sap/m/SplitApp", "sap/m/StandardListItem", "sap/m/Title", "sap/ui/core/Element", "sap/ui/Device", "./BaseSettingsDialog", "./utils/Device"], function (Bar, Button, List, Page, SplitApp, StandardListItem, Title, Element, Device, __BaseSettingsDialog, ___utils_Device) {
  "use strict";
  ...
  const SettingsDialog = BaseSettingsDialog.extend("sap.cux.home.SettingsDialog", {
    ...
    _getDetailPage: function _getDetailPage(settingsPanel) {
      ...
      if (!this._controlMap.get(id)) {
        ...
        (settingsPanel.getAggregation("actionButtons") || []).forEach(actionButton => {
