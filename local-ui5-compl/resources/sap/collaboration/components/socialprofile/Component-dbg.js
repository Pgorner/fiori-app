...
sap.ui.define([
	 ...
	 *
	 * @since version 1.25
	 * @alias sap.collaboration.components.socialprofile.Component
	 * @public
	...
	var Component = UIComponent.extend("sap.collaboration.components.socialprofile.Component",
		/** @lends sap.collaboration.components.socialprofile.Component.prototype */
		{
			...
			*/
			 ...
			 * @private
			 */
			 _createView: async function(){
				var that = this;
				if (!this._oPopoverView) {
					this._oPopoverView = await View.create({
						...
						viewName: "module:sap/collaboration/components/socialprofile/SocialProfileView"
					});
				}
				else {
