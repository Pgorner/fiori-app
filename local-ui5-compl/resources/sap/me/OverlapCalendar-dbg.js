...
sap.ui.define([
	...
	/**
	 * @param {int} iWeeksPerRow The integer number of weeks per row
	 * @public
	 */
	 ...
	 * @returns {int} The number of days (integer) between the two dates. Always positive or zero.
	 * @private
	 */
	 ...
	 * @returns {int} The number (integer) of days between the dates.
	 * @private
	 */
	 ...
	 * @param {Date} firstDate First date of the difference
	 * @param {Date} secondDate Second date of the difference
	 * @returns {int} The number of days, as an integer, between the two dates.
	 * @private
	 */
	...
	OverlapCalendar.prototype._renderHalfDayCalendarEvent = function (key, aHalfDaysEvent) {
		...
		var $newStartDiv = jQuery("<div></div>");
