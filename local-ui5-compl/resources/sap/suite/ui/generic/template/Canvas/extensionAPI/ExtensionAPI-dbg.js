		...
		function getMethods(oTemplateUtils, oController, oBase) {
			return /** @lends sap.suite.ui.generic.template.Canvas.extensionAPI.ExtensionAPI.prototype */ {
				...
				*/
				 ...
				 * Note that the usage of the Flexible Column Layout Action Buttons must have been switched on in the settings of the page.
				 * @return {object} Flexible Column Layout Action Buttons (resp. <code>undefined</code> when no FCL Action Buttons should be shown on this page)
				 * @public
				 * @function
				 */
