sap.ui.define(["sap/ui/core/library",
	...
	Element
		...
		function fnPlaceEmbeddedComponent(oComponentRegistryEntry, mReuseComponentProxies, sEmbeddedKey, oEmbeddedComponentMeta, oEmbeddedComponent){
			if (oComponentRegistryEntry.oComponent.isDestroyStarted() || oComponentRegistryEntry.oAppComponent.isDestroyStarted()){ // if the app is already in the process of getting destroyed, do not place the embedded component anymore
				return;
			}
