	...
	return {
		...
		types: {
			ListReportPage: {
				...
				DynamicPageHeader: {},
				PageTitle: {
					value: "template::DynamicPageTitle"
				}
			},
			ListReportTable: {
			...
			ListReportAction: {
				...
				AddCardtoInsights: {
					optionalParameters: ["sQuickVariantKey"],
					value: function(oParams){return oParams.sQuickVariantKey ? undefined : "template::AddCardtoInsights";}
				}
			},
			ALPAction: {
				ExtensionAction: {
...
//				},
				...
				FileUploaderLabel: {
					parameters: ["sFacet"],
					value: function(oParams){return oParams.sFacet + "::FileUploaderLabel";}
				},
				DynamicSideContent: {
					parameters: ["sFacet"],
				...
				ReplaceSubSectionExtensionSubSection: {
					parameters: ["sEntitySet", "sFacet"],
					value: function(oParams) {return "ReplaceSubSection::" + oParams.sEntitySet  + "::" + oParams.sFacet + "::SubSection";}
				},
				...
				ConnectedFields: {
                                        parameters: ["sFacet", "sAnnotationPath", "sProperty"]
                                },
