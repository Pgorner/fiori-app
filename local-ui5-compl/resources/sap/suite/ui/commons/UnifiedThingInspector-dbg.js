...
sap.ui.define([
	...
	"sap/base/i18n/Localization"
			 ...
			 Bar, Button, Device, ResizeHandler, ManagedObject, ObjectHeader, ObjectAttribute, Image, Icon, Log, KeyCodes, deepEqual, UnifiedThingInspectorRenderer, Element, Lib, Localization) {
	"use strict";
	...
	UnifiedThingInspector.prototype.init = function () {
		...
		this._rb = Lib.getResourceBundleFor("sap.suite.ui.commons");
	...
	UnifiedThingInspector.prototype.onBeforeRendering = function () {
		...
		Element.getElementById(this.getId() + "-master-action-button").setVisible(this.getActionsVisible());
		Element.getElementById(this.getId() + "-detail-action-button").setVisible(this.getActionsVisible());

		Element.getElementById(this.getId() + "-master-transaction-button").setVisible(this.getTransactionsVisible());
		Element.getElementById(this.getId() + "-detail-transaction-button").setVisible(this.getTransactionsVisible());
