...
sap.ui.define([
...
], function (jQuery, library, Ux3Library, CommonsLibrary, VerticalNavigationBar, ThingViewer, Button, ThreePanelThingViewerRenderer, ControlEvents, containsOrEquals, Lib, Localization) {
	"use strict";
	...
	ThreePanelThingViewer.prototype._updateMenuPopup = function () {
		...
		var sStyle = Localization.getRTL() ? "right" : "left";
