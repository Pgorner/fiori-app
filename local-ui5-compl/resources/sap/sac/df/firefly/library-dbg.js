...
sap.ui.define(
  [
    "sap/base/Log",
    "sap/sac/df/firefly/ff2150.contentlib",
    "sap/sac/df/firefly/ff2210.ui.native",
    "sap/sac/df/firefly/ff3600.horizon.ui.api",
    "sap/sac/df/firefly/ff3610.horizon.ui",
    "sap/sac/df/firefly/ff3620.horizon.ui.plugins",
    ...
    "sap/sac/df/firefly/ff8120.dragonfly"
  ],function(
    Log, oFF
  ){
    oFF.ui.FFUi5Preloader.load().then(() => {
        Log.info("sap.sac.df ui deps loaded");
    });
